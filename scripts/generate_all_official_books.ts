...
function getOrCreateBookDetails(book: OfficialBook): BookDetailedContent {
  ...
  const isApplied = ['economics_stat', 'cs_informatics', 'business_entrepreneurship', 'fine_arts_architecture', 'music_theory', 'agriculture', 'industrial', 'commercial', 'tourism', 'renewable', 'stem_capstone', 'robotics_mechatronics', 'electronics_iot', 'ai_data_science', 'biotechnology', 'nanotechnology'].includes(book.subjectId);
