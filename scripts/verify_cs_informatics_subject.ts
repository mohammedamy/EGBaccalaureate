...
assert(officialBooksList.length === 37, `Total official books list is 37 (found: ${officialBooksList.length})`);
...
assert(allPapers.length === 102, `Total past exam papers across platform equals 102 (got ${allPapers.length})`);
