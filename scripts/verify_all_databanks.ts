...
if (databankChaptersCount !== 321) {
  console.error(`Expected 321 databank chapters, but found ${databankChaptersCount}!`);
  errors++;
}
if (totalQ !== 56175) {
  console.error(`Expected 56,175 total questions, but found ${totalQ}!`);
  errors++;
}
