...
if (databankChaptersCount !== 353) {
  console.error(`Expected 353 databank chapters, but found ${databankChaptersCount}!`);
  errors++;
}
if (totalQ !== 61775) {
  console.error(`Expected 61,775 total questions, but found ${totalQ}!`);
  errors++;
}
