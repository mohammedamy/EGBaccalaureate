...
if (databankChaptersCount !== 377) {
  console.error(`Expected 377 databank chapters, but found ${databankChaptersCount}!`);
  errors++;
}
if (totalQ !== 65975) {
  console.error(`Expected 65,975 total questions, but found ${totalQ}!`);
  errors++;
}
