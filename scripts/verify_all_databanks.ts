...
if (databankChaptersCount !== 313) {
  console.error(`Expected 313 databank chapters, but found ${databankChaptersCount}!`);
  errors++;
}
if (totalQ !== 54775) {
  console.error(`Expected 54,775 total questions, but found ${totalQ}!`);
  errors++;
}
