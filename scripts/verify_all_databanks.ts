...
if (databankChaptersCount !== 305) {
  console.error(`Expected 305 databank chapters, but found ${databankChaptersCount}!`);
  errors++;
}
if (totalQ !== 53375) {
  console.error(`Expected 53,375 total questions, but found ${totalQ}!`);
  errors++;
}
