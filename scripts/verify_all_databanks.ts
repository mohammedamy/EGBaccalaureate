...
if (databankChaptersCount !== 361) {
  console.error(`Expected 361 databank chapters, but found ${databankChaptersCount}!`);
  errors++;
}
if (totalQ !== 63175) {
  console.error(`Expected 63,175 total questions, but found ${totalQ}!`);
  errors++;
}
