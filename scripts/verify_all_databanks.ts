...
if (databankChaptersCount !== 369) {
  console.error(`Expected 369 databank chapters, but found ${databankChaptersCount}!`);
  errors++;
}
if (totalQ !== 64575) {
  console.error(`Expected 64,575 total questions, but found ${totalQ}!`);
  errors++;
}
