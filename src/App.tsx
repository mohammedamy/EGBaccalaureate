          ...
          >
            <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
              ...
              <span className="font-medium text-xs sm:text-sm truncate">
                <span className="inline sm:hidden">
                  {lang === 'ar'
                    ? 'البحث الشامل في ٤٥,٠٠٠ مسألة...'
                    : 'Universal Search across 45,000 problems...'}
                </span>
                <span className="hidden sm:inline">
                  {lang === 'ar'
                    ? 'البحث الشامل في ٤٥,٠٠٠ مسألة وقانون وفصل عبر ١٦ مادة... (اضغط للبحث أو ⌘K)'
                    : 'Universal Search across 45,000 problems, theorems & lessons across 16 subjects... (Click or ⌘K)'}
                </span>
              </span>
            </div>
            <div className="flex items-center gap-2 shrink-0">
              <span className="hidden md:inline-flex items-center px-2 py-0.5 text-[11px] font-semibold rounded-full bg-indigo-500/15 text-indigo-400 border border-indigo-500/30">
                {lang === 'ar' ? '٢٢٥ فصلاً • ٤٥,٠٠٠ مسألة' : '225 Ch • 45k Qs'}
              </span>
