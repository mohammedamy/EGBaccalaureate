...
export const EXPERIMENT_CONFIGS: Record<string, ExperimentTemplateConfig> = {
  ...
  // 7b. Physics Coolidge X-Ray Tube & Dual Spectra
  'phys-exp-8': {
    id: 'phys-exp-8',
    discipline: 'physics',
    titleEn: 'Coolidge X-Ray Tube, Continuous Bremsstrahlung & Characteristic Emission Spectroscopy',
    titleAr: 'أنبوبة كولدج لتوليد الأشعة السينية، طيف الكبح والفرملة المستمر، وطيف الانبعاث الخطي المميز',
    gradeEn: 'Grade 12 Physics - Modern Physics: Atomic Spectra & X-Rays (Chapter 6)',
    gradeAr: 'الصف الثالث الثانوي - الفيزياء الحديثة: الأطياف الذرية والأشعة السينية',
    hypothesisEn: 'Minimum wavelength of continuous Bremsstrahlung spectrum strictly obeys Duane-Hunt law λ_min = hc/(eV) governed solely by tube voltage, while characteristic emission peaks (Kα, Kβ) depend exclusively on target atomic number Z and appear only above the K-edge threshold voltage.',
    hypothesisAr: 'يخضع أقصر طول موجي لطيف الكبح المستمر لقانون دوين-هنت λ_min = hc/(eV) ويتوقف حصراً على فرق الجهد بين المصعد والمهبط، بينما تتوقف الأطوال الموجية للأطياف الخطية المميزة (Kα, Kβ) على نوع مادة الهدف وعدده الذري Z ولا تظهر إلا بتجاوز جهد الإثارة الحرج.',
    apparatusEn: [
      'High-Vacuum Evacuated Coolidge X-Ray Tube with lead casing and beryllium exit window',
      'Variable High-Voltage DC Power Supply (20 kV - 100 kV)',
      'Low-Voltage Filament Heating Power Supply (6 - 12 V, 1 - 10 mA)',
      'Interchangeable Anode Targets: Tungsten (W, Z=74), Molybdenum (Mo, Z=42), and Copper (Cu, Z=29)',
      'Massive Copper Anode Body with External Radial Cooling Fins',
      'Bragg Crystal Spectrometer with Sodium Chloride (NaCl) Crystal and Ionization Chamber Detector',
    ],
    apparatusAr: [
      'أنبوبة كولدج زجاجية مفرغة من الهواء مع غلاف واقٍ من الرصاص ونافذة بريليوم لخروج الأشعة',
      'مصدر جهد مستمر عالٍ جداً قابل للضبط (20 kV - 100 kV) بين الفتيلة والهدف',
      'دائرة تسخين الفتيلة منخفضة الجهد لإنتاج الإلكترونات بالانبعاث الكهروحراري (1 - 10 mA)',
      'أهداف مصعدية قابلة للتبديل: تنجستين (W, Z=74)، موليبدنوم (Mo, Z=42)، ونحاس (Cu, Z=29)',
      'ساق مصعدية ضخمة من النحاس مجهزة بريش تبريد إشعاعية خارجية لتشتيت الحرارة',
      'مطياف بلوري حيودي (بلورة ملح طعام NaCl) مع غرفة تأين رقمية لقياس شدة الإشعاع وزاوية براغ',
    ],
    stepsEn: [
      'Energize the filament heating circuit; verify thermionic electron emission from the tungsten cathode.',
      'Apply high voltage V across tube (e.g. 50 kV); measure the continuous Bremsstrahlung spectrum with the Bragg spectrometer.',
      'Record minimum cutoff wavelength λ_min; verify Duane-Hunt relationship λ_min = hc/(eV).',
      'Increase filament heating current If while keeping voltage V constant; observe that curve height (intensity) increases proportionally while λ_min and peak positions remain strictly unchanged.',
      'Increase tube voltage V from 30 kV to 80 kV; observe that λ_min shifts left to shorter wavelengths and overall radiation intensity increases.',
      'Select Molybdenum target (Z=42) and Tungsten target (Z=74); compare characteristic Kα and Kβ peaks, confirming that higher Z shifts characteristic peaks to shorter wavelengths.',
      'Reduce voltage below target K-edge threshold (V < VK); observe the complete disappearance of characteristic spikes, proving threshold excitation condition.',
    ],
    stepsAr: [
      'شغّل دائرة تسخين الفتيلة، وتحقق من انطلاق الإلكترونات من مهبط التنجستين بفعل الانبعاث الحراري.',
      'طبّق فرق جهد عالٍ V بين المصعد والمهبط (50 kV مثلاً)؛ وقِس طيف الأشعة السينية بواسطة المطياف البلوري.',
      'سجل أقصر طول موجي لطيف الكبح λ_min؛ وتحقق من قانون دوين-هنت λ_min = hc/(eV).',
      'ارفع شدة تيار تسخين الفتيلة مع تثبيت فرق الجهد V؛ ولاحظ زيادة شدة الإشعاع (ارتفاع المنحنى) مع بقاء λ_min ومواضع القمم ثابتة دون تغيير.',
      'ارفع فرق الجهد V من 30 kV إلى 80 kV؛ ولاحظ إزاحة λ_min جهة اليسار لأطوال موجية أقصر وزيادة المساحة الكلية تحت المنحنى.',
      'قارن بين هدفي الموليبدنوم (Z=42) والتنجستين (Z=74)؛ وتحقق من إزاحة القمم الخطية المميزة (Kα, Kβ) لأطوال موجية أقصر بزيادة العدد الذري لمادة الهدف.',
      'اخفض فرق الجهد دون جهد التأين الحرج (V < VK)؛ ولاحظ الاختفاء التام للقمم الخطية المميزة، مما يثبت شرط طاقة الإثارة الكافية.',
    ],
    formula: '\\lambda_{\\min} = \\frac{hc}{eV} = \\frac{1.23984 \\times 10^{-6}}{V}, \\quad \\nu_{\\max} = \\frac{eV}{h}, \\quad v_{\\max} = \\sqrt{\\frac{2eV}{m_e}}, \\quad \\Delta E = E_{\\text{outer}} - E_{\\text{inner}} = \\frac{hc}{\\lambda_{\\text{line}}}',
    expectedConclusionEn: 'Continuous X-ray spectrum (Bremsstrahlung) cutoff λ_min depends strictly on tube voltage (λ_min ∝ 1/V), while characteristic line spectrum (Kα, Kβ) depends exclusively on target atomic number Z and requires V ≥ VK to appear.',
    expectedConclusionAr: 'يتوقف الطيف المستمر للأشعة السينية (طيف الفرملة والكبح) وأقصر طول موجي له λ_min حصراً على فرق الجهد المطبق بين المصعد والمهبط (علاقة عكسية)، بينما يتوقف الطيف الخطي المميز حصراً على نوع مادة الهدف وعدده الذري Z ولا يظهر إلا عند تجاوز فرق الجهد لقيمة العتبة الحرجة.',
    columns: [
      { key: 'target', labelAr: 'مادة الهدف (Z)', labelEn: 'Target Metal (Z)' },
      { key: 'voltageKv', labelAr: 'فرق الجهد V (kV)', labelEn: 'Tube Voltage (kV)' },
      { key: 'currentMa', labelAr: 'تيار الفتيلة (mA)', labelEn: 'Filament I (mA)' },
      { key: 'lambdaMinNm', labelAr: 'أقصر طول موجي λ_min', labelEn: 'Cutoff λ_min (nm)' },
      { key: 'vMaxKmS', labelAr: 'أقصى سرعة إلكترون v_max', labelEn: 'Max Velocity v_max' },
      { key: 'kAlphaNm', labelAr: 'خط Kα المميز', labelEn: 'Characteristic Kα' },
    ],
    sampleRows: [
      { target: 'تنجستين W (Z=74)', voltageKv: '40.0 kV', currentMa: '5.0 mA', lambdaMinNm: '0.0310 nm (0.31 Å)', vMaxKmS: '118,600 km/s', kAlphaNm: 'غير ظاهر (V < 69.5 kV)' },
      { target: 'تنجستين W (Z=74)', voltageKv: '80.0 kV', currentMa: '5.0 mA', lambdaMinNm: '0.0155 nm (0.15 Å)', vMaxKmS: '167,700 km/s', kAlphaNm: '0.0213 nm (0.21 Å)' },
      { target: 'موليبدنوم Mo (Z=42)', voltageKv: '40.0 kV', currentMa: '5.0 mA', lambdaMinNm: '0.0310 nm (0.31 Å)', vMaxKmS: '118,600 km/s', kAlphaNm: '0.0710 nm (0.71 Å)' },
      { target: 'موليبدنوم Mo (Z=42)', voltageKv: '40.0 kV', currentMa: '10.0 mA', lambdaMinNm: '0.0310 nm (0.31 Å)', vMaxKmS: '118,600 km/s', kAlphaNm: '0.0710 nm (ضعف الشدة)' },
      { target: 'نحاس Cu (Z=29)', voltageKv: '30.0 kV', currentMa: '4.0 mA', lambdaMinNm: '0.0413 nm (0.41 Å)', vMaxKmS: '102,700 km/s', kAlphaNm: '0.1540 nm (1.54 Å)' },
    ],
    sampleObservationsAr: 'إزاحة نقطة بداية المنحنى (λ_min) نحو اليسار بمقدار النصف عند مضاعفة فرق الجهد من 40 إلى 80 كيلوفولت، بينما أدى مضاعفة تيار الفتيلة إلى مضاعفة قمة المنحنى دون أي زحزحة في λ_min، وظهور قمم حادة مميزة لهدف الموليبدنوم أطول موجياً من قمم التنجستين نظراً لصغر عدده الذري.',
    sampleObservationsEn: 'The spectrum cutoff wavelength λ_min halved and shifted left when doubling voltage from 40 to 80 kV. Doubling filament current doubled curve amplitude with zero shift in λ_min. Characteristic peaks of Molybdenum appeared at longer wavelengths than Tungsten due to smaller atomic number.',
    sampleErrorAnalysisAr: 'امتصاص الأشعة السينية اللينة في نافذة الزجاج وفقد جزء يسير من طاقة الإلكترونات في حرارة تشتت قبل الفرملة النووية.',
    sampleErrorAnalysisEn: 'Low-energy X-ray absorption in the tube glass window and slight thermal dissipation losses in target lattice.',
  },
  ...
  // 24. Math Solids of Revolution & Riemann Discs
  'math-exp-6': {
    id: 'math-exp-6',
    discipline: 'math',
    titleEn: 'Definite Integration & Solids of Revolution: Riemann Disc Summation Convergence',
    titleAr: 'التكامل المحدد وحجوم الأجسام الدورانية: تقارب مجموع أقراص ريمان الأسطوانية',
    gradeEn: 'Grade 12 Pure Math - Calculus & Integration (Chapter 4)',
    gradeAr: 'الصف الثالث الثانوي - الرياضيات البحتة (التفاضل والتكامل: الحجوم والمساحات الناتجة عن الدوران)',
    hypothesisEn: 'The continuous volume of revolution V = π ∫ [f(x)]² dx equals the infinite limit of discrete cylindrical Riemann discs V_N = ∑ π [f(x_i)]² Δx, with numerical error vanishing as N → ∞.',
    hypothesisAr: 'الحجم المتصل للجسم الدوراني V = π ∫ [f(x)]² dx يمثل النهاية الدقيقة لتجميع الأقراص الأسطوانية المتتالية V_N = ∑ π [f(x_i)]² Δx، وينعدم الخطأ الحسابي تدريجياً مع زيادة عدد الأقراص N → ∞.',
    apparatusEn: [
      'Interactive 2.5D Isometric Solids of Revolution Canvas',
      'Continuous 360° rotational angle sweep controller',
      'Riemann disc slicing count slider (N = 4 to 60)',
      'Standard curriculum presets (Paraboloid, Cone, Hemisphere, Vase, Washer)',
      'Real-time analytical integral vs numerical disc volume error telemetry',
    ],
    apparatusAr: [
      'لوحة مجسمات الأجسام الدورانية التفاعلية بأبعاد أيزومترية 2.5D',
      'محدد زاوية الدوران المحوري المتصلة (30° إلى 360°)',
      'منزلق عدد أقراص ريمان الأسطوانية (N من 4 إلى 60 قرصاً)',
      'نماذج دوال المنهج القياسية (المجسم المكافئ، المخروط، نصف الكرة، الإناء الزجاجي، والقرص الحلقي المفرغ)',
      'شاشة قياسات لحظية للحجم التكاملي الدقيق مقابل مجموع ريمان ونسبة الخطأ المئوية',
    ],
    stepsEn: [
      'Select Paraboloid f(x) = √x on [0, 4].',
      'Calculate exact integral: V = π ∫_0^4 x dx = 8π ≈ 25.1327.',
      'Set disc count N = 4 and measure disc volume V_4 and error percentage.',
      'Increase disc count to N = 12, 24, and 60; record diminishing truncation error.',
      'Rotate sweep angle from 90° to 360° to inspect full 3D solid construction.',
    ],
    stepsAr: [
      'اختر نموذج المجسم المكافئ f(x) = √x على الفترة [0, 4].',
      'احسب الحجم التكاملي الدقيق: V = π ∫_0^4 x dx = 8π ≈ 25.1327.',
      'اضبط عدد الأقراص N = 4 وقس حجم مجموع الأقراص ونسبة الخطأ.',
      'زد عدد الأقراص تدريجياً إلى 12 و 24 و 60 قرصاً وسجل انخفاض نسبة الخطأ.',
      'اسحب زاوية الدوران من 90° إلى 360° لمعاينة اكتمال المجسم الفراغي.',
    ],
    formula: 'V = \\pi \\int_a^b [f(x)]^2 \\, dx, \\quad V_N = \\sum_{i=1}^N \\pi [f(x_i^*)]^2 \\Delta x',
    expectedConclusionEn: 'Riemann cylindrical disc sums converge monotonically to the exact definite integral of revolution as partition size Δx approaches zero.',
    expectedConclusionAr: 'يتقارب مجموع أقراص ريمان الأسطوانية رتيباً نحو قيمة التكامل المحدد الدقيق مع اقتراب سمك الشريحة Δx من الصفر.',
    columns: [
      { key: 'trial', labelAr: 'المحاولة / عدد الأقراص N', labelEn: 'Trial / Disc Count N' },
      { key: 'slice_width', labelAr: 'سمك الشريحة Δx', labelEn: 'Slice Width Δx' },
      { key: 'approx_vol', labelAr: 'حجم ريمان التقريبي V_N', labelEn: 'Riemann Sum V_N' },
      { key: 'exact_vol', labelAr: 'الحجم التحليلي الدقيق V', labelEn: 'Exact Integral V' },
      { key: 'error_pct', labelAr: 'نسبة الخطأ المئوية', labelEn: 'Error Percentage', unit: '%' },
    ],
    sampleRows: [
      { trial: 'N = 4 أقراص', slice_width: '1.000', approx_vol: '28.274', exact_vol: '25.133', error_pct: '+12.50%' },
      { trial: 'N = 12 قرصاً', slice_width: '0.333', approx_vol: '26.180', exact_vol: '25.133', error_pct: '+4.17%' },
      { trial: 'N = 24 قرصاً', slice_width: '0.167', approx_vol: '25.656', exact_vol: '25.133', error_pct: '+2.08%' },
      { trial: 'N = 60 قرصاً', slice_width: '0.067', approx_vol: '25.342', exact_vol: '25.133', error_pct: '+0.83%' },
    ],
    sampleObservationsAr: 'أظهرت القياسات أن التقريب الأسطواني يفرط في تقدير الحجم عند اعتماد الحد الأيمن للدالة المتزايدة، ولكن الخطأ يتلاشى بسرعة مع زيادة عدد الشرائح وتصغير سمك القرص.',
    sampleObservationsEn: 'Measurements confirmed that right-endpoint Riemann cylinder sums overestimate volume for monotonically increasing functions, but error decreases asymptotically as partition width Δx → 0.',
    sampleErrorAnalysisAr: 'الخطأ العددي الناتج عن التقطيع المتقطع (Discretization error) واعتماد ارتفاع ثابت للقرص على مدار الشريحة.',
    sampleErrorAnalysisEn: 'Discretization error from piecewise flat cylindrical edges approximating curved boundary profiles.',
  },

  // 25. Math Conic Sections & Focal Optics
  'math-exp-7': {
    id: 'math-exp-7',
    discipline: 'math',
    titleEn: 'Conic Sections & Focal Reflection Optics: Eccentricity & Ray-Tracing Mechanics',
    titleAr: 'القطوع المخروطية وبصريات الانعكاس البؤري: الاختلاف المركزي وتتبع الأشعة الضوئية',
    gradeEn: 'Grade 12 Pure Math - Geometry & Analytic Conics',
    gradeAr: 'الصف الثالث الثانوي - الرياضيات البحتة (الهندسة التحليلية والفراغية: القطوع المخروطية وخصائص البؤرة والدليل)',
    hypothesisEn: 'The eccentricity e = PF/PD strictly classifies conics (circle e=0, ellipse e<1, parabola e=1, hyperbola e>1); parabolic boundaries collimate focal rays into parallel beams, while elliptic mirrors focus all rays to the second focus.',
    hypothesisAr: 'الاختلاف المركزي e = PF/PD يصنف القطوع بدقة (دائرة e=0، ناقص e<1، مكافئ e=1، زائد e>1)؛ وتعكس حدود المكافئ أشعة البؤرة متوازية بينما تعكس حدود الناقص الأشعة نحو البؤرة الأخرى.',
    apparatusEn: [
      'Unified Conic Section Analytic Coordinate Canvas',
      'Eccentricity controller e',
      'Focus and Directrix tracker',
      'Animated optical ray-tracing engine',
      'Curvature radius and asymptote angle visualizer',
    ],
    apparatusAr: [
      'لوحة تحليل القطوع المخروطية الموحدة في المستوى الديكارتي',
      'متحكم الاختلاف المركزي e',
      'محدد موقع البؤرة والدليل وخطوط التناظر',
      'محرك تتبع مسار الأشعة الضوئية وانعكاسها',
      'أداة حساب نصف قطر الانحناء وزوايا خطوط التقارب',
    ],
    stepsEn: [
      'Select Parabola (e = 1.0, y² = 4ax with a = 2.0).',
      'Verify focus F(2, 0) and directrix x = -2; measure ratio PF/PD = 1.0 for arbitrary points.',
      'Emit rays from focal point F; observe parallel reflected rays along x-axis.',
      'Switch to Ellipse (e = 0.6); verify whispering gallery reflection where rays from F1 arrive at F2.',
      'Switch to Hyperbola (e = 1.5); verify asymptotic trajectory bounds.',
    ],
    stepsAr: [
      'اختر القطع المكافئ (e = 1.0 والمعادلة y² = 4ax مع a = 2.0).',
      'تأكد من موقع البؤرة F(2, 0) والدليل x = -2؛ وتحقق من ثبات النسبة PF/PD = 1.0 عند نقاط مختلفة.',
      'أطلق أشعة ضوئية من البؤرة F؛ ولاحظ خروج الأشعة المنعكسة في حزمة متوازية مع محور السينات.',
      'انتقل للقطع الناقص (e = 0.6)؛ وتحقق من التقاء كل شعاع صادر من البؤرة الأولى عند البؤرة الثانية.',
      'انتقل للقطع الزائد (e = 1.5)؛ وافحص انفراج الأشعة وتوافقها مع خطوط التقارب.',
    ],
    formula: 'e = \\frac{PF}{PD}, \\quad y^2 = 4ax, \\quad \\frac{x^2}{a^2} + \\frac{y^2}{b^2} = 1, \\quad \\frac{x^2}{a^2} - \\frac{y^2}{b^2} = 1',
    expectedConclusionEn: 'Conic sections possess unique focal reflection characteristics dictated by eccentricity, providing geometric foundations for parabolic antennas, optical telescopes, and acoustic halls.',
    expectedConclusionAr: 'تمتلك القطوع المخروطية خواص انعكاس بؤري فريدة يحددها الاختلاف المركزي، مما يمنحها تطبيقات صناعية وهندسية حيوية كهوائيات الأقمار الصناعية والتلسكوبات.',
    columns: [
      { key: 'conic_type', labelAr: 'نوع القطع المخروطي', labelEn: 'Conic Section Type' },
      { key: 'eccentricity', labelAr: 'الاختلاف المركزي e', labelEn: 'Eccentricity e' },
      { key: 'dist_focus', labelAr: 'المسافة للبؤرة PF', labelEn: 'Focus Distance PF' },
      { key: 'dist_directrix', labelAr: 'المسافة للدليل PD', labelEn: 'Directrix Distance PD' },
      { key: 'ratio_check', labelAr: 'النسبة المحسوبة PF/PD', labelEn: 'Computed Ratio PF/PD' },
      { key: 'focal_property', labelAr: 'خاصية الانعكاس البؤري', labelEn: 'Focal Optical Property' },
    ],
    sampleRows: [
      { conic_type: 'قطع مكافئ (Parabola)', eccentricity: '1.000', dist_focus: '4.000', dist_directrix: '4.000', ratio_check: '1.000', focal_property: 'انعكاس الأشعة البؤرية في حزمة متوازية تماماً' },
      { conic_type: 'قطع ناقص (Ellipse)', eccentricity: '0.600', dist_focus: '3.600', dist_directrix: '6.000', ratio_check: '0.600', focal_property: 'تجمع جميع الأشعة من البؤرة 1 في البؤرة 2' },
      { conic_type: 'قطع زائد (Hyperbola)', eccentricity: '1.500', dist_focus: '6.000', dist_directrix: '4.000', ratio_check: '1.500', focal_property: 'تباعد الأشعة كأنها صادرة من البؤرة الظاهرية' },
      { conic_type: 'دائرة منتظمة (Circle)', eccentricity: '0.000', dist_focus: '3.000 (نصف القطر)', dist_directrix: '∞ (دليل لانهائي)', ratio_check: '0.000', focal_property: 'انعكاس الأشعة المارة بالمركز لترتد على نفسها' },
    ],
    sampleObservationsAr: 'أكدت الأشعة البصرية المنعكسة تطابق زاوية السقوط والانعكاس مع مماس المنحنى، مما يحقق التوازي الكامل للمكافئ وتجمع البؤرتين للناقص.',
    sampleObservationsEn: 'Reflected rays satisfied Snell specular reflection with respect to the curve tangent, verifying perfect collimation for parabolas and conjugate focus for ellipses.',
    sampleErrorAnalysisAr: 'التقريب العشري لمتجهات المماس والعمودي عند النقاط المنفصلة على المنحنى.',
    sampleErrorAnalysisEn: 'Numerical precision limits when estimating curve normals for ray reflection angles near extreme curvature vertices.',
  },

  // 26. Math Fourier Series & Acoustic Synthesis
  'math-exp-8': {
    id: 'math-exp-8',
    discipline: 'math',
    titleEn: 'Fourier Series & Acoustic Harmonic Synthesis: Gibbs Phenomenon & Epicycles',
    titleAr: 'متسلسلات فورييه والتركيب النغمي السمعي: ظاهرة جيبس وفلكيات التدوير (Epicycles)',
    gradeEn: 'Grade 12 / Advanced Math - Periodic Functions & Spectral Analysis',
    gradeAr: 'الصف الثالث الثانوي والمتقدم - الدوال الدورية، تحليل الترددات ومتسلسلات فورييه',
    hypothesisEn: 'Periodic waveforms decompose into harmonic series; truncating a square wave at N odd harmonics generates an 8.95% overshoot at step discontinuities that does not vanish as N increases.',
    hypothesisAr: 'تتفكك الموجات الدورية إلى توافقيات جيبية؛ وينتج عن قطع الموجة المربعة عند N توافقية زيادة بنسبة 8.95% عند القفزة لا تتلاشى بزيادة N (ظاهرة جيبس).',
    apparatusEn: [
      'Rotating Epicycle Phasor Circles Canvas',
      'Real-time Scrolling Time-Domain Waveform Display',
      'Harmonic count slider (N = 1 to 35)',
      'Waveform presets (Square, Sawtooth, Triangle, Rectified)',
      'Web Audio API real-time acoustic synthesizer',
      'Fourier harmonic amplitude spectrum chart',
    ],
    apparatusAr: [
      'لوحة فلكيات التدوير الدوارة (متجهات التردد الدائرية)',
      'شاشة عرض الدالة الزمنية المتزامنة للموجة الناتجة',
      'متحكم عدد التوافقيات (N من 1 إلى 35)',
      'نماذج الموجات (مربعة، سن منشار، مثلثية، مقومة)',
      'مولد نغمات صوتية سمعي حي عبر Web Audio API',
      'مخطط طيف سعات توافقيات فورييه',
    ],
    stepsEn: [
      'Select Square wave and examine Fourier coefficients b_n = 4/(πn).',
      'Set N = 1 (pure sine wave); listen to fundamental 220 Hz pitch.',
      'Increase to N = 3, 5, 9; observe square profile emerging and timbre sharpening.',
      'Increase to N = 35; measure overshoot peak ratio ≈ 1.0895 (Gibbs phenomenon).',
      'Switch to continuous Triangle wave (b_n ∝ 1/n²); verify rapid convergence and absence of Gibbs overshoot.',
    ],
    stepsAr: [
      'اختر الموجة المربعة وافحص معاملات فورييه b_n = 4/(πn).',
      'اضبط N = 1 (موجة جيبية نقية)؛ واستمع للنغمة الأساسية بتردد 220 هرتز.',
      'زد التوافقيات إلى 3 و 5 و 9؛ ولاحظ استواء قمة الموجة وتغير جرس الصوت.',
      'ارفع التوافقيات إلى N = 35؛ وقس نسبة الارتفاع الزائد للقمة ≈ 1.0895 (ظاهرة جيبس).',
      'انتقل للموجة المثلثية المتصلة (b_n ∝ 1/n²)؛ وتأكد من سرعة التقارب وغياب ظاهرة جيبس.',
    ],
    formula: 'f(t) = \\frac{a_0}{2} + \\sum_{n=1}^\\infty [a_n \\cos(nt) + b_n \\sin(nt)], \\quad \\text{Overshoot} \\approx 8.95\\%',
    expectedConclusionEn: 'Fourier decomposition validates harmonic acoustic synthesis, proving that higher harmonic additions sharpen waveform geometry while jump discontinuities produce persistent Gibbs overshoot.',
    expectedConclusionAr: 'يبرهن تحليل فورييه مبادئ التركيب النغمي السمعي، حيث تسهم التوافقيات العليا في تشكيل حواف الموجة مع بقاء ظاهرة جيبس حتمية عند نقاط عدم الاتصال.',
    columns: [
      { key: 'harmonic_n', labelAr: 'رتبة التوافقية / عدد الحدود N', labelEn: 'Harmonics Count N' },
      { key: 'added_freq', labelAr: 'أعلى تردد توافقي مضاف', labelEn: 'Max Added Frequency', unit: 'Hz' },
      { key: 'peak_amplitude', labelAr: 'أقصى سعة للموجة المركبة', labelEn: 'Peak Amplitude' },
      { key: 'overshoot_pct', labelAr: 'نسبة القفزة الزائدة (جيبس)', labelEn: 'Overshoot Percentage', unit: '%' },
      { key: 'timbre_quality', labelAr: 'الخاصية السمعية / جرس الصوت', labelEn: 'Acoustic Timbre Quality' },
    ],
    sampleRows: [
      { harmonic_n: 'N = 1 (أساسية فقط)', added_freq: '220', peak_amplitude: '1.273', overshoot_pct: '0.00%', timbre_quality: 'نغمة جيبية نقية ناعمة (مزامير)' },
      { harmonic_n: 'N = 3 توافقيات', added_freq: '660', peak_amplitude: '1.146', overshoot_pct: '4.80%', timbre_quality: 'نغمة بدأت تكتسب قسوة ودفء نغمي' },
      { harmonic_n: 'N = 9 توافقيات', added_freq: '1980', peak_amplitude: '1.175', overshoot_pct: '8.45%', timbre_quality: 'صوت شبه مربع يشبه الآلات الوترية الإلكترونية' },
      { harmonic_n: 'N = 35 توافقية', added_freq: '7700', peak_amplitude: '1.179', overshoot_pct: '8.95%', timbre_quality: 'صوت مربع نقي حاد مع طنين عالي التردد' },
    ],
    sampleObservationsAr: 'لوحظ أنه مهما زاد عدد التوافقيات المضافة للموجة المربعة، يظل ارتفاع القمة عند نقطة القفزة ثابتاً عند نحو 8.95% من ارتفاع الدرجة، وتضيق فقط منطقة الذبذبة.',
    sampleObservationsEn: 'Regardless of how large N becomes, the overshoot peak near the jump discontinuity remains fixed at approximately 8.95%, with ringing simply compressed into a narrower boundary width.',
    sampleErrorAnalysisAr: 'التقريب العددي لمجموع المتسلسلة المحدودة وتأثير معدل العينات الصوتي 44.1 kHz.',
    sampleErrorAnalysisEn: 'Finite truncation of infinite series and audio sample-rate quantization limits.',
  },

  // 27. Math Differential Equations & Slope Fields
  'math-exp-9': {
    id: 'math-exp-9',
    discipline: 'math',
    titleEn: 'Differential Equations & Slope Fields: Euler Numerical Approximation vs Runge-Kutta Integral Curves',
    titleAr: 'المعادلات التفاضلية وحقول الميول: التقريب العددي لأويلر مقابل منحنيات التكامل المتصلة',
    gradeEn: 'Grade 12 Pure Math - Calculus (Differential Equations)',
    gradeAr: 'الصف الثالث الثانوي - الرياضيات البحتة (التفاضل والتكامل: المعادلات التفاضلية وحقول الاتجاه)',
    hypothesisEn: 'The geometric direction field dy/dx = f(x, y) guides solution trajectories; Euler numerical steps y_{n+1} = y_n + h f(x_n, y_n) converge to exact integral curves with global truncation error O(h).',
    hypothesisAr: 'حقل اتجاهات الميول dy/dx = f(x, y) يوجه مسارات الحلول هندسياً؛ وتتقارب خطوات أويلر العددية y_{n+1} = y_n + h f(x_n, y_n) نحو الحل الدقيق بخطأ إجمالي يتناسب طردياً مع خطوة التقريب O(h).',
    apparatusEn: [
      'Dense 2D Slope Field Direction Grid',
      'Initial condition coordinate picker (x0, y0)',
      'Continuous 4th-order Runge-Kutta stream tracer',
      'Discrete Euler numerical stepper with step slider h',
      'Curriculum equation presets (Logistic, Harmonic, Newton Cooling, Separable)',
      'Numerical step comparison table with truncation error analysis',
    ],
    apparatusAr: [
      'شبكة حقول الميول ثنائية الأبعاد لأسهم الاتجاه المماسي',
      'محدد الشروط الابتدائية التفاعلي (x0, y0)',
      'محرك تتبع المنحنى المتصل برونج-كوتا من الرتبة الرابعة',
      'أداة تتبع خطوات أويلر العددية مع التحكم في الخطوة h',
      'نماذج المعادلات المقررة (اللوجستي، التوافقي، تبريد نيوتن، القابلة للفصل)',
      'جدول مقارنة الخطوات وقيم الخطأ المتراكم',
    ],
    stepsEn: [
      'Select Logistic growth dy/dx = 0.8y(1 - y/4).',
      'Pick initial condition (x0, y0) = (0, 0.5) and observe S-shaped sigmoid curve reaching carrying capacity y = 4.',
      'Set Euler step h = 0.4; trace polygon and measure endpoint error at x = 4.',
      'Reduce step h to 0.2, 0.1, and 0.05; record error halving as h halves.',
      'Switch to Harmonic slope dy/dx = -x/y; verify concentric circular integral trajectories.',
    ],
    stepsAr: [
      'اختر معادلة النمو اللوجستي dy/dx = 0.8y(1 - y/4).',
      'حدد الشرط الابتدائي (x0, y0) = (0, 0.5) ولاحظ المنحنى اللوجستي المقارب للخط y = 4.',
      'اضبط خطوة أويلر h = 0.4؛ وتتبع مضلع الحل وقس الخطأ عند x = 4.',
      'صغّر الخطوة إلى 0.2 ثم 0.1 ثم 0.05؛ وسجل تنصيف الخطأ مع تنصيف الخطوة.',
      'انتقل للميول التوافقية dy/dx = -x/y؛ وتأكد من تشكل مسارات دائرية مغلقة.',
    ],
    formula: '\\frac{dy}{dx} = f(x, y), \\quad y_{n+1} = y_n + h f(x_n, y_n), \\quad E_{\\text{global}} \\le C \\cdot h',
    expectedConclusionEn: 'Slope fields visualize dynamic flows without integration, and Euler numerical scheme converges linearly with step size h, verifying the foundation of computational calculus.',
    expectedConclusionAr: 'تكشف حقول الميول السلوك الهندسي للدوال الديناميكية دون الحاجة للتكامل المباشر، وتتقارب طريقة أويلر خطياً مع صغر خطوة التقريب محققة أسس الحساب العددي.',
    columns: [
      { key: 'step_h', labelAr: 'طول خطوة التقريب h', labelEn: 'Euler Step Size h' },
      { key: 'steps_count', labelAr: 'عدد الخطوات المنفذة N', labelEn: 'Number of Steps N' },
      { key: 'euler_y', labelAr: 'قيمة أويلر العددية y(4)', labelEn: 'Euler Numerical y(4)' },
      { key: 'exact_y', labelAr: 'قيمة الحل الدقيق y(4)', labelEn: 'Exact Solution y(4)' },
      { key: 'abs_error', labelAr: 'الخطأ المطلق |y_exact - y_euler|', labelEn: 'Absolute Error' },
      { key: 'error_ratio', labelAr: 'نسبة الخطأ إلى الخطوة E/h', labelEn: 'Ratio Error / h' },
    ],
    sampleRows: [
      { step_h: 'h = 0.40', steps_count: '10 خطوات', euler_y: '3.421', exact_y: '3.784', abs_error: '0.363', error_ratio: '0.908' },
      { step_h: 'h = 0.20', steps_count: '20 خطوة', euler_y: '3.612', exact_y: '3.784', abs_error: '0.172', error_ratio: '0.860' },
      { step_h: 'h = 0.10', steps_count: '40 خطوة', euler_y: '3.701', exact_y: '3.784', abs_error: '0.083', error_ratio: '0.830' },
      { step_h: 'h = 0.05', steps_count: '80 خطوة', euler_y: '3.743', exact_y: '3.784', abs_error: '0.041', error_ratio: '0.820' },
    ],
    sampleObservationsAr: 'أثبتت النتائج أن تنصيف طول الخطوة h يؤدي فورياً إلى تنصيف الخطأ التراكمي المطلق، مما يبرهن أن رتبة تقارب طريقة أويلر من الدرجة الأولى O(h).',
    sampleObservationsEn: 'Halving the step size h directly halved the accumulated global error, confirming that Euler forward method converges with first-order linear precision O(h).',
    sampleErrorAnalysisAr: 'تراكم أخطاء البتر المحلية (Local Truncation Error) الناتجة عن إهمال الحدود غير الخطية في مفكوك تايلور.',
    sampleErrorAnalysisEn: 'Accumulation of local truncation error caused by omitting higher-order Taylor series terms at each discrete step.',
  },

  // 28. Math Linear Programming & Feasible Polygon
  'math-exp-10': {
    id: 'math-exp-10',
    discipline: 'math',
    titleEn: 'Linear Programming & Feasible Polygon Optimization: Extreme Value Vertex Theorem',
    titleAr: 'البرمجة الخطية ومضلع منطقة الحلول الممكنة: نظرية القيم العظمى عند الرؤوس',
    gradeEn: 'Grade 11 / 12 Pure & Applied Math - Algebra & Linear Optimization',
    gradeAr: 'الصف الثاني والثالث الثانوي - الجبر والبرمجة الخطية والحل الأمثل لمسائل التكلفة والإنتاج',
    hypothesisEn: 'The maximum or minimum of linear objective function Z = c1 x + c2 y over convex polygonal feasible region S occurs strictly at one or more corner vertices (Corner Point Theorem).',
    hypothesisAr: 'تقع القيمة العظمى أو الصغرى لدالة الهدف الخطية Z = c1 x + c2 y على منطقة الحلول المحدبة S حتماً عند أحد رؤوس مضلع القيود (نظرية النقطة الرأسية).',
    apparatusEn: [
      'Interactive 2D Cartesian Linear Programming Canvas',
      'Half-plane linear inequality boundary shading engine',
      'Automated convex feasible polygon clipper and vertex solver',
      'Interactive Objective Function line controller with animated sweep',
      'Real-world curriculum scenario presets (Manufacturing, Farming, Diet)',
      'Corner Point vertex evaluation data table with optimal highlighting',
    ],
    apparatusAr: [
      'لوحة استكشاف البرمجة الخطية والحلول المثلى في المستوى ثنائي الأبعاد',
      'محرك تظليل أنصاف المستويات للمتباينات الخطية',
      'محدد مضلع منطقة الحلول الممكنة وحساب إحداثيات الرؤوس تلقائياً',
      'متحكم خط دالة الهدف مع خاصية المسح الديناميكي للربح',
      'نماذج سيناريوهات واقعية مقررة (تصنيع الأثاث، توزيع المحاصيل، وأدنى تكلفة)',
      'جدول تقييم رؤوس الحلول الممكنة وتحديد النقطة المثلى',
    ],
    stepsEn: [
      'Select Furniture Manufacturing preset: 2x + y ≤ 100, x + 2y ≤ 80, x, y ≥ 0.',
      'Identify feasible vertices: (0, 0), (50, 0), (40, 20), (0, 40).',
      'Set profit objective function Z = 40x + 30y.',
      'Evaluate Z at each corner point: Z(0,0)=0, Z(50,0)=2000, Z(0,40)=1200, Z(40,20)=2200.',
      'Animate objective line sweep; confirm parallel profit line leaves polygon at optimal vertex (40, 20).',
    ],
    stepsAr: [
      'اختر نموذج تصنيع الأثاث: 2x + y ≤ 100، x + 2y ≤ 80، x, y ≥ 0.',
      'حدد رؤوس مضلع الحلول الممكنة: (0, 0)، (50, 0)، (40, 20)، (0, 40).',
      'اضبط دالة الهدف للربح Z = 40x + 30y.',
      'احسب Z عند كل رأس: Z(0,0)=0، Z(50,0)=2000، Z(0,40)=1200، Z(40,20)=2200 (الأمثل).',
      'شغّل مسح خط دالة الهدف؛ وتأكد من أن آخر نقطة يلامسها الخط هي الرأس الأمثل (40, 20).',
    ],
    formula: '\\max Z = c_1 x + c_2 y \\quad \\text{subject to} \\quad A \\mathbf{x} \\le \\mathbf{b}, \\; \\mathbf{x} \\ge 0',
    expectedConclusionEn: 'Linear optimization proves the Corner Point Theorem: maximum profit is achieved exclusively at boundary vertices, validating optimal resource allocation for industrial engineering.',
    expectedConclusionAr: 'تبرهن البرمجة الخطية صحة نظرية النقاط الرأسية: يتحقق أقصى ربح حتماً عند أحد رؤوس المضلع، مما يوفر استراتيجية قطعية لإدارة وتخصيص الموارد الصناعية.',
    columns: [
      { key: 'vertex_label', labelAr: 'رأس منطقة الحلول (x, y)', labelEn: 'Feasible Vertex (x, y)' },
      { key: 'constraint_1', labelAr: 'قيد الورشة 1 (2x + y)', labelEn: 'Constraint 1 (2x + y ≤ 100)' },
      { key: 'constraint_2', labelAr: 'قيد الورشة 2 (x + 2y)', labelEn: 'Constraint 2 (x + 2y ≤ 80)' },
      { key: 'obj_val', labelAr: 'قيمة دالة الهدف Z', labelEn: 'Objective Function Z', unit: 'EGP' },
      { key: 'optimality', labelAr: 'حالة النقطة', labelEn: 'Optimality Status' },
    ],
    sampleRows: [
      { vertex_label: '(0, 0)', constraint_1: '0 ≤ 100 (متاح)', constraint_2: '0 ≤ 80 (متاح)', obj_val: '0', optimality: 'نقطة الأصل (انعدام الإنتاج)' },
      { vertex_label: '(50, 0)', constraint_1: '100 ≤ 100 (استنفاد تام)', constraint_2: '50 ≤ 80 (فائض 30)', obj_val: '2000', optimality: 'حل ممكن محلي (إنتاج كراسي فقط)' },
      { vertex_label: '(0, 40)', constraint_1: '40 ≤ 100 (فائض 60)', constraint_2: '80 ≤ 80 (استنفاد تام)', obj_val: '1200', optimality: 'حل ممكن محلي (إنتاج طاولات فقط)' },
      { vertex_label: '(40, 20)', constraint_1: '100 ≤ 100 (استنفاد تام)', constraint_2: '80 ≤ 80 (استنفاد تام)', obj_val: '2200', optimality: 'الحل الأمثل المطلق (أقصى ربح ممكن)' },
    ],
    sampleObservationsAr: 'أظهر جدول التقييم أن الرأس (40, 20) يحقق استغلالاً تاماً لجميع الموارد دون أي هدر في ساعات العمل بالورشتين، مع تحقيق أعلى عائد مالي ممكن قدره 2200 جنيه.',
    sampleObservationsEn: 'Evaluation table demonstrated that vertex (40, 20) fully saturates all resource capacities without idle capacity, generating maximum possible revenue of 2200 EGP.',
    sampleErrorAnalysisAr: 'الافتراض النظري بقابلية المنتجات للتجزئة المستمرة مقارنة بالواقع الذي يتطلب أعداداً صحيحة (البرمجة الخطية الصحيحة Integer Programming).',
    sampleErrorAnalysisEn: 'Continuous divisibility assumption of production variables versus integer reality requiring branch-and-bound integer programming.',
  },
};
