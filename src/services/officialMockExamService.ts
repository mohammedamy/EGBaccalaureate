...
export function getOfficialMockConfig(subjectId: string = 'all', branchId: string = 'all'): OfficialMockConfig {
  ...
  if (normSubject === 'geography' || (normBranch.includes('geo') && !normBranch.includes('geol')) || normBranch.includes('جغراف')) {
    return {
      subjectId: 'geography',
      totalQuestions: 46,
      totalMarks: 60,
  ...
  if (normSubject === 'philosophy' || normBranch.includes('phil') || normBranch.includes('فلسف') || normBranch.includes('منطق')) {
    return {
      ...
      section1Count: 32, // 32 * 1 = 32 marks
      section2Count: 14, // 14 * 2 = 28 marks (Total: 60 marks)
      titleAr: 'امتحان شهادة إتمام الدراسة الثانوية العامة - مادة الفلسفة والمنطق التطبيقي',
      titleEn: 'Official Thanawya Amma Examination - Philosophy & Applied Logic',
      descAr: '٤٦ سؤالاً (٣٢ سؤالاً بدرجة واحدة + ١٤ سؤالاً بدرجتين) بإجمالي ٦٠ درجة في ٣ ساعات كاملة بنظام البابل شيت الرسمي.',
      descEn: '46 questions (32 items @ 1 mark + 14 items @ 2 marks) totaling 60 marks over 3 hours conforming to official ministerial specifications.',
    };
  }
  ...
  if (
    normSubject === 'chinese' ||
    normSubject.includes('chinese') ||
    normSubject.includes('mandarin') ||
    normSubject.includes('صين') ||
    normBranch.includes('chinese') ||
    normBranch.includes('صين') ||
    normBranch.includes('mandarin')
  ) {
    return {
      subjectId: 'chinese',
      totalQuestions: 31,
      ...
      section1Count: 22, // 22 * 1 = 22 marks
      section2Count: 9,  // 9 * 2 = 18 marks (Total: 40 marks)
      titleAr: 'امتحان شهادة إتمام الدراسة الثانوية العامة - مادة اللغة الأجنبية الثانية (الصينية)',
      titleEn: 'Official Thanawya Amma Examination - Chinese (Second Foreign Language)',
      descAr: '٣١ سؤالاً (٢٢ سؤالاً بدرجة واحدة + ٩ أسئلة بدرجتين) بإجمالي ٤٠ درجة في ساعتين كاملتين بنظام البابل شيت الرسمي.',
      descEn: '31 questions (22 items @ 1 mark + 9 items @ 2 marks) totaling 40 marks over 2 hours conforming to official ministerial specifications.',
    };
  }
  ...
  if (
    ...
    normSubject.includes('ذكاء') ||
    normBranch.includes('cs_informatic') ||
    normBranch.includes('حاسب')
  ) {
    return {
      ...
      section1Count: 30, // 30 * 1 = 30 marks
      section2Count: 10, // 10 * 2 = 20 marks (Total: 50 marks)
      titleAr: 'امتحان شهادة إتمام الدراسة الثانوية العامة - مادة الحاسب الآلي وتكنولوجيا المعلومات والاتصالات',
      titleEn: 'Official Thanawya Amma Examination - Computer Science & Informatics',
      descAr: '٤٠ سؤالاً (٣٠ سؤالاً بدرجة واحدة + ١٠ أسئلة بدرجتين) بإجمالي ٥٠ درجة في ٣ ساعات كاملة بنظام البابل شيت الرسمي.',
      descEn: '40 questions (30 items @ 1 mark + 10 items @ 2 marks) totaling 50 marks over 3 hours conforming to official ministerial specifications.',
    };
  }
  ...
  if (
    normSubject === 'earth_space' ||
    normSubject.includes('earth_space') ||
    normSubject.includes('فلك') ||
    normSubject.includes('فضاء') ||
    normSubject.includes('كواكب') ||
    normBranch.includes('earth_space') ||
    normBranch.includes('فلك') ||
    normBranch.includes('فضاء')
  ) {
    return {
  ...
  if (
    normSubject === 'agriculture' ||
    normSubject === 'agricultural_sciences' ||
    normSubject.includes('agri') ||
    normSubject.includes('زراع') ||
    normSubject.includes('أراض') ||
    normBranch.includes('agri') ||
    normBranch.includes('زراع')
  ) {
    return {
      ...
      section1Count: 30, // 30 * 1 = 30 marks
      section2Count: 10, // 10 * 2 = 20 marks (Total: 50 marks)
      titleAr: 'امتحان شهادة إتمام الدراسة الثانوية العامة - مادة العلوم والتكنولوجيا الزراعية',
      titleEn: 'Official Thanawya Amma Examination - Agricultural Sciences & Agrotechnology',
      descAr: '٤٠ سؤالاً (٣٠ سؤالاً بدرجة واحدة + ١٠ أسئلة بدرجتين) بإجمالي ٥٠ درجة في ٣ ساعات كاملة بنظام البابل شيت الرسمي.',
      descEn: '40 questions (30 items @ 1 mark + 10 items @ 2 marks) totaling 50 marks over 3 hours conforming to official ministerial specifications.',
    };
  }
  ...
  if (
    normSubject === 'commercial' ||
    normSubject === 'commercial_sciences' ||
    normSubject.includes('comm') ||
    normSubject.includes('تجار') ||
    normSubject.includes('محاسب') ||
    normSubject.includes('مصرف') ||
    normBranch.includes('comm') ||
    normBranch.includes('تجار')
  ) {
    return {
      ...
      section1Count: 30, // 30 * 1 = 30 marks
      section2Count: 10, // 10 * 2 = 20 marks (Total: 50 marks)
      titleAr: 'امتحان شهادة إتمام الدراسة الثانوية العامة - مادة العلوم التجارية والمحاسبة والمالية',
      titleEn: 'Official Thanawya Amma Examination - Commercial Sciences, Accounting & Banking',
      descAr: '٤٠ سؤالاً (٣٠ سؤالاً بدرجة واحدة + ١٠ أسئلة بدرجتين) بإجمالي ٥٠ درجة في ٣ ساعات كاملة بنظام البابل شيت الرسمي.',
      descEn: '40 questions (30 items @ 1 mark + 10 items @ 2 marks) totaling 50 marks over 3 hours conforming to official ministerial specifications.',
    };
  }
  ...
  if (
    normSubject === 'tourism' ||
    normSubject === 'tourism_hospitality' ||
    normSubject.includes('tour') ||
    normSubject.includes('سياح') ||
    normSubject.includes('ضياف') ||
    normSubject.includes('فندق') ||
    normBranch.includes('tour') ||
    normBranch.includes('سياح')
  ) {
    return {
      subjectId: 'tourism',
      totalQuestions: 40,
      ...
      section1Count: 30, // 30 * 1 = 30 marks
      section2Count: 10, // 10 * 2 = 20 marks (Total: 50 marks)
      titleAr: 'امتحان شهادة إتمام الدراسة الثانوية العامة - مادة السياحة والضيافة وإدارة التراث الثقافي',
      titleEn: 'Official Thanawya Amma Examination - Tourism, Hospitality & Cultural Heritage Management',
      descAr: '٤٠ سؤالاً (٣٠ سؤالاً بدرجة واحدة + ١٠ أسئلة بدرجتين) بإجمالي ٥٠ درجة في ٣ ساعات كاملة بنظام البابل شيت الرسمي.',
      descEn: '40 questions (30 items @ 1 mark + 10 items @ 2 marks) totaling 50 marks over 3 hours conforming to official ministerial specifications.',
    };
  }
  ...
  if (
    normSubject === 'renewable' ||
    normSubject === 'renewable_energy' ||
    normSubject.includes('renew') ||
    normSubject.includes('solar') ||
    normSubject.includes('wind') ||
    normSubject.includes('hydrogen') ||
    normSubject.includes('متجدد') ||
    normSubject.includes('استدام') ||
    normBranch.includes('renew') ||
    normBranch.includes('متجدد')
  ) {
    return {
      subjectId: 'renewable',
      totalQuestions: 40,
      ...
      section1Count: 30, // 30 * 1 = 30 marks
      section2Count: 10, // 10 * 2 = 20 marks (Total: 50 marks)
      titleAr: 'امتحان شهادة إتمام الدراسة الثانوية العامة - مادة الطاقة المتجددة والاستدامة البيئية',
      titleEn: 'Official Thanawya Amma Examination - Renewable Energy & Environmental Sustainability',
      descAr: '٤٠ سؤالاً (٣٠ سؤالاً بدرجة واحدة + ١٠ أسئلة بدرجتين) بإجمالي ٥٠ درجة في ٣ ساعات كاملة بنظام البابل شيت الرسمي.',
      descEn: '40 questions (30 items @ 1 mark + 10 items @ 2 marks) totaling 50 marks over 3 hours conforming to official ministerial specifications.',
    };
  }
