...
export const thanaweyaCurriculum: Curriculum = {
  ...
  branches: [
    ...
    thanaweyaAiDataScienceBranch,
    thanaweyaBiotechnologyBranch,
    thanaweyaNanotechnologyBranch,
  ],
};
