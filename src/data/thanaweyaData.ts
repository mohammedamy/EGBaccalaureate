...
export const thanaweyaCurriculum: Curriculum = {
  ...
  nameAr: 'الثانوية العامة المصرية (الرياضيات والعلوم واللغات والتاريخ والجغرافيا)',
  subtitleEn: 'Grade 12 Standardized Ministry of Education Mathematics, Sciences, Languages, National History & Political Geography (Pure & Applied Math, Physics, Chemistry, Biology, English, French, Arabic, History, Geography)',
  subtitleAr: 'الصف الثالث الثانوي - الصفوف الإتمامية بوزارة التربية والتعليم والتعليم الفني — فروع الرياضيات والعلوم التجريبية واللغات والتاريخ الوطني المصري والجغرافيا السياسية',
