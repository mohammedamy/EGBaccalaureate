...
export const thanaweyaEnglishBranch: Branch = {
  ...
  titleEn: 'English Language (First Foreign Language)',
  titleAr: 'اللغة الإنجليزية (اللغة الأجنبية الأولى)',
