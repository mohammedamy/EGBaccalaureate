...
export const algCh3Databank: ChapterDatabank = {
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Calculate the value of the upper triangular determinant: $\begin{vmatrix} 3 & 5 & -1 \\ 0 & 2 & 7 \\ 0 & 0 & 4 \end{vmatrix}$.",
    "questionAr": "احسب قيمة محدد المصفوفة المثلثية العلوية: $\begin{vmatrix} 3 & 5 & -1 \\ 0 & 2 & 7 \\ 0 & 0 & 4 \end{vmatrix}$.",
    "optionsEn": [
      "$24$",
      "$14$",
      "$0$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the trigonometric determinant: $\begin{vmatrix} \cos \theta & -\sin \theta \\ \sin \theta & \cos \theta \end{vmatrix}$.",
    "questionAr": "احسب ناتج المحدد المثلثي: $\begin{vmatrix} \cos \theta & -\sin \theta \\ \sin \theta & \cos \theta \end{vmatrix}$.",
    "optionsEn": [
      "$1$",
      "$0$",
      "$\\cos 2\\theta$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Evaluate the hyperbolic/trigonometric identity determinant: $\begin{vmatrix} \sec \theta & \tan \theta \\ \tan \theta & \sec \theta \end{vmatrix}$.",
    "questionAr": "احسب قيمة محدد المتطابقة المثلثية: $\begin{vmatrix} \sec \theta & \tan \theta \\ \tan \theta & \sec \theta \end{vmatrix}$.",
    "optionsEn": [
      "$1$",
      "$-1$",
      "$0$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the value of the exponential determinant: $\begin{vmatrix} e^x & e^{2x} \\ e^{-x} & 1 \end{vmatrix}$.",
    "questionAr": "عيّن قيمة محدد الدوال الأسية: $\begin{vmatrix} e^x & e^{2x} \\ e^{-x} & 1 \end{vmatrix}$.",
    "optionsEn": [
      "$0$",
      "$e^x$",
      "$e^{3x}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Using change-of-base logarithmic rules, evaluate: $\begin{vmatrix} \log_2 3 & \log_2 5 \\ \log_5 2 & \log_3 2 \end{vmatrix}$.",
    "questionAr": "باستخدام قوانين تغيير الأساس اللوغاريتمي، احسب قيمة المحدد: $\begin{vmatrix} \log_2 3 & \log_2 5 \\ \log_5 2 & \log_3 2 \end{vmatrix}$.",
    "optionsEn": [
      "$0$",
      "$1$",
      "$-1$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the determinant of the diagonal matrix containing cube roots of unity: $\begin{vmatrix} \omega & 0 & 0 \\ 0 & \omega^2 & 0 \\ 0 & 0 & 1 \end{vmatrix}$.",
    "questionAr": "أوجد محدد المصفوفة القطرية المشتملة على الجذور التكعيبية للواحد: $\begin{vmatrix} \omega & 0 & 0 \\ 0 & \omega^2 & 0 \\ 0 & 0 & 1 \end{vmatrix}$.",
    "optionsEn": [
      "$1$",
      "$\\omega$",
      "$\\omega^2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the inverse of the diagonal matrix $D = \begin{pmatrix} 2 & 0 \\ 0 & 5 \end{pmatrix}$.",
    "questionAr": "عيّن معكوس المصفوفة القطرية $D = \begin{pmatrix} 2 & 0 \\ 0 & 5 \end{pmatrix}$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the determinant of the triangular matrix: $\begin{vmatrix} 2 & 7 & -5 \\ 0 & -3 & 4 \\ 0 & 0 & 5 \end{vmatrix}$.",
    "questionAr": "أوجد قيمة محدد المصفوفة المثلثية: $\begin{vmatrix} 2 & 7 & -5 \\ 0 & -3 & 4 \\ 0 & 0 & 5 \end{vmatrix}$.",
    "optionsEn": [
      "$-30$",
      "30",
      "0",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Given that $A$ is a $3 \times 3$ matrix with $\det(A) = 4$, determine the value of $\det(2A)$.",
    "questionAr": "إذا كانت $A$ مصفوفة على النظم $3 \times 3$ بحيث $\det(A) = 4$، فعيّن قيمة $\det(2A)$.",
    "optionsEn": [
      "32",
      "8",
      "16",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "If $A$ is a $2 \times 2$ matrix with determinant $|A| = -5$, calculate $|\text{adj}(A)|$.",
    "questionAr": "إذا كانت $A$ مصفوفة مربعة من النظم $2 \times 2$ محددها $|A| = -5$، فاحسب $|\text{adj}(A)|$.",
    "optionsEn": [
      "$-5$",
      "$5$",
      "$25$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Apply column operations to evaluate the determinant: $\begin{vmatrix} 1 & a & b+c \\ 1 & b & c+a \\ 1 & c & a+b \end{vmatrix}$.",
    "questionAr": "باستخدام خواص الأعمدة، احسب قيمة المحدد: $\begin{vmatrix} 1 & a & b+c \\ 1 & b & c+a \\ 1 & c & a+b \end{vmatrix}$.",
    "optionsEn": [
      "$0$",
      "$a+b+c$",
      "$abc$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "If $A$ is a $3 \times 3$ matrix with $\text{adj}(A) = M$, determine the expression for $\text{adj}(2A)$ in terms of $M$.",
    "questionAr": "إذا كانت $A$ مصفوفة على النظم $3 \times 3$ وملحقتها $\text{adj}(A) = M$، فعيّن $\text{adj}(2A)$ بدلالة $M$.",
    "optionsEn": [
      "$4 M$",
      "$8 M$",
      "$2 M$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "For a $3 \times 3$ matrix $A$ with $|A| = 3$, evaluate $|\text{adj}(2A)|$.",
    "questionAr": "لمصفوفة $A$ على النظم $3 \times 3$ محددها $|A| = 3$، احسب قيمة $|\text{adj}(2A)|$.",
    "optionsEn": [
      "$576$",
      "$144$",
      "$72$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Evaluate the classic Vandermonde determinant: $\begin{vmatrix} 1 & 1 & 1 \\ a & b & c \\ a^2 & b^2 & c^2 \end{vmatrix}$.",
    "questionAr": "احسب قيمة محدد فاندرموند الكلاسيكي: $\begin{vmatrix} 1 & 1 & 1 \\ a & b & c \\ a^2 & b^2 & c^2 \end{vmatrix}$.",
    "optionsEn": [
      "$(b - a)(c - a)(c - b)$",
      "$(a - b)(b - c)(c - a)$",
      "$abc$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "If $A$ is a $3 \times 3$ matrix with $|A| = 2$, determine the determinant of the inverse of its adjoint: $|(\text{adj}(A))^{-1}|$.",
    "questionAr": "إذا كانت $A$ مصفوفة على النظم $3 \times 3$ بحيث $|A| = 2$، فعيّن محدد معكوس ملحقتها: $|(\text{adj}(A))^{-1}|$.",
    "optionsEn": [
      "$1/4$",
      "$4$",
      "$1/8$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "If $A$ is a $3 \times 3$ matrix with $|A| = -3$, compute the determinant of the product with its transpose: $|A A^T|$.",
    "questionAr": "إذا كانت $A$ مصفوفة على النظم $3 \times 3$ حيث $|A| = -3$، فاحسب محدد حاصل ضربها في مدورها: $|A A^T|$.",
    "optionsEn": [
      "$9$",
      "$-9$",
      "$27$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Given a $3 \times 3$ matrix $A$ with $\det(A) = 5$, calculate $\det(\operatorname{adj}(A))$.",
    "questionAr": "إذا كانت $A$ مصفوفة على النظم $3 \times 3$ بحيث $\det(A) = 5$، فاحسب $\det(\operatorname{adj}(A))$.",
    "optionsEn": [
      "25",
      "5",
      "125",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Compute the transposed Vandermonde determinant: $\begin{vmatrix} 1 & a & a^2 \\ 1 & b & b^2 \\ 1 & c & c^2 \end{vmatrix}$.",
    "questionAr": "احسب قيمة محدد فاندرموند المنقول: $\begin{vmatrix} 1 & a & a^2 \\ 1 & b & b^2 \\ 1 & c & c^2 \end{vmatrix}$.",
    "optionsEn": [
      "$(b - a)(c - a)(c - b)$",
      "$(a - b)(b - c)(c - a)$",
      "$(a + b)(b + c)(c + a)$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "For a $3 \times 3$ matrix $A$ with $|A| = 2$, evaluate the iterated adjoint determinant: $|\text{adj}(\text{adj}(A))|$.",
    "questionAr": "لمصفوفة $A$ من الرتبة $3 \times 3$ حيث $|A| = 2$، احسب محدد المصفوفة الملحقة للملحقة: $|\text{adj}(\text{adj}(A))|$.",
    "optionsEn": [
      "$16$",
      "$8$",
      "$64$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "If $R(\theta) = \begin{pmatrix} \cos \theta & -\sin \theta \\ \sin \theta & \cos \theta \end{pmatrix}$, determine the $n$-th power matrix $[R(\theta)]^n$.",
    "questionAr": "إذا كانت $R(\theta) = \begin{pmatrix} \cos \theta & -\sin \theta \\ \sin \theta & \cos \theta \end{pmatrix}$، فعيّن مصفوفة القوة النونية $[R(\theta)]^n$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Given the rotation matrix $J = \begin{pmatrix} 0 & -1 \\ 1 & 0 \end{pmatrix}$, compute $J^{102}$.",
    "questionAr": "إذا كانت مصفوفة الدوران $J = \begin{pmatrix} 0 & -1 \\ 1 & 0 \end{pmatrix}$، فاحسب $J^{102}$.",
    "optionsEn": [
      "$-I$",
      "$I$",
      "$J$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "If $A$ is a $3 \times 3$ matrix with $\text{rank}(A) = 2$, determine $\text{rank}(\text{adj}(A))$.",
    "questionAr": "إذا كانت $A$ مصفوفة على النظم $3 \times 3$ ورتبتها $\text{rank}(A) = 2$، فعيّن رتبة مصفوفة الملحقة $\text{rank}(\text{adj}(A))$.",
    "optionsEn": [
      "$1$",
      "$2$",
      "$0$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "If $A$ is a $3 \times 3$ matrix with $\text{rank}(A) = 1$, what is the adjoint matrix $\text{adj}(A)$?",
    "questionAr": "إذا كانت $A$ مصفوفة على النظم $3 \times 3$ ورتبتها $\text{rank}(A) = 1$، فما هي المصفوفة الملحقة $\text{adj}(A)$؟",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Using properties of the cube roots of unity, evaluate: $\begin{vmatrix} 1 & \omega & \omega^2 \\ \omega^2 & 1 & \omega \\ \omega & \omega^2 & 1 \end{vmatrix}$.",
    "questionAr": "باستخدام خواص الجذور التكعيبية للواحد الصحيح، احسب: $\begin{vmatrix} 1 & \omega & \omega^2 \\ \omega^2 & 1 & \omega \\ \omega & \omega^2 & 1 \end{vmatrix}$.",
    "optionsEn": [
      "$0$",
      "$3$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Differentiate the determinant function $f(x) = \begin{vmatrix} x^2 & x \\ 3 & 1 \end{vmatrix}$ and evaluate $f'(2)$.",
    "questionAr": "فاضل دالة المحدد $f(x) = \begin{vmatrix} x^2 & x \\ 3 & 1 \end{vmatrix}$ ثم احسب $f'(2)$.",
    "optionsEn": [
      "$1$",
      "$4$",
      "$7$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "For the diagonal matrix $A = \begin{pmatrix} 2 & 0 \\ 0 & 3 \end{pmatrix}$, determine the determinant of the matrix exponential: $|e^A|$.",
    "questionAr": "للمصفوفة القطرية $A = \begin{pmatrix} 2 & 0 \\ 0 & 3 \end{pmatrix}$، عيّن محدد الدالة الأسية المصفوفية: $|e^A|$.",
    "optionsEn": [
      "$e^5$",
      "$e^6$",
      "$5e$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "If $D = \text{diag}(2, 3, 4)$, calculate the classical adjoint matrix $\text{adj}(D)$.",
    "questionAr": "إذا كانت $D = \text{diag}(2, 3, 4)$، فاحسب المصفوفة الملحقة $\text{adj}(D)$.",
    "optionsEn": [
      "$\\text{diag}(12, 8, 6)$",
      "$\\text{diag}(2, 3, 4)$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Compute the upper triangular trigonometric determinant: $\begin{vmatrix} 1 & \cos 2\theta & \cos 4\theta \\ 0 & 2\cos^2 \theta & 2\cos^2 2\theta \\ 0 & 0 & 1 \end{vmatrix}$.",
    "questionAr": "احسب قيمة محدد المصفوفة المثلثية العلوية: $\begin{vmatrix} 1 & \cos 2\theta & \cos 4\theta \\ 0 & 2\cos^2 \theta & 2\cos^2 2\theta \\ 0 & 0 & 1 \end{vmatrix}$.",
    "optionsEn": [
      "$2\\cos^2 \\theta$",
      "$\\cos 2\\theta$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Determine the factored expression for the higher-degree alternating determinant: $\begin{vmatrix} 1 & 1 & 1 \\ a & b & c \\ a^3 & b^3 & c^3 \end{vmatrix}$.",
    "questionAr": "عيّن الصورة المحللة لمحدد الدرجة العليا المتناوب: $\begin{vmatrix} 1 & 1 & 1 \\ a & b & c \\ a^3 & b^3 & c^3 \end{vmatrix}$.",
    "optionsEn": [
      "$(b - a)(c - a)(c - b)(a + b + c)$",
      "$(a - b)(b - c)(c - a)$",
      "$(b - a)(c - a)(c - b)$",
