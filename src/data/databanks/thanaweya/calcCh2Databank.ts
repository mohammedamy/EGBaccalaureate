...
export const calcCh2Databank: ChapterDatabank = {
  ...
  },
  {
  ...
  },
    {
        ...
        "titleEn": "Slope of Tangent to Exponential Product Curve",
        "titleAr": "ميل المماس لمنحنى حاصل ضرب دالة أسية",
        "difficulty": "medium",
        "questionEn": "Find the slope of the tangent line to the curve $y = x^2 e^{2x}$ at the point where $x = 1$.",
        "questionAr": "أوجد ميل المماس للمنحنى $y = x^2 e^{2x}$ عند النقطة التي إحداثيها السيني $x = 1$.",
        "optionsEn": [
            "$4e^2$",
            "$2e^2$",
            "$3e^2$",
        ...
        "correctAnswer": "$4e^2$",
        "correctIndex": 0,
        "hintEn": "Apply the product rule for differentiation: $\\frac{d}{dx}[u \\cdot v] = u' v + u v'$, then substitute $x = 1$.",
        "hintAr": "طبق قاعدة اشتقاق حاصل ضرب دالتين: $(u \\cdot v)' = u' v + u v'$ ثم عوض عن $x = 1$.",
        "stepByStepSolutionEn": [
            "1. Differentiate $y = x^2 e^{2x}$ with respect to $x$ using the product rule:",
            "   $\\frac{dy}{dx} = \\frac{d}{dx}(x^2) \\cdot e^{2x} + x^2 \\cdot \\frac{d}{dx}(e^{2x})$.",
            "2. Compute the derivatives:",
            "   $\\frac{dy}{dx} = 2x e^{2x} + x^2(2e^{2x}) = 2x(1 + x)e^{2x}$.",
            "3. Substitute $x = 1$:",
            "   $\\frac{dy}{dx}\\Big|_{x=1} = 2(1)(1 + 1)e^{2(1)} = 2(2)e^2 = 4e^2$."
        ],
        "stepByStepSolutionAr": [
            "١. اشتق الدالة $y = x^2 e^{2x}$ باستخدام قاعدة ضرب دالتين:",
            "   $\\frac{dy}{dx} = 2x \\cdot e^{2x} + x^2 \\cdot 2e^{2x}$.",
            "٢. أخذ العامل المشترك:",
            "   $\\frac{dy}{dx} = 2x(1 + x)e^{2x}$.",
            "٣. بالتعويض عن $x = 1$:",
            "   $y'(1) = 2(1)(2)e^2 = 4e^2$."
        ],
        "teacherTipEn": "Remember that the derivative of $e^{kx}$ is $k e^{kx}$. Factoring out $e^{2x}$ makes arithmetic substitution much faster and cleaner.",
        "teacherTipAr": "تذكر أن مشتقة $e^{kx}$ هي $k e^{kx}$، وأخذ العامل المشترك يسهل عملية التعويض الحسابي."
    },
  {
  ...
  "titleEn": "Limit of Difference of Exponential Bases",
  "titleAr": "نهاية الفرق بين أساسين أسّيين مختلفين",
  "difficulty": "medium",
  "questionEn": "Evaluate the limit: $\\lim_{x \\to 0} \\frac{3^x - 2^x}{x}$",
  "questionAr": "احسب قيمة النهاية: $\\lim_{x \\to ٠} \\frac{٣^x - ٢^x}{x}$",
  "optionsEn": [
    "$\\ln(3/2)$",
    "$\\ln(6)$",
    "$\\ln(5)$",
  ...
  "correctAnswer": "$\\ln(3/2)$",
  "correctIndex": 0,
  "hintEn": "Subtract and add 1 in the numerator: (3^x - 1)/x - (2^x - 1)/x, or use L'Hopital's rule.",
  "hintAr": "اطرح واجمع 1 في البسط: $\\frac{٣^x - ١}{x} - \\frac{٢^x - ١}{x}$ أو طبق قاعدة لوبيتال.",
  "stepByStepSolutionEn": [
    "1. Split the limit: $\\lim_{x \\to 0} \\left[ \\frac{3^x - 1}{x} - \\frac{2^x - 1}{x} \\right]$.",
    "2. Using the standard exponential limit $\\lim_{x \\to 0} \\frac{a^x - 1}{x} = \\ln(a)$:",
    "3. First term gives $\\ln(3)$, and second term gives $\\ln(2)$.",
    "4. Result: $\\ln(3) - \\ln(2) = \\ln\\left(\\frac{3}{2}\\right)$."
  ],
  "stepByStepSolutionAr": [
    "١. فصل النهاية بإضافة وطرح ١: $\\lim_{x \\to ٠} \\left[ \\frac{٣^x - ١}{x} - \\frac{٢^x - ١}{x} \\right]$.",
    "٢. بتطبيق النظرية القياسية لنهاية الدالة الأسية $\\lim_{x \\to ٠} \\frac{a^x - ١}{x} = \\ln a$:",
    "٣. الحد الأول يساوي $\\ln(٣)$ والحد الثاني يساوي $\\ln(٢)$.",
    "٤. إذن: $\\ln(٣) - \\ln(٢) = \\ln\\left(\\frac{٣}{٢}\\right)$."
  ],
  "teacherTipEn": "Standard theorem: lim (a^x - b^x)/x as x -> 0 is always ln(a/b).",
  "teacherTipAr": "قاعدة قياسية مباشرة: نهاية (أ^س - ب^س) / س عندما س تؤول للصفر تساوي دائماً لوغاريتم (أ / ب)."
},
  {
  ...
  "titleEn": "Logarithmic Differentiation of Variable Base and Exponent",
  "titleAr": "الاشتقاق اللوغاريتمي لدالة ذات أساس وأس متغيرين",
  "difficulty": "hots",
  "questionEn": "If $y = x^{\\sin(x)}$ for $x > 0$, find the value of $\\frac{dy}{dx}$ at $x = \\frac{\\pi}{2}$.",
  "questionAr": "إذا كان $y = x^{\\sin(x)}$ حيث $x > ٠$، فأوجد قيمة $\\frac{dy}{dx}$ عند $x = \\frac{\\pi}{٢}$.",
  "optionsEn": [
    "1",
    "$\\frac{\\pi}{2}$",
  ...
  "optionsAr": [
    "١",
    "\\frac{\\pi}{٢}",
    "\\ln\\left(\\frac{\\pi}{٢}\\right)",
    "٠"
  ],
  "correctAnswer": "1",
  "correctIndex": 0,
  "hintEn": "Take the natural logarithm of both sides: ln(y) = sin(x) * ln(x), then differentiate implicitly.",
  "hintAr": "بأخذ اللوغاريتم الطبيعي للطرفين: $\\ln y = \\sin x \\ln x$ ثم الاشتقاق الضمني بالنسبة إلى س.",
  "stepByStepSolutionEn": [
    "1. Take natural logarithm: $\\ln y = \\sin(x) \\ln(x)$.",
    "2. Differentiate both sides with respect to $x$: $\\frac{1}{y} \\frac{dy}{dx} = \\cos(x) \\ln(x) + \\frac{\\sin(x)}{x}$.",
    "3. At $x = \\frac{\\pi}{2}$: $y = (\\frac{\\pi}{2})^{\\sin(\\pi/2)} = (\\frac{\\pi}{2})^1 = \\frac{\\pi}{2}$.",
    "4. Evaluate right side: $\\cos(\\frac{\\pi}{2}) \\ln(\\frac{\\pi}{2}) + \\frac{\\sin(\\pi/2)}{\\pi/2} = 0 + \\frac{1}{\\pi/2} = \\frac{2}{\\pi}$.",
    "5. Multiplying by $y$: $\\frac{dy}{dx} = y \\times \\frac{2}{\\pi} = \\frac{\\pi}{2} \\times \\frac{2}{\\pi} = 1$."
  ],
  "stepByStepSolutionAr": [
    "١. بأخذ اللوغاريتم الطبيعي: $\\ln y = \\sin(x) \\ln(x)$.",
    "٢. بالاشتقاق الضمني: $\\frac{١}{y} \\frac{dy}{dx} = \\cos(x) \\ln(x) + \\frac{\\sin(x)}{x}$.",
    "٣. عند $x = \\frac{\\pi}{٢}$: $y = (\\frac{\\pi}{٢})^{\\sin(\\pi/٢)} = \\frac{\\pi}{٢}$.",
    "٤. حساب الطرف الأيمن: $٠ + \\frac{١}{\\pi/٢} = \\frac{٢}{\\pi}$.",
    "٥. بالضرب في $y$: $\\frac{dy}{dx} = \\frac{\\pi}{٢} \\times \\frac{٢}{\\pi} = ١$."
  ],
  "teacherTipEn": "Functions with variable base and variable exponent always require logarithmic differentiation.",
  "teacherTipAr": "أي دالة فيها الأساس متغير والأس متغير تتطلب حتماً استخدام الاشتقاق اللوغاريتمي بأخذ اللوغاريتم للطرفين."
},
  {
  ...
  },
  {
  ...
  },
    {
        ...
        "titleEn": "Standard Exponential and Trigonometric Limit",
        "titleAr": "نهاية دالة أسية ومثلثية قياسية",
        "difficulty": "hots",
        "questionEn": "Evaluate the limit: $\\lim_{x \\to 0} \\frac{e^{3x} - \\cos 2x}{x}$.",
        "questionAr": "أوجد قيمة النهاية: $\\lim_{x \\to 0} \\frac{e^{3x} - \\cos 2x}{x}$.",
        "optionsEn": [
            "$3$",
            "$5$",
            "$1$",
        ...
        "correctAnswer": "$3$",
        "correctIndex": 0,
        "hintEn": "Add and subtract 1 in the numerator to separate the expression into the fundamental exponential limit $\\lim_{x \\to 0} \\frac{e^{3x} - 1}{x}$ and trigonometric limit $\\lim_{x \\to 0} \\frac{1 - \\cos 2x}{x}$.",
        "hintAr": "أضف واطرح 1 في البسط لفصل النهاية إلى نهاية أسية قياسية $\\lim_{x \\to 0} \\frac{e^{3x} - 1}{x}$ ونهاية مثلثية $\\lim_{x \\to 0} \\frac{1 - \\cos 2x}{x}$.",
        "stepByStepSolutionEn": [
            "1. Rewrite the numerator by adding and subtracting 1:",
            "   $\\frac{e^{3x} - \\cos 2x}{x} = \\frac{(e^{3x} - 1) + (1 - \\cos 2x)}{x} = \\frac{e^{3x} - 1}{x} + \\frac{1 - \\cos 2x}{x}$.",
            "2. Evaluate the first limit using the standard formula $\\lim_{u \\to 0} \\frac{e^u - 1}{u} = 1$:",
            "   $\\lim_{x \\to 0} \\frac{e^{3x} - 1}{x} = 3 \\lim_{x \\to 0} \\frac{e^{3x} - 1}{3x} = 3(1) = 3$.",
            "3. Evaluate the second limit using the standard trigonometric identity:",
            "   $\\lim_{x \\to 0} \\frac{1 - \\cos 2x}{x} = 0$.",
            "4. Add the two limits: $3 + 0 = 3$."
        ],
        "stepByStepSolutionAr": [
            "١. أعد كتابة البسط بإضافة وطرح 1:",
            "   $\\lim_{x \\to 0} \\left[\\frac{e^{3x} - 1}{x} + \\frac{1 - \\cos 2x}{x}\\right]$.",
            "٢. النهاية الأولى هي نهاية أسية قياسية:",
            "   $\\lim_{x \\to 0} \\frac{e^{3x} - 1}{x} = 3$.",
            "٣. النهاية الثانية هي نهاية مثلثية قياسية قيمتها صفر:",
            "   $\\lim_{x \\to 0} \\frac{1 - \\cos 2x}{x} = 0$.",
            "٤. مجموع النهايتين هو: $3 + 0 = 3$."
        ],
        "teacherTipEn": "You can quickly verify using L’Hôpital’s rule: $\\lim_{x \\to 0} \\frac{3e^{3x} + 2\\sin 2x}{1} = 3(1) + 2(0) = 3$.",
        "teacherTipAr": "يمكنك التحقق السريع باستخدام قاعدة لوبيتال: مشتقة البسط على مشتقة المقام تعطي $3e^0 + 2\\sin 0 = 3$."
    },
  {
  ...
  "titleEn": "Equation of Tangent to Natural Exponential Curve",
  "titleAr": "معادلة المماس لمنحنى الدالة الأسية الطبيعية",
  "difficulty": "hots",
  "questionEn": "Find the equation of the tangent line to the exponential curve $y = e^{2x}$ at the point where the curve intersects the $y$-axis.",
  "questionAr": "أوجد معادلة المماس لمنحنى الدالة الأسية $y = e^{٢x}$ عند نقطة تقاطعه مع محور الصادات.",
  "optionsEn": [
    "$2x - y + 1 = 0$",
    "$2x + y - 1 = 0$",
    "$x - 2y + 2 = 0$",
  ...
  "correctIndex": 0,
  "hintEn": "Intersection with y-axis has x = 0, so y = e^0 = 1. The slope is m = y'(0).",
  "hintAr": "التقاطع مع محور الصادات يكون عند x = 0، إذن y = e^0 = 1. وميل المماس هو m = y'(0).",
  "stepByStepSolutionEn": [
    "1. Find point of tangency: at $x = 0$, $y = e^{2(0)} = e^0 = 1$. The point is $(0, 1)$.",
    "2. Derivative of exponential function: $\\frac{dy}{dx} = 2 e^{2x}$.",
    "3. Slope at $x = 0$: $m = 2 e^0 = 2$.",
    "4. Tangent line equation: $y - 1 = 2(x - 0) \\implies y = 2x + 1 \\implies 2x - y + 1 = 0$."
  ],
  "stepByStepSolutionAr": [
    "١. نقطة التماس: عند $x = ٠$ نجد أن $y = e^{٠} = ١$، فالنقطة هي $(٠، ١)$.",
    "٢. مشتقة الدالة الأسية: $\\frac{dy}{dx} = ٢ e^{٢x}$.",
    "٣. ميل المماس عند $x = ٠$: $m = ٢ e^٠ = ٢$.",
    "٤. معادلة المماس: $y - ١ = ٢(x - ٠) \\implies y = ٢x + ١ \\implies ٢x - y + ١ = ٠$."
  ],
  "teacherTipEn": "The derivative of e^(k x) is k * e^(k x).",
  "teacherTipAr": "مشتقة الدالة هـ^(أ س) هي أ × هـ^(أ س)."
},
  {
  ...
  },
  {
  ...
  },
    {
        ...
        "titleEn": "Equation of Tangent Line to Gaussian Bell Curve",
        "titleAr": "معادلة المماس للمنحنى الأسي الغوسي",
        "difficulty": "hots",
        "questionEn": "Find the Cartesian equation of the tangent line to the curve $y = e^{-x^2}$ at the point where $x = 1$.",
        "questionAr": "أوجد معادلة خط المماس للمنحنى $y = e^{-x^2}$ عند النقطة التي إحداثيها السيني $x = 1$.",
        "optionsEn": [
            "$2x + ey - 3 = 0$",
            "$2x - ey - 1 = 0$",
            "$x + ey - 2 = 0$",
        ...
        "correctAnswer": "$2x + ey - 3 = 0$",
        "correctIndex": 0,
        "hintEn": "Find the point $(x_1, y_1) = (1, e^{-1})$, then compute the derivative $y' = -2x e^{-x^2}$ to find the slope $m$, and apply the point-slope form $y - y_1 = m(x - x_1)$.",
        "hintAr": "أوجد نقطة التماس $(1, e^{-1})$، ثم احسب المشتقة الأولى $y' = -2x e^{-x^2}$ لإيجاد الميل $m$، ثم طبق معادلة الخط المستقيم.",
        "stepByStepSolutionEn": [
            "1. Find the coordinates of the point of tangency when $x = 1$:",
            "   $y_1 = e^{-(1)^2} = e^{-1} = \\frac{1}{e}$. Point is $\\left(1, \\frac{1}{e}\\right)$.",
            "2. Differentiate $y = e^{-x^2}$ with respect to $x$:",
            "   $\\frac{dy}{dx} = -2x e^{-x^2}$.",
            "3. Calculate the slope $m$ at $x = 1$:",
            "   $m = -2(1)e^{-1} = -\\frac{2}{e}$.",
            "4. Write the equation of the tangent line:",
            "   $y - \\frac{1}{e} = -\\frac{2}{e}(x - 1)$.",
            "5. Multiply by $e$ to clear denominators:",
            "   $ey - 1 = -2(x - 1) = -2x + 2 \\implies 2x + ey - 3 = 0$."
        ],
        "stepByStepSolutionAr": [
            "١. أوجد إحداثيات نقطة التماس عند $x = 1$:",
            "   $y_1 = e^{-1} = \\frac{1}{e}$. نقطة التماس هي $(1, \\frac{1}{e})$.",
            "٢. اشتق الدالة بالنسبة لـ $x$:",
            "   $\\frac{dy}{dx} = -2x e^{-x^2}$.",
            "٣. احسب ميل المماس $m$ عند $x = 1$:",
            "   $m = -2(1)e^{-1} = -\\frac{2}{e}$.",
            "٤. طبق معادلة الخط المستقيم المار بالنقطة المعلومة بالميل $m$:",
            "   $y - \\frac{1}{e} = -\\frac{2}{e}(x - 1)$.",
            "٥. اضرب طرفي المعادلة في $e$ وبسط:",
            "   $ey - 1 = -2x + 2 \\implies 2x + ey - 3 = 0$."
        ],
        "teacherTipEn": "Clearing denominators by multiplying through by $e$ gives the standard linear equation form $Ax + By + C = 0$ expected in examinations.",
        "teacherTipAr": "ضرب المعادلة في $e$ للتخلص من المقام يعطيك المعادلة الخطية بالصورة العامة $Ax + By + C = 0$ كما في الامتحانات."
    }
]
};
