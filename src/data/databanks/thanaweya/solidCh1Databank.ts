...
export const solidCh1Databank: ChapterDatabank = {
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Calculate the perpendicular distance from point $P(3, -4, 5)$ to the x-axis.",
    "questionAr": "احسب البعد العمودي للنقطة $P(3, -4, 5)$ عن محور السينات.",
    "optionsEn": [
      "5",
      "12",
      "13",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the distance from point $P(2, -3, 6)$ to the y-axis.",
    "questionAr": "عيّن بعد النقطة $P(2, -3, 6)$ عن محور الصادات.",
    "optionsEn": [
      "10",
      "5",
      "\\sqrt{61}",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the scalar product $\\vec{A} \\cdot \\vec{B}$ for $\\vec{A} = (2, -1, 3)$ and $\\vec{B} = (1, 4, -2)$.",
    "questionAr": "احسب الضرب القياسي $\\vec{A} \\cdot \\vec{B}$ للمتجهين $\\vec{A} = (2, -1, 3)$ و $\\vec{B} = (1, 4, -2)$.",
    "optionsEn": [
      "(-2, 5, -7)",
      "(2, -5, 7)",
      "(-2, -5, -7)",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the vector cross product $\\vec{A} \\times \\vec{B}$ given $\\vec{A} = (1, 2, -1)$ and $\\vec{B} = (3, 0, 1)$.",
    "questionAr": "عيّن حاصل الضرب الاتجاهي $\\vec{A} \\times \\vec{B}$ إذا كان $\\vec{A} = (1, 2, -1)$ و $\\vec{B} = (3, 0, 1)$.",
    "optionsEn": [
      "(-2, 3, -5)",
      "(2, -3, 5)",
      "(5, -3, 2)",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Compute the volume of the parallelepiped via $(\\vec{A} \\times \\vec{B}) \\cdot \\vec{C}$ with $\\vec{A} = (2, 3, -1)$, $\\vec{B} = (1, -2, 4)$, and $\\vec{C} = (3, 1, 0)$.",
    "questionAr": "احسب ناتج الضرب الثلاثي القياسي $(\\vec{A} \\times \\vec{B}) \\cdot \\vec{C}$ للمتجهات المعطاة.",
    "optionsEn": [
      "18",
      "30",
      "24",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Determine the scalar triple product $\\vec{u} \\cdot (\\vec{v} \\times \\vec{w})$ for $\\vec{u} = (1, 0, 2)$, $\\vec{v} = (2, -1, 3)$, and $\\vec{w} = (0, 1, 1)$.",
    "questionAr": "عيّن حاصل الضرب القياسي الثلاثي $\\vec{u} \\cdot (\\vec{v} \\times \\vec{w})$ للمتجهات الثلاثة.",
    "optionsEn": [
      "16",
      "20",
      "8",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the cross product $\\vec{u} \\times \\vec{v}$ where $\\vec{u} = (2, -1, 1)$ and $\\vec{v} = (1, 1, -2)$.",
    "questionAr": "أوجد حاصل الضرب الاتجاهي $\\vec{u} \\times \\vec{v}$ حيث $\\vec{u} = (2, -1, 1)$ و $\\vec{v} = (1, 1, -2)$.",
    "optionsEn": [
      "-15",
      "15",
      "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Evaluate the scalar triple product $\\vec{A} \\cdot (\\vec{B} \\times \\vec{C})$ for $\\vec{A} = (1, 2, 3)$, $\\vec{B} = (-1, 0, 2)$, and $\\vec{C} = (2, -1, 1)$.",
    "questionAr": "احسب حاصل الضرب القياسي الثلاثي $\\vec{A} \\cdot (\\vec{B} \\times \\vec{C})$ للمتجهات الثلاثة.",
    "optionsEn": [
      "0",
      "\\|\\vec{A}\\| \\|\\vec{B}\\|",
      "1",
