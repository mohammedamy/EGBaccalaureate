...
export const algCh1Databank: ChapterDatabank = {
  easy: [
  {
    ...
    "difficulty": "easy",
    "questionEn": "Evaluate the sum: $0! + 1!$.",
    "questionAr": "احسب قيمة المقدار: $٠! + ١!$.",
    "optionsEn": [
      "2",
      "1",
      "0",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Evaluate: $\\frac{7!}{5! \\times 2!}$.",
    "questionAr": "احسب قيمة: $\\frac{٧!}{٥! \\times ٢!}$.",
    "optionsEn": [
      "21",
      "42",
      "14",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "If $n! = 720$, find the value of $n$.",
    "questionAr": "إذا كان $n! = ٧٢٠$، فأوجد قيمة $n$.",
    "optionsEn": [
      "6",
      "5",
      "7",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "If $(n + 1)! = 30(n - 1)!$, find the value of $n$.",
    "questionAr": "إذا كان $(n + ١)! = ٣٠(n - ١)!$، فأوجد قيمة $n$.",
    "optionsEn": [
      "n = 5",
      "n = 6",
      "n = 4",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "If $P(n, 2) = 30$, find $n$.",
    "questionAr": "إذا كان $P(n, ٢) = ٣٠$، فأوجد قيمة $n$.",
    "optionsEn": [
      "6",
      "5",
      "7",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "If $P(7, r) = 210$, find the value of $r$.",
    "questionAr": "إذا كان $P(٧، r) = ٢١٠$، فأوجد قيمة $r$.",
    "optionsEn": [
      "3",
      "2",
      "4",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "If $P(n, 3) = 6 \\times P(n, 2)$, find $n$.",
    "questionAr": "إذا كان $P(n, ٣) = ٦ \\times P(n, ٢)$، فأوجد قيمة $n$.",
    "optionsEn": [
      "8",
      "7",
      "9",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "If $\\binom{n}{5} = \\binom{n}{3}$, find $n$.",
    "questionAr": "إذا كان $\\binom{n}{٥} = \\binom{n}{٣}$، فأوجد قيمة $n$.",
    "optionsEn": [
      "8",
      "15",
      "2",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Evaluate: $\\binom{12}{0} + \\binom{12}{12}$.",
    "questionAr": "احسب قيمة: $\\binom{١٢}{٠} + \\binom{١٢}{١٢}$.",
    "optionsEn": [
      "2",
      "1",
      "12",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "If $\\binom{n}{2} = 45$, find $n$.",
    "questionAr": "إذا كان $\\binom{n}{٢} = ٤٥$، فأوجد قيمة $n$.",
    "optionsEn": [
      "10",
      "9",
      "11",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the term independent of $x$ in the expansion of $\\left(x + \\frac{1}{x}\\right)^4$.",
    "questionAr": "أوجد الحد الخالي من س في مفكوك $\\left(س + \\frac{١}{س}\\right)^٤$.",
    "optionsEn": [
      "6",
      "4",
      "1",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "In the expansion of $\\left(x^2 + \\frac{1}{x^2}\\right)^8$, find the term independent of $x$.",
    "questionAr": "في مفكوك $\\left(س^٢ + \\frac{١}{س^٢}\\right)^٨$، أوجد الحد الخالي من س.",
    "optionsEn": [
      "70",
      "56",
      "28",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Which term has the greatest coefficient in the expansion of $(1 + x)^{12}$?",
    "questionAr": "أي الحدود له أكبر معامل في مفكوك $(١ + س)^{١٢}$؟",
    "optionsEn": [
      "T_7",
      "T_6",
      "T_8",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "If $\\frac{(2n)!}{(2n - 2)!} = 90$, find $n$.",
    "questionAr": "إذا كان $\\frac{(٢n)!}{(٢n - ٢)!} = ٩٠$، فأوجد قيمة $n$.",
    "optionsEn": [
      "n = 5",
      "n = 9",
      "n = 10",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "If $P(n, 4) = 42 \\times P(n, 2)$, find $n$.",
    "questionAr": "إذا كان $P(n، ٤) = ٤٢ \\times P(n، ٢)$، فأوجد قيمة $n$.",
    "optionsEn": [
      "n = 9",
      "n = 8",
      "n = 7",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "If $\\binom{28}{2r} = \\binom{28}{2r - 4}$, find the value of $\\binom{r}{2}$.",
    "questionAr": "إذا كان $\\binom{٢٨}{٢r} = \\binom{٢٨}{٢r - ٤}$، فأوجد قيمة $\\binom{r}{٢}$.",
    "optionsEn": [
      "28",
      "21",
      "36",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the coefficient of $x^3$ in the expansion of $(2x - 3)^6$.",
    "questionAr": "أوجد معامل $س^٣$ في مفكوك $(٢ س - ٣)^٦$.",
    "optionsEn": [
      "-4320",
      "4320",
      "-2160",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the coefficient of $x^4$ in the expansion of $(1 + 2x + x^2)^5$.",
    "questionAr": "أوجد معامل $س^٤$ في مفكوك $(١ + ٢ س + س^٢)^٥$.",
    "optionsEn": [
      "210",
      "120",
      "252",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In the expansion of $\\left(x^2 + \\frac{1}{x}\\right)^{15}$, find the term independent of $x$.",
    "questionAr": "في مفكوك $\\left(س^٢ + \\frac{١}{س}\\right)^{١٥}$، أوجد الحد الخالي من س.",
    "optionsEn": [
      "3003",
      "5005",
      "1365",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In the expansion of $\\left(x\\sqrt{x} + \\frac{1}{x^2}\\right)^7$, find the term independent of $x$.",
    "questionAr": "في مفكوك $\\left(س\\sqrt{س} + \\frac{١}{س^٢}\\right)^٧$، أوجد الحد الخالي من س.",
    "optionsEn": [
      "35",
      "21",
      "7",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In the expansion of $\\left(2x - \\frac{1}{2x^2}\\right)^9$, find the term independent of $x$.",
    "questionAr": "في مفكوك $\\left(٢ س - \\frac{١}{٢ س^٢}\\right)^٩$، أوجد الحد الخالي من س.",
    "optionsEn": [
      "-672",
      "672",
      "-336",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Which term has the greatest coefficient in the expansion of $(3x + 2)^9$?",
    "questionAr": "أي الحدود له أكبر معامل في مفكوك $(٣ س + ٢)^٩$؟",
    "optionsEn": [
      "T_6",
      "T_5",
      "T_7",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In the expansion of $\\left(x^4 - \\frac{1}{x^2}\\right)^{12}$, find the term independent of $x$.",
    "questionAr": "في مفكوك $\\left(س^٤ - \\frac{١}{س^٢}\\right)^{١٢}$، أوجد قيمة الحد الخالي من س.",
    "optionsEn": [
      "495",
      "-495",
      "792",
  ...
  hots: [
  {
    ...
    "difficulty": "hots",
    "questionEn": "If $\\frac{1}{(n - 2)!} + \\frac{1}{(n - 1)!} = \\frac{36}{n!}$, find the value of $n$.",
    "questionAr": "إذا كان $\\frac{١}{(n - ٢)!} + \\frac{١}{(n - ١)!} = \\frac{٣٦}{n!}$، فأوجد قيمة $n$.",
    "optionsEn": [
      "n = 6",
      "n = 5",
      "n = 7",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "If $\\frac{n!}{(n - 3)!} = 3 \\times \\frac{(n + 1)!}{(n - 1)!}$, find $n$.",
    "questionAr": "إذا كان $\\frac{n!}{(n - ٣)!} = ٣ \\times \\frac{(n + ١)!}{(n - ١)!}$، فأوجد قيمة $n$.",
    "optionsEn": [
      "n = 7",
      "n = 6",
      "n = 8",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "If $P(n, 4) = 1680$, find the value of $P(n - 2, 3)$.",
    "questionAr": "إذا كان $P(n، ٤) = ١٦٨٠$، فأوجد قيمة $P(n - ٢، ٣)$.",
    "optionsEn": [
      "120",
      "210",
      "60",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Evaluate: $\\sum_{r=1}^{4} \\frac{\\binom{4}{r}}{\\binom{4}{r - 1}}$.",
    "questionAr": "احسب قيمة المجموع: $\\sum_{r=١}^{٤} \\frac{\\binom{٤}{r}}{\\binom{٤}{r - ١}}$.",
    "optionsEn": [
      "25 / 3",
      "10",
      "8",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the coefficient of $x^8$ in the expansion of $(1 - x^2 + 2x^4)(1 + x)^8$.",
    "questionAr": "أوجد معامل $س^٨$ في مفكوك المقدار $(١ - س^٢ + ٢ س^٤)(١ + س)^٨$.",
    "optionsEn": [
      "113",
      "70",
      "140",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the term independent of $x$ in the expansion of $\\left(x + 1 + \\frac{1}{x}\\right)^4$.",
    "questionAr": "أوجد الحد الخالي من س في مفكوك المقدار $\\left(س + ١ + \\frac{١}{س}\\right)^٤$.",
    "optionsEn": [
      "19",
      "16",
      "24",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the term independent of $x$ in the expansion of $(1 + x + 2x^3) \\left(\\frac{3}{2}x^2 - \\frac{1}{3x}\\right)^9$.",
    "questionAr": "أوجد الحد الخالي من س في مفكوك $(١ + س + ٢ س^٣) \\left(\\frac{٣}{٢} س^٢ - \\frac{١}{٣ س}\\right)^٩$.",
    "optionsEn": [
      "7 / 18",
      "7 / 9",
      "5 / 18",
