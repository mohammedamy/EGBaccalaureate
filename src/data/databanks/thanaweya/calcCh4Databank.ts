...
export const calcCh4Databank: ChapterDatabank = {
  easy: [
  {
    ...
    "difficulty": "easy",
    "questionEn": "Using the definite integral identity for identical limits, evaluate: $\int_5^5 (x^3 + 7x - 2) dx$.",
    "questionAr": "باستخدام خاصية تساوي حدي التكامل، احسب قيمة: $\int_5^5 (x^3 + 7x - 2) dx$.",
    "optionsEn": [
      "$0$",
      "$5$",
      "$12$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Using the interval additivity property, if $\int_0^3 f(x) dx = 4$ and $\int_3^7 f(x) dx = 9$, find $\int_0^7 f(x) dx$.",
    "questionAr": "باستخدام خاصية تجزئة فترات التكامل، إذا كان $\int_0^3 f(x) dx = 4$ و $\int_3^7 f(x) dx = 9$، فأوجد $\int_0^7 f(x) dx$.",
    "optionsEn": [
      "$13$",
      "$5$",
      "$-5$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Using the property of odd functions over symmetric intervals, evaluate: $\int_{-4}^4 x^5 dx$.",
    "questionAr": "باستخدام خاصية الدوال الفردية على فترة متماثلة حول نقطة الأصل، احسب: $\int_{-4}^4 x^5 dx$.",
    "optionsEn": [
      "$0$",
      "$256$",
      "$512$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Apply the odd function symmetry theorem to compute: $\int_{-\pi/2}^{\pi/2} \sin x \, dx$.",
    "questionAr": "طبّق نظرية تماثل الدالة الفردية لحساب قيمة التكامل: $\int_{-\pi/2}^{\pi/2} \sin x \, dx$.",
    "optionsEn": [
      "$0$",
      "$1$",
      "$2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Apply linearity of the definite integral to find $\int_1^5 (3f(x) + 2) dx$ given $\int_1^5 f(x) dx = 6$.",
    "questionAr": "طبّق خاصية خطية التكامل المحدد لإيجاد $\int_1^5 (3f(x) + 2) dx$ إذا كان $\int_1^5 f(x) dx = 6$.",
    "optionsEn": [
      "$26$",
      "$20$",
      "$18$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the linear definite integral: $\int_0^3 (2x + 1) dx$.",
    "questionAr": "احسب ناتج التكامل المحدد للدالة الخطية: $\int_0^3 (2x + 1) dx$.",
    "optionsEn": [
      "$12$",
      "$9$",
      "$15$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the definite integral of the quadratic monomial: $\int_0^3 x^2 dx$.",
    "questionAr": "أوجد التكامل المحدد لكثيرة الحدود التربيعية: $\int_0^3 x^2 dx$.",
    "optionsEn": [
      "$9$",
      "$27$",
      "$18$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the area under the cosine wave on $[0, \pi/2]$: $\int_0^{\pi/2} \cos x \, dx$.",
    "questionAr": "عيّن قيمة التكامل المحدد لدالة جيب التمام: $\int_0^{\pi/2} \cos x \, dx$.",
    "optionsEn": [
      "$1$",
      "$0$",
      "$-1$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Calculate the definite integral of the derivative of tangent: $\int_0^{\pi/4} \sec^2 x \, dx$.",
    "questionAr": "احسب قيمة التكامل المحدد لمشتقة دالة الظل: $\int_0^{\pi/4} \sec^2 x \, dx$.",
    "optionsEn": [
      "$1$",
      "$\\sqrt{2}$",
      "$2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the definite integral of the absolute value function: $\int_{-1}^2 |x| dx$.",
    "questionAr": "احسب التكامل المحدد لدالة المقياس: $\int_{-1}^2 |x| dx$.",
    "optionsEn": [
      "$\\frac{5}{2}$",
      "$2$",
      "$\\frac{3}{2}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the net change of the natural exponential: $\int_0^1 e^x dx$.",
    "questionAr": "أوجد قيمة التكامل المحدد للدالة الأسية الطبيعية: $\int_0^1 e^x dx$.",
    "optionsEn": [
      "$e - 1$",
      "$e$",
      "$e + 1$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Evaluate the definite integral of the reciprocal function: $\int_1^2 \frac{1}{x} dx$.",
    "questionAr": "احسب التكامل المحدد لمقلوب المتغير: $\int_1^2 \frac{1}{x} dx$.",
    "optionsEn": [
      "$\\ln 2$",
      "$\\frac{1}{2}$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Apply the Fundamental Theorem of Calculus Part 1 to find: $\frac{d}{dx} \left[ \int_2^x \sqrt{t^3 + 1} \, dt \right]$.",
    "questionAr": "طبّق النظرية الأساسية للتفاضل والتكامل لإيجاد: $\frac{d}{dx} \left[ \int_2^x \sqrt{t^3 + 1} \, dt \right]$.",
    "optionsEn": [
      "$\\sqrt{x^3 + 1}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the triangular area under $y = 2x$ above $[0, 3]$.",
    "questionAr": "احسب المساحة المثلثية أسفل $y = 2x$ وفوق الفترة $[0, 3]$.",
    "optionsEn": [
      "$9$",
      "$6$",
      "$18$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Use geometric interpretation (area of a quarter circle) to evaluate: $\int_0^3 \sqrt{9 - x^2} \, dx$.",
    "questionAr": "باستخدام المعنى الهندسي (مساحة ربع دائرة)، احسب: $\int_0^3 \sqrt{9 - x^2} \, dx$.",
    "optionsEn": [
      "$\\frac{9\\pi}{4}$",
      "$9\\pi$",
      "$\\frac{9\\pi}{2}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Recognize the semicircle geometry to find: $\int_{-2}^2 \sqrt{4 - x^2} \, dx$.",
    "questionAr": "بالاستفادة من التفسير الهندسي لمنحنى نصف الدائرة، أوجد: $\int_{-2}^2 \sqrt{4 - x^2} \, dx$.",
    "optionsEn": [
      "$2\\pi$",
      "$4\\pi$",
      "$\\pi$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the area enclosed by $y = e^{2x}$ and the x-axis on $[0, 1]$.",
    "questionAr": "عيّن المساحة المحصورة بين $y = e^{2x}$ ومحور السينات على $[0, 1]$.",
    "optionsEn": [
      "$\\frac{e^2 - 1}{2}$",
      "$e^2 - 1$",
      "$\\frac{e^2}{2}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the trapezoidal area under $y = x + 2$ from $x = 1$ to $x = 3$.",
    "questionAr": "أوجد مساحة شبه المنحرف أسفل $y = x + 2$ من $x = 1$ إلى $x = 3$.",
    "optionsEn": [
      "$8$",
      "$6$",
      "$10$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Calculate the volume of the solid generated by revolving $y = x^2$ about the x-axis from $x = 0$ to $x = 2$.",
    "questionAr": "احسب حجم الجسم الدوراني الناشئ عن دوران $y = x^2$ حول محور السينات دورة كاملة من $x = 0$ إلى $x = 2$.",
    "optionsEn": [
      "$\\frac{32\\pi}{5}$",
      "$\\frac{16\\pi}{5}$",
      "$8\\pi$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the solid of revolution volume when $y = \sin x$ rotates around the x-axis between $x = 0$ and $x = \pi$.",
    "questionAr": "أوجد حجم مجسم الدوران الناتج عن دوران القوس $y = \sin x$ حول محور السينات بين $x = 0$ و $x = \pi$.",
    "optionsEn": [
      "$\\frac{\\pi^2}{2}$",
      "$\\pi^2$",
      "$2\\pi$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the volume obtained by rotating the exponential curve $y = e^x$ about the x-axis from $x = 0$ to $x = 1$.",
    "questionAr": "احسب الحجم الناتج عن دوران المنحنى الأسي $y = e^x$ حول محور السينات من $x = 0$ إلى $x = 1$.",
    "optionsEn": [
      "$\\frac{\\pi}{2}(e^2 - 1)$",
      "$\\pi(e^2 - 1)$",
      "$\\frac{\\pi}{2}e^2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the volume of revolution of the hyperbola $y = \frac{1}{x}$ about the x-axis on $[1, 4]$.",
    "questionAr": "عيّن حجم مجسم الدوران لمنحنى $y = \frac{1}{x}$ حول محور السينات على الفترة $[1, 4]$.",
    "optionsEn": [
      "$\\frac{3\\pi}{4}$",
      "$\\pi \\ln 4$",
      "$\\frac{\\pi}{4}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the mean value of the linear function $f(x) = 4x$ over $[0, 2]$.",
    "questionAr": "احسب القيمة المتوسطة للدالة الخطية $f(x) = 4x$ على الفترة $[0, 2]$.",
    "optionsEn": [
      "$4$",
      "$8$",
      "$2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the average value of the sine wave $f(x) = \sin x$ across $[0, \pi]$.",
    "questionAr": "عيّن القيمة المتوسطة لموجة الجيب $f(x) = \sin x$ عبر الفترة $[0, \pi]$.",
    "optionsEn": [
      "$\\frac{2}{\\pi}$",
      "$\\frac{1}{\\pi}$",
      "$\\frac{\\pi}{2}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Apply the odd polynomial symmetry theorem to find: $\int_{-3}^{3} (x^5 - 4x^3 + 7x) \, dx$.",
    "questionAr": "طبّق قاعدة تماثل الدوال الفردية لحساب: $\int_{-3}^{3} (x^5 - 4x^3 + 7x) \, dx$.",
    "optionsEn": [
      "$0$",
      "$18$",
      "$36$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the antiderivative of the trigonometric combination: $\int (3\sec^2(x) - 2\sin(x)) \, dx$.",
    "questionAr": "أوجد المشتقة العكسية للمقدار المثلثي: $\int (3\sec^2(x) - 2\sin(x)) \, dx$.",
    "optionsEn": [
      "$3\\tan(x) + 2\\cos(x) + C$",
      "$3\\tan(x) - 2\\cos(x) + C$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Use substitution to integrate: $\int 2x (x^2 + 5)^4 \, dx$.",
    "questionAr": "استخدم طريقة التعويض المباشر لحساب: $\int 2x (x^2 + 5)^4 \, dx$.",
    "optionsEn": [
      "$\\frac{1}{5}(x^2 + 5)^5 + C$",
      "$\\frac{1}{4}(x^2 + 5)^5 + C$",
      "$(x^2 + 5)^5 + C$",
  ...
  },
  {
    ...
    "titleAr": "خاصية تجزئة فترات التكامل المحدد",
    "difficulty": "easy",
    "questionEn": "By decomposing the integration interval, given $\int_{1}^{4} f(x) \, dx = 7$ and $\int_{2}^{4} f(x) \, dx = 3$, find $\int_{1}^{2} f(x) \, dx$.",
    "questionAr": "بتجزئة فترة التكامل، إذا علم أن $\int_{1}^{4} f(x) \, dx = 7$ و $\int_{2}^{4} f(x) \, dx = 3$، فاحسب $\int_{1}^{2} f(x) \, dx$.",
    "optionsEn": [
      "$4$",
      "$10$",
      "$-4$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the antiderivative of the composite exponential fraction: $\int \frac{e^{\sqrt{x}}}{\sqrt{x}} \, dx$.",
    "questionAr": "عيّن ناتج التكامل للدالة الأسية ذات الجذر: $\int \frac{e^{\sqrt{x}}}{\sqrt{x}} \, dx$.",
    "optionsEn": [
      "$2 e^{\\sqrt{x}} + C$",
      "$\\frac{1}{2} e^{\\sqrt{x}} + C$",
      "$e^{\\sqrt{x}} + C$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Evaluate the piecewise absolute value integral: $\int_{-1}^{3} |x - 1| \, dx$.",
    "questionAr": "احسب قيمة تكامل دالة القيمة المطلقة بعد إعادة تعريفها: $\int_{-1}^{3} |x - 1| \, dx$.",
    "optionsEn": [
      "$4$",
      "$2$",
      "$6$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the area of the region bounded by the parabola $y = x^2$ and the line $y = 2x$.",
    "questionAr": "احسب مساحة المنطقة المحصورة بين القطع المكافئ $y = x^2$ والمستقيم $y = 2x$.",
    "optionsEn": [
      "$\\frac{4}{3}$",
      "$\\frac{2}{3}$",
      "$2$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the area enclosed by the two intersecting parabolas $y = x^2$ and $y = 4x - x^2$.",
    "questionAr": "أوجد مساحة المنطقة المحدودة بين القطعين المكافئين المتقاطعين $y = x^2$ و $y = 4x - x^2$.",
    "optionsEn": [
      "$\\frac{8}{3}$",
      "$\\frac{4}{3}$",
      "$\\frac{16}{3}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Determine the area of the region between the radical and quadratic curves $y = \sqrt{x}$ and $y = x^2$.",
    "questionAr": "عيّن مساحة المنطقة المحصورة بين منحنى الجذر والقطع المكافئ $y = \sqrt{x}$ و $y = x^2$.",
    "optionsEn": [
      "$\\frac{1}{3}$",
      "$\\frac{2}{3}$",
      "$\\frac{1}{6}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the area of the parabolic segment enclosed by $y = x^2 - 2x$ and the line $y = x$.",
    "questionAr": "أوجد مساحة القطاع المكافئ المحصور بين $y = x^2 - 2x$ والقاطع $y = x$.",
    "optionsEn": [
      "$\\frac{9}{2}$",
      "$9$",
      "$\\frac{27}{6}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Compute the area enclosed by $x = y^2$ and $x = y + 2$ by integrating along the y-axis.",
    "questionAr": "احسب مساحة المنطقة المحصورة بين $x = y^2$ والمستقيم $x = y + 2$ بالتكامل بالنسبة لمحور الصادات.",
    "optionsEn": [
      "$\\frac{9}{2}$",
      "$9$",
      "$\\frac{7}{2}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Compute the washer volume generated by revolving the region between $y = x$ and $y = x^2$ about the x-axis.",
    "questionAr": "احسب حجم المجسم الحلقي الناشئ عن دوران المنطقة بين $y = x$ و $y = x^2$ حول محور السينات.",
    "optionsEn": [
      "$\\frac{2\\pi}{15}$",
      "$\\frac{\\pi}{15}$",
      "$\\frac{4\\pi}{15}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Determine the volume of revolution obtained by rotating the region between $y = 2x$ and $y = x^2$ around the x-axis.",
    "questionAr": "عيّن حجم مجسم الدوران الناتج عن دوران المنطقة بين $y = 2x$ و $y = x^2$ حول محور السينات.",
    "optionsEn": [
      "$\\frac{64\\pi}{15}$",
      "$\\frac{32\\pi}{15}$",
      "$\\frac{16\\pi}{5}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the volume of the solid formed when the region bounded by $y = \sqrt{x}$ and $y = x^2$ is revolved about the x-axis.",
    "questionAr": "أوجد حجم الجسم الدوراني المتولد من دوران المنطقة المحصورة بين $y = \sqrt{x}$ و $y = x^2$ حول محور السينات.",
    "optionsEn": [
      "$\\frac{3\\pi}{10}$",
      "$\\frac{\\pi}{5}$",
      "$\\frac{3\\pi}{5}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Using substitution $u = 3x$, evaluate $\int_0^2 f(3x) dx$ when $\int_0^6 f(x) dx = 12$.",
    "questionAr": "باستخدام التعويض $u = 3x$، احسب قيمة $\int_0^2 f(3x) dx$ إذا كان $\int_0^6 f(x) dx = 12$.",
    "optionsEn": [
      "$4$",
      "$36$",
      "$12$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Using translation substitution $u = x + 1$, compute $\int_0^3 f(x + 1) dx$ if $\int_1^4 f(x) dx = 10$.",
    "questionAr": "باستخدام تعويض الإزاحة $u = x + 1$، احسب $\int_0^3 f(x + 1) dx$ إذا كان $\int_1^4 f(x) dx = 10$.",
    "optionsEn": [
      "$10$",
      "$9$",
      "$11$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Using the symmetry property of trigonometric quotients, calculate: $\int_0^{\pi/2} \frac{\sin x}{\sin x + \cos x} dx$.",
    "questionAr": "باستخدام خاصية التماثل للكسور المثلثية، احسب قيمة: $\int_0^{\pi/2} \frac{\sin x}{\sin x + \cos x} dx$.",
    "optionsEn": [
      "$\\frac{\\pi}{4}$",
      "$\\frac{\\pi}{2}$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Compute the definite integral by parts: $\int_0^1 x e^{2x} \, dx$.",
    "questionAr": "احسب التكامل المحدد بطريقة التجزيء: $\int_0^1 x e^{2x} \, dx$.",
    "optionsEn": [
      "$\\frac{e^2 + 1}{4}$",
      "$\\frac{e^2 - 1}{4}$",
      "$\\frac{e^2 + 1}{2}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Determine the definite integral of the logarithmic product: $\int_1^e x^2 \ln x \, dx$.",
    "questionAr": "عيّن ناتج التكامل المحدد لحاصل الضرب اللوغاريتمي: $\int_1^e x^2 \ln x \, dx$.",
    "optionsEn": [
      "$\\frac{2e^3 + 1}{9}$",
      "$\\frac{2e^3 - 1}{9}$",
      "$\\frac{e^3 + 1}{9}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the average value of $f(x) = \sqrt{x}$ on the interval $[0, 4]$.",
    "questionAr": "احسب القيمة المتوسطة لجذر المتغير $f(x) = \sqrt{x}$ على الفترة $[0, 4]$.",
    "optionsEn": [
      "$\\frac{4}{3}$",
      "$2$",
      "$\\frac{8}{3}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Evaluate the logarithmic rational integral: $\int_0^1 \frac{2x}{x^2 + 1} dx$.",
    "questionAr": "احسب قيمة التكامل الكسري اللوغاريتمي: $\int_0^1 \frac{2x}{x^2 + 1} dx$.",
    "optionsEn": [
      "$\\ln 2$",
      "$\\ln 3$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Use partial fractions to evaluate: $\int_2^3 \frac{1}{x^2 - 1} dx$.",
    "questionAr": "استخدم طريقة الكسور الجزئية لحساب قيمة: $\int_2^3 \frac{1}{x^2 - 1} dx$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Use integration by parts to evaluate: $\int x \cos x \, dx$.",
    "questionAr": "استخدم التكامل بالتجزيء لحساب المشتقة العكسية: $\int x \cos x \, dx$.",
    "optionsEn": [
      "$x \\sin x + \\cos x + C$",
      "$x \\sin x - \\cos x + C$",
      "$-x \\sin x + \\cos x + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Compute the antiderivative by parts: $\int x \sin 2x \, dx$.",
    "questionAr": "احسب المشتقة العكسية بطريقة التجزيء: $\int x \sin 2x \, dx$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the definite integral using integration by parts: $\int_0^\pi x \sin x \, dx$.",
    "questionAr": "احسب التكامل المحدد باستخدام طريقة التجزيء: $\int_0^\pi x \sin x \, dx$.",
    "optionsEn": [
      "$\\pi$",
      "$2\\pi$",
      "$0$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Evaluate the radical fraction integral using substitution: $\int \frac{x}{\sqrt{x^2 + 9}} dx$.",
    "questionAr": "احسب قيمة تكامل الكسر الجذري بالتعويض: $\int \frac{x}{\sqrt{x^2 + 9}} dx$.",
    "optionsEn": [
      "$\\sqrt{x^2 + 9} + C$",
      "$2\\sqrt{x^2 + 9} + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Recognize that the integrand is an odd function to evaluate: $\int_{-5}^5 \frac{x^3 + \sin x}{x^4 + 1} dx$.",
    "questionAr": "بملاحظة أن الدالة فردية والمجال متماثل، احسب: $\int_{-5}^5 \frac{x^3 + \sin x}{x^4 + 1} dx$.",
    "optionsEn": [
      "$0$",
      "$10$",
      "$5$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Integrate the polynomial product using linear substitution: $\int x(x - 1)^5 dx$.",
    "questionAr": "كامل حاصل الضرب الخطي في القوس المرفوع لقوة: $\int x(x - 1)^5 dx$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the area under the V-shaped absolute value curve: $\int_0^4 |x - 2| \, dx$.",
    "questionAr": "احسب المساحة الممثلة لتكامل دالة المقياس المتماثلة: $\int_0^4 |x - 2| \, dx$.",
    "optionsEn": [
      "$4$",
      "$8$",
      "$2$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Use the half-angle trigonometric identity to evaluate: $\int \sin^2 x \, dx$.",
    "questionAr": "استخدم متطابقة نصف الزاوية لإيجاد: $\int \sin^2 x \, dx$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the antiderivative using the double-angle cosine identity: $\int \cos^2 x \, dx$.",
    "questionAr": "أوجد المشتقة العكسية بالاعتماد على متطابقة ضعف الزاوية: $\int \cos^2 x \, dx$.",
    "optionsEn": [
      "$\\frac{x}{2} + \\frac{\\sin 2x}{4} + C$",
      "$\\frac{x}{2} - \\frac{\\sin 2x}{4} + C$",
      "$\\frac{\\cos^3 x}{3} + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Determine the definite integral of squared sine on $[0, \pi/2]$: $\int_0^{\pi/2} \sin^2 x \, dx$.",
    "questionAr": "عيّن قيمة التكامل المحدد لمربع دالة الجيب على $[0, \pi/2]$: $\int_0^{\pi/2} \sin^2 x \, dx$.",
    "optionsEn": [
      "$\\frac{\\pi}{4}$",
      "$\\frac{\\pi}{2}$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Evaluate the indefinite integral of squared tangent: $\int \tan^2 x \, dx$.",
    "questionAr": "احسب ناتج التكامل غير المحدد لمربع دالة الظل: $\int \tan^2 x \, dx$.",
    "optionsEn": [
      "$\\tan x - x + C$",
      "$\\tan x + x + C$",
      "$\\frac{\\tan^3 x}{3} + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Determine the indefinite integral of squared cotangent: $\int \cot^2 x \, dx$.",
    "questionAr": "عيّن التكامل غير المحدد لمربع دالة ظل التمام: $\int \cot^2 x \, dx$.",
    "optionsEn": [
      "$-\\cot x - x + C$",
      "$-\\cot x + x + C$",
      "$\\cot x - x + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Given $\int_1^5 f(x) dx = 10$ and $\int_1^3 f(x) dx = 4$, determine the value of $\int_3^5 f(x) dx$.",
    "questionAr": "إذا كان $\int_1^5 f(x) dx = 10$ و $\int_1^3 f(x) dx = 4$، فعيّن قيمة $\int_3^5 f(x) dx$.",
    "optionsEn": [
      "$6$",
      "$14$",
      "$40$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Using Leibniz's rule with an upper limit of $x^2$, differentiate: $\frac{d}{dx} \left[ \int_1^{x^2} \sqrt{t^2 + 5} \, dt \right]$.",
    "questionAr": "باستخدام قاعدة لايبنتز بحد علوي $x^2$، فاضل: $\frac{d}{dx} \left[ \int_1^{x^2} \sqrt{t^2 + 5} \, dt \right]$.",
    "optionsEn": [
      "$2x \\sqrt{x^4 + 5}$",
      "$\\sqrt{x^4 + 5}$",
      "$2x \\sqrt{x^2 + 5}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Compute the definite integral using integration by parts: $\int_{0}^{2} x e^{3x} \, dx$.",
    "questionAr": "احسب قيمة التكامل المحدد باستخدام طريقة التجزيء: $\int_{0}^{2} x e^{3x} \, dx$.",
    "optionsEn": [
      "$\\frac{5e^6 + 1}{9}$",
      "$\\frac{5e^6 - 1}{9}$",
      "$\\frac{6e^6 - 1}{9}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Decompose into partial fractions to integrate: $\int \frac{5x - 2}{x^2 - x - 6} \, dx$.",
    "questionAr": "استخدم تفكيك الكسور الجزئية لحساب ناتج التكامل: $\int \frac{5x - 2}{x^2 - x - 6} \, dx$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the average-value integral over a half period: $\int_{0}^{\pi} \sin^2(x) \, dx$.",
    "questionAr": "أوجد قيمة التكامل لمربع دالة الجيب على نصف دورة: $\int_{0}^{\pi} \sin^2(x) \, dx$.",
    "optionsEn": [
      "$\\frac{\\pi}{2}$",
      "$\\pi$",
      "$\\frac{\\pi}{4}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Evaluate the circular segment definite integral: $\int_{0}^{2} \sqrt{4 - x^2} \, dx$.",
    "questionAr": "احسب التكامل المحدد الدائري الممثل لربع الدائرة: $\int_{0}^{2} \sqrt{4 - x^2} \, dx$.",
    "optionsEn": [
      "$\\pi$",
      "$2\\pi$",
      "$\\frac{\\pi}{2}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Use the product-to-sum trigonometric identity to evaluate: $\int_{0}^{\pi} \sin(3x) \sin(x) \, dx$.",
    "questionAr": "استخدم قوانين تحويل حاصل الضرب إلى مجموع دوال مثلثية لحساب: $\int_{0}^{\pi} \sin(3x) \sin(x) \, dx$.",
    "optionsEn": [
      "$0$",
      "$\\frac{\\pi}{2}$",
      "$\\frac{\\pi}{4}$",
  ...
  hots: [
  {
    ...
    "difficulty": "hots",
    "questionEn": "Apply Leibniz's integral rule to compute: $\frac{d}{dx} \left[ \int_0^{x^2} \sqrt{1 + t^2} \, dt \right]$.",
    "questionAr": "طبّق قاعدة لايبنتز للتفاضل تحت علامة التكامل لحساب: $\frac{d}{dx} \left[ \int_0^{x^2} \sqrt{1 + t^2} \, dt \right]$.",
    "optionsEn": [
      "$2x \\sqrt{1 + x^4}$",
      "$\\sqrt{1 + x^4}$",
      "$2x \\sqrt{1 + x^2}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Apply the integral symmetry reflection $x \mapsto \frac{\pi}{2} - x$ to evaluate: $\int_0^{\pi/2} \ln(\tan x) \, dx$.",
    "questionAr": "استخدم خاصية الانعكاس للتكامل المحدد $x \mapsto \frac{\pi}{2} - x$ لحساب: $\int_0^{\pi/2} \ln(\tan x) \, dx$.",
    "optionsEn": [
      "$0$",
      "$\\frac{\\pi}{2}$",
      "$\\ln 2$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Analyze the parity (odd/even) of the rational integrand to determine: $\int_{-1}^1 \frac{x^4 \sin x}{1 + x^2} dx$.",
    "questionAr": "حدّد نوع الدالة (فردية أم زوجية) لحساب قيمة التكامل: $\int_{-1}^1 \frac{x^4 \sin x}{1 + x^2} dx$.",
    "optionsEn": [
      "$0$",
      "$1$",
      "$\\frac{\\pi}{4}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Evaluate the improper gamma-type integral: $\int_0^\infty x^3 e^{-x} dx$.",
    "questionAr": "احسب قيمة التكامل المعتل المرتبط بدالة غاما: $\int_0^\infty x^3 e^{-x} dx$.",
    "optionsEn": [
      "$6$",
      "$3$",
      "$24$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Calculate the convergent improper exponential integral: $\int_0^\infty e^{-3x} dx$.",
    "questionAr": "احسب قيمة التكامل المعتل المتقارب للدالة الأسية: $\int_0^\infty e^{-3x} dx$.",
    "optionsEn": [
      "$\\frac{1}{3}$",
      "$3$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Evaluate the famous symmetry integral using King's property: $\int_0^\pi \frac{x \sin x}{1 + \cos^2 x} dx$.",
    "questionAr": "احسب التكامل المتماثل الشهير باستخدام خاصية الملك: $\int_0^\pi \frac{x \sin x}{1 + \cos^2 x} dx$.",
    "optionsEn": [
      "$\\frac{\\pi^2}{4}$",
      "$\\frac{\\pi^2}{2}$",
      "$\\frac{\\pi}{4}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Compute the classic logarithmic-tangent definite integral: $\int_0^{\pi/4} \ln(1 + \tan x) \, dx$.",
    "questionAr": "احسب التكامل المحدد الكلاسيكي للوغاريتم الظل: $\int_0^{\pi/4} \ln(1 + \tan x) \, dx$.",
    "optionsEn": [
      "$\\frac{\\pi}{8}\\ln 2$",
      "$\\frac{\\pi}{4}\\ln 2$",
      "$\\frac{1}{2}\\ln 2$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Evaluate the definite integral of the floor step function: $\int_0^3 \lfloor x \rfloor dx$.",
    "questionAr": "احسب قيمة التكامل المحدد لدالة أكبر عدد صحيح (الدالة السلمية): $\int_0^3 \lfloor x \rfloor dx$.",
    "optionsEn": [
      "$3$",
      "$6$",
      "$1.5$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Apply symmetry across the origin to determine: $\int_{-3}^3 \frac{1}{1 + e^x} dx$.",
    "questionAr": "طبّق خواص التماثل حول نقطة الأصل لحساب: $\int_{-3}^3 \frac{1}{1 + e^x} dx$.",
    "optionsEn": [
      "$3$",
      "$6$",
      "$0$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Compute the definite integral using the King symmetry theorem: $\int_{-\pi/2}^{\pi/2} \frac{\cos x}{e^x + 1} dx$.",
    "questionAr": "احسب التكامل المحدد باستخدام نظرية الملك والتماثل: $\int_{-\pi/2}^{\pi/2} \frac{\cos x}{e^x + 1} dx$.",
    "optionsEn": [
      "$1$",
      "$2$",
      "$0$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Recognize the odd function symmetry to evaluate: $\int_{-\pi/3}^{\pi/3} x^2 \sin x \, dx$.",
    "questionAr": "بملاحظة أن دالة التكامل فردية، احسب قيمة: $\int_{-\pi/3}^{\pi/3} x^2 \sin x \, dx$.",
    "optionsEn": [
      "$0$",
      "$\\frac{\\pi}{3}$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Evaluate the symmetric rational trigonometric integral: $\int_0^{\pi/2} \frac{1}{1 + \tan^3 x} dx$.",
    "questionAr": "احسب قيمة التكامل الكسري المثلثي المتماثل: $\int_0^{\pi/2} \frac{1}{1 + \tan^3 x} dx$.",
    "optionsEn": [
      "$\\frac{\\pi}{4}$",
      "$\\frac{\\pi}{2}$",
      "$1$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Separate the integrand into odd and even parts to evaluate: $\int_{-\pi}^\pi (x^5 \cos x + x^2) dx$.",
    "questionAr": "افصل دالة التكامل إلى دالة فردية وأخرى زوجية لحساب: $\int_{-\pi}^\pi (x^5 \cos x + x^2) dx$.",
    "optionsEn": [
      "$\\frac{2\\pi^3}{3}$",
      "$0$",
      "$\\frac{\\pi^3}{3}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Use King's property of definite integrals to calculate: $\int_{2}^{7} \frac{\sqrt{x}}{\sqrt{x} + \sqrt{9 - x}} dx$.",
    "questionAr": "استخدم خاصية الملك للتكامل المحدد لحساب: $\int_{2}^{7} \frac{\sqrt{x}}{\sqrt{x} + \sqrt{9 - x}} dx$.",
    "optionsEn": [
      "$\\frac{5}{2}$",
      "$5$",
      "$\\frac{9}{2}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Apply the inversion substitution $x = 1/t$ to evaluate: $\int_{1/2}^{2} \frac{\ln(x)}{1 + x^2} dx$.",
    "questionAr": "طبّق تعويض المقلوب $x = 1/t$ لحساب التكامل المحدد: $\int_{1/2}^{2} \frac{\ln(x)}{1 + x^2} dx$.",
    "optionsEn": [
      "$0$",
      "$\\frac{1}{2}$",
      "$\\ln(2)$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Determine the value of the trigonometric power integral: $\int_{0}^{\pi/2} \sin^4(x) \cos^2(x) \, dx$.",
    "questionAr": "عيّن قيمة تكامل القوى المثلثية: $\int_{0}^{\pi/2} \sin^4(x) \cos^2(x) \, dx$.",
    "optionsEn": [
      "$\\frac{\\pi}{32}$",
      "$\\frac{\\pi}{16}$",
      "$\\frac{\\pi}{64}$",
