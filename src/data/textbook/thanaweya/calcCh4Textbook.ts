...
export const calcCh4SolvedExamples: SolvedProblem[] = [
  {
    ...
    "difficulty": "easy",
    "questionEn": "Using the power-of-a-function rule, determine the indefinite integral: $\\int x (x^2 + 3)^4 dx$.",
    "questionAr": "باستخدام قاعدة مشتقة القوس، أوجد التكامل غير المحدد: $\\int x (x^2 + 3)^4 dx$.",
    "optionsEn": [
      "$\\frac{1}{10} (x^2 + 3)^5 + C$",
      "$\\frac{1}{5} (x^2 + 3)^5 + C$",
      "$\\frac{1}{2} (x^2 + 3)^5 + C$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Evaluate the logarithmic form integral whose numerator is the derivative of the denominator: $\\int \\frac{2x + 3}{x^2 + 3x + 5} dx$.",
    "questionAr": "احسب التكامل بالصورة اللوغاريتمية حيث البسط مشتقة المقام: $\\int \\frac{2x + 3}{x^2 + 3x + 5} dx$.",
    "optionsEn": [
      "$\\ln|x^2 + 3x + 5| + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Apply integration by parts to compute the indefinite integral: $\\int x e^{2x} dx$.",
    "questionAr": "طبق طريقة التكامل بالتجزيء لحساب التكامل غير المحدد: $\\int x e^{2x} dx$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Using integration by parts, determine the antiderivative of the product: $\\int x \\ln(x) dx$.",
    "questionAr": "باستخدام التكامل بالتجزيء، حدد الدالة الأصلية لحاصل الضرب: $\\int x \\ln(x) dx$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Utilize the half-angle trigonometric identity to evaluate: $\\int \\sin^2(x) dx$.",
    "questionAr": "وظف متطابقة نصف الزاوية المثلثية لحساب التكامل: $\\int \\sin^2(x) dx$.",
    "optionsEn": [
...
export const calcCh4Exercises: SolvedProblem[] = [
  {
    ...
    "difficulty": "easy",
    "questionEn": "Calculate the indefinite integral of the linear binomial raised to a power: $\\int (3x - 1)^5 dx$.",
    "questionAr": "احسب التكامل غير المحدد لذات الحدين الخطية المرفوعة لقوة: $\\int (3x - 1)^5 dx$.",
    "optionsEn": [
      "$\\frac{1}{18} (3x - 1)^6 + C$",
      "$\\frac{1}{6} (3x - 1)^6 + C$",
      "$\\frac{1}{2} (3x - 1)^6 + C$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Evaluate the trigonometric integral involving squared secant: $\\int \\sec^2(4x) dx$.",
    "questionAr": "احسب التكامل المثلثي لدالة مربع القاطع: $\\int \\sec^2(4x) dx$.",
    "optionsEn": [
      "$\\frac{1}{4} \\tan(4x) + C$",
      "$4 \\tan(4x) + C$",
      "$\\tan(4x) + C$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the antiderivative for the linear-exponent exponential function: $\\int e^{3x - 2} dx$.",
    "questionAr": "احسب الدالة الأصلية للدالة الأسية ذات الأس الخطي: $\\int e^{3x - 2} dx$.",
    "optionsEn": [
      "$\\frac{1}{3} e^{3x - 2} + C$",
      "$3 e^{3x - 2} + C$",
      "$e^{3x - 2} + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the indefinite integral of the quotient whose numerator is the derivative of the denominator: $\\int \\frac{\\cos(x)}{\\sin(x) + 2} dx$.",
    "questionAr": "أوجد التكامل غير المحدد للكسر الذي بسطه مشتقة لمقامه: $\\int \\frac{\\cos(x)}{\\sin(x) + 2} dx$.",
    "optionsEn": [
      "$\\ln(\\sin(x) + 2) + C$",
      "$\\ln|\\cos(x)| + C$",
      "$\\frac{1}{(\\sin(x) + 2)^2} + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Employ integration by parts to evaluate the product integral: $\\int x \\cos(x) dx$.",
    "questionAr": "وظف التكامل بالتجزيء لحساب تكامل حاصل الضرب: $\\int x \\cos(x) dx$.",
    "optionsEn": [
      "$x \\sin(x) + \\cos(x) + C$",
      "$x \\sin(x) - \\cos(x) + C$",
      "$-x \\sin(x) + \\cos(x) + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Evaluate the integral involving a reciprocal logarithm: $\\int \\frac{1}{x \\ln(x)} dx$.",
    "questionAr": "احسب التكامل المحتوي على مقلوب اللوغاريتم: $\\int \\frac{1}{x \\ln(x)} dx$.",
    "optionsEn": [
      "$\\ln|\\ln(x)| + C$",
      "$\\frac{1}{2} (\\ln x)^2 + C$",
      "$\\ln(x) + C$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the definite integral using integration by parts: $\\int_0^1 x e^x dx$.",
    "questionAr": "احسب قيمة التكامل المحدد باستخدام طريقة التجزيء: $\\int_0^1 x e^x dx$.",
    "optionsEn": [
      "$1$",
      "$e - 1$",
      "$e$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Apply algebraic substitution with a radical to find: $\\int x \\sqrt{x + 1} dx$.",
    "questionAr": "طبق التعويض الجبري لجذر تربيعي لإيجاد: $\\int x \\sqrt{x + 1} dx$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Compute the definite integral of the absolute value function over the interval $[-2, 3]$: $\\int_{-2}^3 |x| dx$.",
    "questionAr": "احسب التكامل المحدد لدالة القيمة المطلقة على الفترة $[-2, 3]$: $\\int_{-2}^3 |x| dx$.",
    "optionsEn": [
      "$\\frac{13}{2} = 6.5$",
      "$\\frac{5}{2} = 2.5$",
      "$\\frac{9}{2} = 4.5$",
