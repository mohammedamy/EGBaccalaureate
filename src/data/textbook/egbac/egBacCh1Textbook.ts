...
export const egBacCh1Exercises: SolvedProblem[] = [
  {
    ...
    "difficulty": "easy",
    "questionEn": "Given the spatial vectors $\\vec{u} = (1, 2, -1)$ and $\\vec{v} = (2, -1, 4)$ in Euclidean 3-space, evaluate their scalar dot product $\\vec{u} \\cdot \\vec{v}$.",
    "questionAr": "معطى المتجهان الفراغيان $\\vec{u} = (1, 2, -1)$ و $\\vec{v} = (2, -1, 4)$ في الفضاء الإقليدي ثلاثي الأبعاد، احسب حاصل ضربهما القياسي $\\vec{u} \\cdot \\vec{v}$.",
    "optionsEn": [
      "$\\vec{u} \\cdot \\vec{v} = -4$",
      "$\\vec{u} \\cdot \\vec{v} = -2$",
      "$\\vec{u} \\cdot \\vec{v} = -6$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Compute the Euclidean inner product $\\langle \\vec{u}, \\vec{v} \\rangle$ for the vector pair $\\vec{u} = (2, 2, -1)$ and $\\vec{v} = (2, -2, 4)$ in $\\mathbb{R}^3$.",
    "questionAr": "احسب الضرب الداخلي الإقليدي $\\langle \\vec{u}, \\vec{v} \\rangle$ لزوج المتجهين $\\vec{u} = (2, 2, -1)$ و $\\vec{v} = (2, -2, 4)$ في $\\mathbb{R}^3$.",
    "optionsEn": [
      "$\\vec{u} \\cdot \\vec{v} = -2$",
      "$\\vec{u} \\cdot \\vec{v} = -4$",
      "$\\vec{u} \\cdot \\vec{v} = -6$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Two physical force vectors are defined as $\\vec{u} = (3, 2, -1)$ and $\\vec{v} = (2, -3, 4)$ in Cartesian components. Calculate the scalar product $\\vec{u} \\cdot \\vec{v}$.",
    "questionAr": "عُرف متجها قوة فيزيائيان بالمركبات الديكارتية $\\vec{u} = (3, 2, -1)$ و $\\vec{v} = (2, -3, 4)$. احسب الضرب القياسي $\\vec{u} \\cdot \\vec{v}$.",
    "optionsEn": [
      "$\\vec{u} \\cdot \\vec{v} = -2$",
      "$\\vec{u} \\cdot \\vec{v} = -6$",
      "$\\vec{u} \\cdot \\vec{v} = -4$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "In an analytical geometry problem, consider the displacement vectors $\\vec{u} = (4, 2, -1)$ and $\\vec{v} = (2, -4, 4)$ in $\\mathbb{R}^3$. Find the value of $\\vec{u} \\cdot \\vec{v}$.",
    "questionAr": "في مسألة هندسة تحليلية، اعتبر متجَهي الإزاحة $\\vec{u} = (4, 2, -1)$ و $\\vec{v} = (2, -4, 4)$ في $\\mathbb{R}^3$. أوجد قيمة الضرب القياسي $\\vec{u} \\cdot \\vec{v}$.",
    "optionsEn": [
      "$\\vec{u} \\cdot \\vec{v} = -2$",
      "$\\vec{u} \\cdot \\vec{v} = -6$",
      "$\\vec{u} \\cdot \\vec{v} = 2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the dot product $\\vec{u} \\cdot \\vec{v}$ between the direction vectors $\\vec{u} = (5, 2, -1)$ and $\\vec{v} = (2, -5, 4)$.",
    "questionAr": "حدد الضرب القياسي $\\vec{u} \\cdot \\vec{v}$ بين متجَهي الاتجاه $\\vec{u} = (5, 2, -1)$ و $\\vec{v} = (2, -5, 4)$.",
    "optionsEn": [
      "$\\vec{u} \\cdot \\vec{v} = -4$",
      "$\\vec{u} \\cdot \\vec{v} = -2$",
      "$\\vec{u} \\cdot \\vec{v} = -6$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Determine the perpendicular distance $d$ from the coordinate origin $(0, 0, 0)$ to the flat boundary plane $\\pi: 3x + 4y + 12z - 13 = 0$.",
    "questionAr": "حدد البعد العمودي $d$ من نقطة الأصل $(0, 0, 0)$ إلى المستوى الحدودي $\\pi: 3x + 4y + 12z - 13 = 0$.",
    "optionsEn": [
      "$d = 2\\text{ units}$",
      "$d = 1\\text{ units}$",
      "$d = 3\\text{ units}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the shortest Euclidean distance separating the origin $O(0, 0, 0)$ from the planar surface $\\pi: 3x + 4y + 12z - 26 = 0$.",
    "questionAr": "احسب أقصر مسافة إقليدية تفصل نقطة الأصل $O(0, 0, 0)$ عن السطح المستوي $\\pi: 3x + 4y + 12z - 26 = 0$.",
    "optionsEn": [
      "$d = 3\\text{ units}$",
      "$d = 4\\text{ units}$",
      "$d = 2\\text{ units}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In three-dimensional space, find the orthogonal distance from the origin $(0, 0, 0)$ to the plane $\\pi: 3x + 4y + 12z - 39 = 0$.",
    "questionAr": "في الفضاء ثلاثي الأبعاد، أوجد المسافة العمودية المتعامدة من نقطة الأصل $(0, 0, 0)$ إلى المستوى $\\pi: 3x + 4y + 12z - 39 = 0$.",
    "optionsEn": [
      "$d = 4\\text{ units}$",
      "$d = 5\\text{ units}$",
      "$d = 6\\text{ units}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A sensor at the origin $(0, 0, 0)$ measures the closest distance to a reflective plane $\\pi: 3x + 4y + 12z - 52 = 0$. What is this perpendicular distance $d$?",
    "questionAr": "حساس مثبت عند نقطة الأصل $(0, 0, 0)$ يقيس أقرب مسافة لمستوى عاكس $\\pi: 3x + 4y + 12z - 52 = 0$. ما هو هذا البعد العمودي $d$؟",
    "optionsEn": [
      "$d = 4\\text{ units}$",
      "$d = 5\\text{ units}$",
      "$d = 6\\text{ units}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the normal distance from the coordinate origin $(0, 0, 0)$ to the geometric plane given by $\\pi: 3x + 4y + 12z - 65 = 0$.",
    "questionAr": "أوجد البعد العمودي من نقطة الأصل الإحداثية $(0, 0, 0)$ إلى المستوى الهندسي المعطى بالمعادلة $\\pi: 3x + 4y + 12z - 65 = 0$.",
    "optionsEn": [
      "$d = 6\\text{ units}$",
      "$d = 5\\text{ units}$",
      "$d = 7\\text{ units}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Determine the measure of the acute dihedral angle $\\theta$ formed by the intersection of planes $\\pi_1: 1x + 1y = 0$ and $\\pi_2: 1y + 1z = 0$.",
    "questionAr": "حدد قياس الزاوية الزوجية الحادة $\\theta$ الناتجة عن تقاطع المستويين $\\pi_1: 1x + 1y = 0$ و $\\pi_2: 1y + 1z = 0$.",
    "optionsEn": [
      "$\\theta = 30^\\circ$",
      "$\\theta = 45^\\circ$",
      "$\\theta = 60^\\circ$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "In $\\mathbb{R}^3$, compute the acute angle $\\theta$ between the pair of intersecting planes $\\pi_1: 2x + 2y = 0$ and $\\pi_2: 2y + 2z = 0$.",
    "questionAr": "في $\\mathbb{R}^3$، احسب الزاوية الحادة $\\theta$ بين زوج المستويين المتقاطعين $\\pi_1: 2x + 2y = 0$ و $\\pi_2: 2y + 2z = 0$.",
    "optionsEn": [
      "$\\theta = 30^\\circ$",
      "$\\theta = 45^\\circ$",
      "$\\theta = 90^\\circ$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the inclination angle $\\theta \\in [0^\\circ, 90^\\circ]$ between the normal vectors of planes $\\pi_1: 3x + 3y = 0$ and $\\pi_2: 3y + 3z = 0$.",
    "questionAr": "أوجد زاوية الميل الحادة $\\theta \\in [0^\\circ, 90^\\circ]$ بين متجهي العمودي للمستويين $\\pi_1: 3x + 3y = 0$ و $\\pi_2: 3y + 3z = 0$.",
    "optionsEn": [
      "$\\theta = 60^\\circ$",
      "$\\theta = 30^\\circ$",
      "$\\theta = 45^\\circ$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Calculate the acute angle $\\theta$ separating the two spatial coordinate planes $\\pi_1: 4x + 4y = 0$ and $\\pi_2: 4y + 4z = 0$.",
    "questionAr": "احسب الزاوية الحادة $\\theta$ التي تفصل بين المستويين الفراغيين $\\pi_1: 4x + 4y = 0$ و $\\pi_2: 4y + 4z = 0$.",
    "optionsEn": [
      "$\\theta = 30^\\circ$",
      "$\\theta = 60^\\circ$",
      "$\\theta = 45^\\circ$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Two planar reflectors are positioned according to equations $\\pi_1: 5x + 5y = 0$ and $\\pi_2: 5y + 5z = 0$. Determine the acute angle $\\theta$ between them.",
    "questionAr": "سطحان عاكسان مستويان رُكبا وفق المعادلتين $\\pi_1: 5x + 5y = 0$ و $\\pi_2: 5y + 5z = 0$. حدد الزاوية الحادة $\\theta$ بينهما.",
    "optionsEn": [
      "$\\theta = 30^\\circ$",
      "$\\theta = 45^\\circ$",
      "$\\theta = 60^\\circ$",
