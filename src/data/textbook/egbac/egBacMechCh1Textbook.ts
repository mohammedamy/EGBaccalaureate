...
export const egBacMechCh1Exercises: SolvedProblem[] = [
  {
    ...
    "difficulty": "easy",
    "questionEn": "A vehicle traversing a curved highway has tangential acceleration $a_t = 3\\text{ m/s}^2$ and centripetal normal acceleration $a_n = 4\\text{ m/s}^2$. Calculate its total acceleration magnitude $\\|\\vec{a}\\|_2$.",
    "questionAr": "مركبة تسير على طريق منحنٍ تمتلك عجلة مماسية $a_t = 3\\text{ م/ث}^2$ وعجلة عمودية مركزية $a_n = 4\\text{ م/ث}^2$. احسب مقدار عجلتها الكلية $\\|\\vec{a}\\|_2$.",
    "optionsEn": [
      "$\\|\\vec{a}\\| = 5\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 7\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 9\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "An aerobatic aircraft in a pull-up maneuver experiences tangential acceleration $a_t = 6\\text{ m/s}^2$ and normal acceleration $a_n = 8\\text{ m/s}^2$. Determine the resultant acceleration magnitude $\\|\\vec{a}\\|$.",
    "questionAr": "طائرة استعراضية في مناورة صعود تتأثر بعجلة مماسية $a_t = 6\\text{ م/ث}^2$ وعجلة عمودية $a_n = 8\\text{ م/ث}^2$. حدد مقدار العجلة المحصلة $\\|\\vec{a}\\|$.",
    "optionsEn": [
      "$\\|\\vec{a}\\| = 12\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 10\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 14\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "At a given instant along its trajectory, a particle displays intrinsic accelerations $a_t = 9\\text{ m/s}^2$ and $a_n = 12\\text{ m/s}^2$. Compute the total acceleration magnitude $\\|\\vec{a}\\| = \\sqrt{a_t^2 + a_n^2}$.",
    "questionAr": "في لحظة معينة على طول مساره، يمتلك جسيم عجلتين ذاتيتين $a_t = 9\\text{ م/ث}^2$ و $a_n = 12\\text{ م/ث}^2$. احسب مقدار العجلة الكلية $\\|\\vec{a}\\| = \\sqrt{a_t^2 + a_n^2}$.",
    "optionsEn": [
      "$\\|\\vec{a}\\| = 17\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 19\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 15\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "A roller coaster car moving along a vertical track loop has components $a_t = 12\\text{ m/s}^2$ and $a_n = 16\\text{ m/s}^2$. Find the magnitude $\\|\\vec{a}\\|$ of its total linear acceleration.",
    "questionAr": "عربة قطار ملاهٍ تتحرك على حلقة مسار رأسية تمتلك مركبتي عجلة $a_t = 12\\text{ م/ث}^2$ و $a_n = 16\\text{ م/ث}^2$. أوجد مقدار عجلتها الخطية الكلية $\\|\\vec{a}\\|$.",
    "optionsEn": [
      "$\\|\\vec{a}\\| = 22\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 24\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 19\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "In a centrifuge rotor, a test sample experiences tangential deceleration $a_t = 15\\text{ m/s}^2$ and normal acceleration $a_n = 20\\text{ m/s}^2$. Calculate its net acceleration magnitude $\\|\\vec{a}\\|$.",
    "questionAr": "في جهاز طرد مركزي، تتعرض عينة اختبار لتباطؤ مماسي $a_t = 15\\text{ م/ث}^2$ وعجلة عمودية $a_n = 20\\text{ م/ث}^2$. احسب مقدار العجلة الصافية $\\|\\vec{a}\\|$.",
    "optionsEn": [
      "$\\|\\vec{a}\\| = 25\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 27\\text{ m/s}^2$",
      "$\\|\\vec{a}\\| = 29\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A racing car negotiates a bend of radius of curvature $\\rho = 50\\text{ m}$ at constant speed $v = 10\\text{ m/s}$. Find its centripetal normal acceleration $a_n = v^2 / \\rho$.",
    "questionAr": "سيارة سباق تجتاز منعطفاً نصف قطر انحنائه $\\rho = 50\\text{ م}$ بسرعة ثابتة $v = 10\\text{ م/ث}$. أوجد عجلتها العمودية المركزية $a_n = v^2 / \\rho$.",
    "optionsEn": [
      "$a_n = 4\\text{ m/s}^2$",
      "$a_n = 2\\text{ m/s}^2$",
      "$a_n = 6\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A train rounds a circular track section of radius $\\rho = 100\\text{ m}$ with forward speed $v = 20\\text{ m/s}$. Determine the normal acceleration $a_n$ acting toward the center.",
    "questionAr": "قطار يلتف حول قسم مسار دائري نصف قطره $\\rho = 100\\text{ م}$ بسرعة أمامية $v = 20\\text{ م/ث}$. حدد العجلة العمودية $a_n$ المؤثرة نحو المركز.",
    "optionsEn": [
      "$a_n = 6\\text{ m/s}^2$",
      "$a_n = 8\\text{ m/s}^2$",
      "$a_n = 4\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A particle travels along an orbital arc with curvature radius $\\rho = 150\\text{ m}$ at instantaneous speed $v = 30\\text{ m/s}$. Compute its normal acceleration component $a_n$.",
    "questionAr": "جسيم يتحرك على طول قوس مداري بنصف قطر انحناء $\\rho = 150\\text{ م}$ بسرعة لحظية $v = 30\\text{ م/ث}$. احسب مركبة عجلته العمودية $a_n$.",
    "optionsEn": [
      "$a_n = 8\\text{ m/s}^2$",
      "$a_n = 10\\text{ m/s}^2$",
      "$a_n = 7\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "An autonomous drone maneuvers along a parabolic flight path where $\\rho = 200\\text{ m}$ at airspeed $v = 40\\text{ m/s}$. Calculate the normal acceleration $a_n$.",
    "questionAr": "طائرة مسيرة ذاتية القيادة تناور على مسار طيران مكافئ بنصف قطر $\\rho = 200\\text{ م}$ وبسرعة جوية $v = 40\\text{ م/ث}$. احسب العجلة العمودية $a_n$.",
    "optionsEn": [
      "$a_n = 8\\text{ m/s}^2$",
      "$a_n = 10\\text{ m/s}^2$",
      "$a_n = 12\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In high-speed transit testing, a pod moves at $v = 50\\text{ m/s}$ through a curve designed with radius of curvature $\\rho = 250\\text{ m}$. Find the normal acceleration $a_n$.",
    "questionAr": "في اختبار نقل فائق السرعة، تتحرك كبسولة بسرعة $v = 50\\text{ م/ث}$ خلال منعطف مصمم بنصف قطر انحناء $\\rho = 250\\text{ م}$. أوجد العجلة العمودية $a_n$.",
    "optionsEn": [
      "$a_n = 12\\text{ m/s}^2$",
      "$a_n = 10\\text{ m/s}^2$",
      "$a_n = 14\\text{ m/s}^2$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "In plane polar coordinates, a satellite tracking station records radial velocity $v_r = \\dot{r} = 3\\text{ m/s}$ and transverse velocity $v_\\theta = r\\dot{\\theta} = 4\\text{ m/s}$. Find its total speed $v = \\sqrt{v_r^2 + v_\\theta^2}$.",
    "questionAr": "في الإحداثيات القطبية المستوية، تسجل محطة تتبع أقمار صناعية سرعة نصف قطرية $v_r = \\dot{r} = 3\\text{ م/ث}$ وسرعة مستعرضة $v_\\theta = r\\dot{\\theta} = 4\\text{ م/ث}$. أوجد السرعة الكلية $v = \\sqrt{v_r^2 + v_\\theta^2}$.",
    "optionsEn": [
      "$v = 7\\text{ m/s}$",
      "$v = 9\\text{ m/s}$",
      "$v = 5\\text{ m/s}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A radar unit tracks an approaching aircraft with radial velocity $v_r = 6\\text{ m/s}$ and azimuthal cross-velocity $v_\\theta = 8\\text{ m/s}$. Determine the total flight speed $v$.",
    "questionAr": "وحدة رادار تتتبع طائرة مقتربة بسرعة نصف قطرية $v_r = 6\\text{ م/ث}$ وسرعة زاوية مستعرضة $v_\\theta = 8\\text{ م/ث}$. حدد سرعة الطيران الكلية $v$.",
    "optionsEn": [
      "$v = 12\\text{ m/s}$",
      "$v = 14\\text{ m/s}$",
      "$v = 11\\text{ m/s}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A robotic sensor probe moving in a polar plane has components $v_r = 9\\text{ m/s}$ and $v_\\theta = 12\\text{ m/s}$. Calculate its overall speed magnitude $v$.",
    "questionAr": "مسبار استشعار روبوتي يتحرك في مستوى قطبي بمركبتي سرعة $v_r = 9\\text{ م/ث}$ و $v_\\theta = 12\\text{ م/ث}$. احسب مقدار سرعته الإجمالية $v$.",
    "optionsEn": [
      "$v = 15\\text{ m/s}$",
      "$v = 17\\text{ m/s}$",
      "$v = 19\\text{ m/s}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A particle expanding outward along a spiral trajectory has $\\dot{r} = 12\\text{ m/s}$ and $r\\dot{\\theta} = 16\\text{ m/s}$. Find the particle's resultant speed $v$.",
    "questionAr": "جسيم يتحرك مبتعداً على طول مسار حلزوني يمتلك $\\dot{r} = 12\\text{ م/ث}$ و $r\\dot{\\theta} = 16\\text{ م/ث}$. أوجد سرعة الجسيم المحصلة $v$.",
    "optionsEn": [
      "$v = 22\\text{ m/s}$",
      "$v = 20\\text{ m/s}$",
      "$v = 24\\text{ m/s}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "At a celestial observation point, a comet's polar components are measured as $v_r = 15\\text{ m/s}$ and $v_\\theta = 20\\text{ m/s}$. Compute the total orbital speed $v$.",
    "questionAr": "عند نقطة رصد فلكية، قِيست مركبات مذنب القطبية ووجدت $v_r = 15\\text{ م/ث}$ و $v_\\theta = 20\\text{ م/ث}$. احسب السرعة المدارية الكلية $v$.",
    "optionsEn": [
      "$v = 27\\text{ m/s}$",
      "$v = 29\\text{ m/s}$",
      "$v = 25\\text{ m/s}$",
