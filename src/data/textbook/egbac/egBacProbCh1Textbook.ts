...
export const egBacProbCh1Exercises: SolvedProblem[] = [
  {
    ...
    "difficulty": "medium",
    "questionEn": "In a medical diagnostic screening, the target disease event $A$ and its complement $A^c$ satisfy $P(A) = 0.10$ and $P(A^c) = 0.90$. Given the test sensitivity $P(B | A) = 0.80$ and false-positive rate $P(B | A^c) = 0.20$, determine the overall positive test probability $P(B)$ via the Law of Total Probability.",
    "questionAr": "في فحص تشخيصي طبي، يحقق حدث المرض $A$ ومتممه $A^c$ الاحتمالين $P(A) = 0.10$ و $P(A^c) = 0.90$. بمعلومية حساسية الفحص $P(B | A) = 0.80$ ومعدل الإيجابية الخاطئة $P(B | A^c) = 0.20$، حدد الاحتمال الكلي لنتيجة فحص إيجابية $P(B)$ بقانون الاحتمال الكلي.",
    "optionsEn": [
      "$P(B) = 0.2600$",
      "$P(B) = 0.3100$",
      "$P(B) = 0.2100$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A quality assurance system inspects factory output partitioned into batch $A$ ($P(A) = 0.20$) and batch $A^c$ ($P(A^c) = 0.80$). If defect likelihoods are $P(B | A) = 0.80$ and $P(B | A^c) = 0.20$, compute the total defect rate $P(B)$.",
    "questionAr": "نظام توكيد جودة يفحص إنتاج مصنع مجزأ إلى الدفعة $A$ بـ ($P(A) = 0.20$) والدفعة $A^c$ بـ ($P(A^c) = 0.80$). إذا كانت احتمالات العيب $P(B | A) = 0.80$ و $P(B | A^c) = 0.20$، احسب معدل العيوب الإجمالي $P(B)$.",
    "optionsEn": [
      "$P(B) = 0.3700$",
      "$P(B) = 0.3200$",
      "$P(B) = 0.2700$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "An algorithmic network classifier routes incoming packets across primary channel $A$ ($P(A) = 0.30$) and secondary channel $A^c$ ($P(A^c) = 0.70$). Given packet loss rates $P(B | A) = 0.80$ and $P(B | A^c) = 0.20$, find the total probability of packet loss $P(B)$.",
    "questionAr": "مصنف شبكات خوارزمي يوجه حزم البيانات عبر القناة الأساسية $A$ ($P(A) = 0.30$) والقناة الاحتياطية $A^c$ ($P(A^c) = 0.70$). بمعلومية معدلات الفقد $P(B | A) = 0.80$ و $P(B | A^c) = 0.20$، أوجد احتمال فقد الحزم الإجمالي $P(B)$.",
    "optionsEn": [
      "$P(B) = 0.4300$",
      "$P(B) = 0.3300$",
      "$P(B) = 0.3800$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In a financial portfolio, market states partition into volatile regime $A$ ($P(A) = 0.40$) and stable regime $A^c$ ($P(A^c) = 0.60$). If loss risk is $P(B | A) = 0.80$ and $P(B | A^c) = 0.20$, evaluate the total probability of loss $P(B)$.",
    "questionAr": "في محفظة مالية، تنقسم حالات السوق إلى النظام المتقلب $A$ ($P(A) = 0.40$) والنظام المستقر $A^c$ ($P(A^c) = 0.60$). إذا كانت مخاطر الخسارة $P(B | A) = 0.80$ و $P(B | A^c) = 0.20$، احسب الاحتمال الكلي للخسارة $P(B)$.",
    "optionsEn": [
      "$P(B) = 0.4900$",
      "$P(B) = 0.3900$",
      "$P(B) = 0.5400$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Two equally likely production lines partition the sample space ($P(A) = P(A^c) = 0.50$). Given feature conditional likelihoods $P(B | A) = 0.80$ and $P(B | A^c) = 0.20$, determine the marginalized probability $P(B)$.",
    "questionAr": "خطا إنتاج متساويا الاحتمال يجزءان فضاء العينة ($P(A) = P(A^c) = 0.50$). بمعلومية الاحتمالات الشرطية للميزة $P(B | A) = 0.80$ و $P(B | A^c) = 0.20$، حدد الاحتمال الهامشي $P(B)$.",
    "optionsEn": [
      "$P(B) = 0.5000$",
      "$P(B) = 0.5500$",
      "$P(B) = 0.4500$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A quality control sample consists of $n = 10$ independent Bernoulli trials with defect probability $p = 0.25$ ($X \\sim \\text{Bin}(10, 0.25)$). Compute its theoretical expectation $\\mathbb{E}[X]$ and variance $\\text{Var}(X)$.",
    "questionAr": "عينة مراقبة جودة تتكون من $n = 10$ محاولات برنولي مستقلة باحتمال عيب $p = 0.25$ ($X \\sim \\text{Bin}(10, 0.25)$). احسب التوقع الرياضي $\\mathbb{E}[X]$ والتباين $\\text{Var}(X)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In a transmission experiment, $n = 20$ bits are transmitted through a noisy channel with bit-error rate $p = 0.25$. For the number of errors $X \\sim \\text{Bin}(20, 0.25)$, find $\\mathbb{E}[X]$ and $\\text{Var}(X)$.",
    "questionAr": "في تجربة إرسال، أُرسلت $n = 20$ بت عبر قناة مشوشة بمعدل خطأ في البت $p = 0.25$. لعدد الأخطاء $X \\sim \\text{Bin}(20, 0.25)$، أوجد $\\mathbb{E}[X]$ و $\\text{Var}(X)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A clinical study tests $n = 30$ patients under a treatment with efficacy probability $p = 0.25$. For $X \\sim \\text{Bin}(30, 0.25)$, determine the mean response $\\mathbb{E}[X]$ and statistical variance $\\text{Var}(X)$.",
    "questionAr": "دراسة سريرية تختبر $n = 30$ مريضاً تحت علاج باحتمال استجابة $p = 0.25$. للمتغير $X \\sim \\text{Bin}(30, 0.25)$، حدد متوسط الاستجابة $\\mathbb{E}[X]$ والتباين الإحصائي $\\text{Var}(X)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In an automated inspection of $n = 40$ microchips where each chip has failure probability $p = 0.25$, compute the expected number of failures $\\mathbb{E}[X]$ and variance $\\text{Var}(X)$ for $X \\sim \\text{Bin}(40, 0.25)$.",
    "questionAr": "في فحص آلي لـ $n = 40$ رقاقة إلكترونية حيث لكل رقاقة احتمال فشل $p = 0.25$، احسب العدد المتوقع للرقائق التالفة $\\mathbb{E}[X]$ والتباين $\\text{Var}(X)$ حيث $X \\sim \\text{Bin}(40, 0.25)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Consider an agricultural germination batch of $n = 50$ seeds with individual germination rate $p = 0.25$. Calculate the mean $\\mathbb{E}[X]$ and variance $\\text{Var}(X)$ for the total successes $X \\sim \\text{Bin}(50, 0.25)$.",
    "questionAr": "اعتبر دفعة إنبات زراعية تحتوي على $n = 50$ بذرة بمعدل إنبات فردي $p = 0.25$. احسب المتوسط $\\mathbb{E}[X]$ والتباين $\\text{Var}(X)$ لإجمالي البذور النابتة $X \\sim \\text{Bin}(50, 0.25)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Customer calls arrive at a call center according to a Poisson process with average intensity $\\lambda_1 = 2$ calls per hour. Over an extended observation window of $t = 2\\text{ hours}$, find the parameter $\\lambda_2$ and the probability that zero calls arrive.",
    "questionAr": "تصل مكالمات العملاء إلى مركز خدمة بموجب عملية بواسون بكثافة متوسطة $\\lambda_1 = 2$ مكالمة في الساعة. خلال نافذة مراقبة ممتدة مدتها $t = 2\\text{ ساعة}$، أوجد المعامل $\\lambda_2$ واحتمال عدم وصول أي مكالمة.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "In a cosmic ray detector, particles trigger detection events at a Poisson rate of $\\lambda_1 = 4$ particles/hour. For a continuous 2-hour monitoring run ($t = 2\\text{ h}$), evaluate $\\lambda_2$ and the probability $P(X = 0)$ of zero detections.",
    "questionAr": "في كاشف أشعة كونية، ترصد الجسيمات بمعدل بواسون قدره $\\lambda_1 = 4$ جسيم/ساعة. لفترة رصد مستمرة مدتها ساعتان ($t = 2\\text{ ساعة}$)، احسب $\\lambda_2$ واحتمال $P(X = 0)$ لعدم رصد أي جسيم.",
    "optionsEn": [
      "$\\lambda_2 = 4, \\quad P(X = 0) = e^{-4}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A server experiences request packet bursts governed by a Poisson process at intensity $\\lambda_1 = 6$ packets per hour. Over a duration of $t = 2\\text{ hours}$, determine the combined rate $\\lambda_2$ and the exact probability of observing no packet arrivals.",
    "questionAr": "يستقبل خادم حزم طلبات تخضع لعملية بواسون بكثافة $\\lambda_1 = 6$ حزمة في الساعة. على مدى فترة زمنية $t = 2\\text{ ساعة}$، حدد المعدل المشترك $\\lambda_2$ والاحتمال الدقيق لعدم وصول أي حزمة.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Defects along a manufacturing fiber occur randomly at a Poisson rate $\\lambda_1 = 8$ flaws per hour. During a 2-hour production cycle ($t = 2\\text{ h}$), find the parameter $\\lambda_2$ and the probability of a completely flaw-free interval $P(X = 0)$.",
    "questionAr": "تحدث العيوب في ألياف التصنيع عشوائياً بمعدل بواسون $\\lambda_1 = 8$ عيوب في الساعة. خلال دورة إنتاج مدتها ساعتان ($t = 2\\text{ ساعة}$)، أوجد المعامل $\\lambda_2$ واحتمال خلو الفترة تماماً من العيوب $P(X = 0)$.",
    "optionsEn": [
      "$\\lambda_2 = 8, \\quad P(X = 0) = e^{-8}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Seismic micro-tremors in a geological fault follow a Poisson distribution with mean frequency $\\lambda_1 = 10$ events/hour. For a 2-hour observation period, determine the new parameter $\\lambda_2$ and the probability $P(X = 0)$ that no tremor is recorded.",
    "questionAr": "الهزات الأرضية الخفيفة في فالق جيولوجي تتبع توزيع بواسون بتردد متوسط $\\lambda_1 = 10$ هزة/ساعة. لفترة رصد مدتها ساعتان، حدد المعامل الجديد $\\lambda_2$ واحتمال $P(X = 0)$ لعدم تسجيل أي هزة.",
    "optionsEn": [
      "$\\lambda_2 = 10, \\quad P(X = 0) = e^{-10}$",
