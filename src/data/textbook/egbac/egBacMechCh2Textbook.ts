...
export const egBacMechCh2Exercises: SolvedProblem[] = [
  {
    ...
    "difficulty": "easy",
    "questionEn": "A constant horizontal towing force of magnitude $F = 5\\text{ N}$ acts on a sled displacing it by distance $d = 4\\text{ m}$ in its direction. Find the work done $W = F \\cdot d$.",
    "questionAr": "قوة سحب أفقية ثابتة مقدارها $F = 5\\text{ ن}$ تؤثر على زلاجة فتحركها مسافة $d = 4\\text{ م}$ في اتجاهها. أوجد الشغل المبذول $W = F \\cdot d$.",
    "optionsEn": [
      "$W = 20\\text{ J}$",
      "$W = 30\\text{ J}$",
      "$W = 40\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "An electric winch applies a continuous tension $F = 10\\text{ N}$ along a cable over a straight haul distance $d = 4\\text{ m}$. Calculate the work performed $W$.",
    "questionAr": "ونش كهربائي يؤثر بقوة شد مستمرة $F = 10\\text{ ن}$ على طول كابل لمسافة سحب مستقيمة $d = 4\\text{ م}$. احسب الشغل المنجز $W$.",
    "optionsEn": [
      "$W = 50\\text{ J}$",
      "$W = 40\\text{ J}$",
      "$W = 60\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "During a material testing trial, a mechanical ram exerts a constant thrust of $F = 15\\text{ N}$ pushing an actuator forward by $d = 4\\text{ m}$. Compute the work done $W$.",
    "questionAr": "خلال تجربة اختبار مواد، يؤثر مكبس ميكانيكي بقوة دفع ثابتة $F = 15\\text{ ن}$ تدفع مشغلاً للأمام مسافة $d = 4\\text{ م}$. احسب الشغل المبذول $W$.",
    "optionsEn": [
      "$W = 70\\text{ J}$",
      "$W = 80\\text{ J}$",
      "$W = 60\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "A pneumatic cylinder pushes a crate with a sustained force $F = 20\\text{ N}$ across a smooth conveyor distance of $d = 4\\text{ m}$. Determine the work input $W$.",
    "questionAr": "أسطوانة هواء تضغط صندوقاً بقوة مستمرة $F = 20\\text{ ن}$ عبر مسافة سير ملساء $d = 4\\text{ م}$. حدد الشغل المنجز $W$.",
    "optionsEn": [
      "$W = 90\\text{ J}$",
      "$W = 100\\text{ J}$",
      "$W = 75\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "A test vehicle rocket thruster generates a constant propulsive force $F = 25\\text{ N}$ while traveling a displacement $d = 4\\text{ m}$ along a rail. Find the work $W$.",
    "questionAr": "محرك صاروخي لمركبة اختبار يولد قوة دفع ثابتة $F = 25\\text{ ن}$ أثناء قطع إزاحة $d = 4\\text{ م}$ على سكة. أوجد الشغل $W$.",
    "optionsEn": [
      "$W = 100\\text{ J}$",
      "$W = 110\\text{ J}$",
      "$W = 120\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A satellite of mass $m = 2\\text{ kg}$ traverses a circular orbit of radius $r = 3\\text{ m}$ at orbital speed $v = 5\\text{ m/s}$. Find its angular momentum $L = mvr$.",
    "questionAr": "قمر صناعي كتلته $m = 2\\text{ كجم}$ يتحرك في مدار دائري نصف قطره $r = 3\\text{ م}$ بسرعة مدارية $v = 5\\text{ م/ث}$. أوجد كمية حركته الزاوية $L = mvr$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A tethered particle of mass $m = 2\\text{ kg}$ revolves horizontally on a circle of radius $r = 6\\text{ m}$ at constant velocity $v = 5\\text{ m/s}$. Determine its angular momentum $L$.",
    "questionAr": "جسيم مربوط كتلته $m = 2\\text{ كجم}$ يدور أفقياً في دائرة نصف قطرها $r = 6\\text{ م}$ بسرعة ثابتة $v = 5\\text{ م/ث}$. حدد كمية حركته الزاوية $L$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "In a laboratory centrifuge arm, a test mass $m = 2\\text{ kg}$ rotates at radial distance $r = 9\\text{ m}$ with linear speed $v = 5\\text{ m/s}$. Calculate the angular momentum $L$.",
    "questionAr": "في ذراع جهاز طرد مركزي معملي، تدور كتلة اختبار $m = 2\\text{ كجم}$ عند بعد نصف قطري $r = 9\\text{ م}$ بسرعة خطية $v = 5\\text{ م/ث}$. احسب كمية الحركة الزاوية $L$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "An astronomical probe of mass $m = 2\\text{ kg}$ orbits in a circular trajectory of radius $r = 12\\text{ m}$ at constant speed $v = 5\\text{ m/s}$. Compute its angular momentum $L$.",
    "questionAr": "مسبار فلكي كتلته $m = 2\\text{ كجم}$ يدور في مسار دائري نصف قطره $r = 12\\text{ م}$ بسرعة منتظمة $v = 5\\text{ م/ث}$. احسب كمية حركته الزاوية $L$.",
    "optionsEn": [
      "$L = 120\\text{ kg}\\cdot\\text{m}^2\\text{/s}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A flywheel perimeter element of mass $m = 2\\text{ kg}$ rotates at radius $r = 15\\text{ m}$ with peripheral speed $v = 5\\text{ m/s}$. Find its total angular momentum $L$.",
    "questionAr": "عنصر محيطي في حذافة كتلته $m = 2\\text{ كجم}$ يدور عند نصف قطر $r = 15\\text{ م}$ بسرعة محيطية $v = 5\\text{ م/ث}$. أوجد كمية حركته الزاوية الإجمالية $L$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Calculate the kinetic energy $T = \\frac{1}{2}mv^2$ of a particle of mass $m = 4\\text{ kg}$ moving at translation speed $v = 3\\text{ m/s}$.",
    "questionAr": "احسب طاقة الحركة $T = \\frac{1}{2}mv^2$ لجسيم كتلته $m = 4\\text{ كجم}$ يتحرك بسرعة انتقالية $v = 3\\text{ م/ث}$.",
    "optionsEn": [
      "$T = 36\\text{ J}$",
      "$T = 54\\text{ J}$",
      "$T = 18\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A laboratory cart with mass $m = 4\\text{ kg}$ glides across an air track at speed $v = 6\\text{ m/s}$. Determine its kinetic energy $T$.",
    "questionAr": "عربة معملية كتلتها $m = 4\\text{ كجم}$ تنزلق على مسار هوائي بسرعة $v = 6\\text{ م/ث}$. حدد طاقة حركتها $T$.",
    "optionsEn": [
      "$T = 90\\text{ J}$",
      "$T = 108\\text{ J}$",
      "$T = 63\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "An autonomous projectile of mass $m = 4\\text{ kg}$ attains cruising speed $v = 9\\text{ m/s}$. Compute the total kinetic energy $T$ carried by the projectile.",
    "questionAr": "قذيفة ذاتية الدفع كتلتها $m = 4\\text{ كجم}$ تبلغ سرعة طيران $v = 9\\text{ م/ث}$. احسب إجمالي طاقة الحركة $T$ المحمولة بالقذيفة.",
    "optionsEn": [
      "$T = 162\\text{ J}$",
      "$T = 180\\text{ J}$",
      "$T = 198\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "In a dynamic collision test, a vehicle body of mass $m = 4\\text{ kg}$ strikes a barrier at impact velocity $v = 12\\text{ m/s}$. Find the kinetic energy $T$.",
    "questionAr": "في اختبار تصادم ديناميكي، تصطدم مركبة كتلتها $m = 4\\text{ كجم}$ بحاجز عند سرعة تصادم $v = 12\\text{ م/ث}$. أوجد طاقة الحركة $T$.",
    "optionsEn": [
      "$T = 306\\text{ J}$",
      "$T = 288\\text{ J}$",
      "$T = 324\\text{ J}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Determine the kinetic energy $T$ stored in a mass $m = 4\\text{ kg}$ traveling at a high velocity of $v = 15\\text{ m/s}$.",
    "questionAr": "حدد طاقة الحركة $T$ المخزنة في كتلة $m = 4\\text{ كجم}$ تتحرك بسرعة عالية تبلغ $v = 15\\text{ م/ث}$.",
    "optionsEn": [
      "$T = 468\\text{ J}$",
      "$T = 486\\text{ J}$",
      "$T = 450\\text{ J}$",
