...
export const egBacAnaCh1Exercises: SolvedProblem[] = [
  {
    ...
    "difficulty": "easy",
    "questionEn": "For the limit $\\lim_{x \\to 1} (2x + 3) = 5$, determine the maximum value of $\\delta$ in terms of $\\epsilon > 0$ that satisfies the limit definition.",
    "questionAr": "للنهاية $\\lim_{x \\to 1} (2x + 3) = 5$، أوجد أقصى قيمة لـ $\\delta$ بدلالة $\\epsilon > 0$ تحقق تعريف النهاية.",
    "optionsEn": [
      "$\\delta = \\frac{\\epsilon}{2}$",
      "$\\delta = 2\\epsilon$",
      "$\\delta = \\frac{\\epsilon}{4}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "For the limit $\\lim_{x \\to 1} (3x + 3) = 6$, determine the maximum value of $\\delta$ in terms of $\\epsilon > 0$ that satisfies the limit definition.",
    "questionAr": "للنهاية $\\lim_{x \\to 1} (3x + 3) = 6$، أوجد أقصى قيمة لـ $\\delta$ بدلالة $\\epsilon > 0$ تحقق تعريف النهاية.",
    "optionsEn": [
      "$\\delta = 3\\epsilon$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "For the limit $\\lim_{x \\to 1} (4x + 3) = 7$, determine the maximum value of $\\delta$ in terms of $\\epsilon > 0$ that satisfies the limit definition.",
    "questionAr": "للنهاية $\\lim_{x \\to 1} (4x + 3) = 7$، أوجد أقصى قيمة لـ $\\delta$ بدلالة $\\epsilon > 0$ تحقق تعريف النهاية.",
    "optionsEn": [
      "$\\delta = 4\\epsilon$",
      "$\\delta = \\frac{\\epsilon}{6}$",
      "$\\delta = \\frac{\\epsilon}{4}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "For the limit $\\lim_{x \\to 1} (5x + 3) = 8$, determine the maximum value of $\\delta$ in terms of $\\epsilon > 0$ that satisfies the limit definition.",
    "questionAr": "للنهاية $\\lim_{x \\to 1} (5x + 3) = 8$، أوجد أقصى قيمة لـ $\\delta$ بدلالة $\\epsilon > 0$ تحقق تعريف النهاية.",
    "optionsEn": [
      "$\\delta = 5\\epsilon$",
      "$\\delta = \\frac{\\epsilon}{7}$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "For the limit $\\lim_{x \\to 1} (6x + 3) = 9$, determine the maximum value of $\\delta$ in terms of $\\epsilon > 0$ that satisfies the limit definition.",
    "questionAr": "للنهاية $\\lim_{x \\to 1} (6x + 3) = 9$، أوجد أقصى قيمة لـ $\\delta$ بدلالة $\\epsilon > 0$ تحقق تعريف النهاية.",
    "optionsEn": [
      "$\\delta = \\frac{\\epsilon}{6}$",
      "$\\delta = 6\\epsilon$",
      "$\\delta = \\frac{\\epsilon}{8}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the limit: $\\lim_{x \\to 0} x^{2} \\sin\\left(\\frac{1}{x^{1}}\\right)$.",
    "questionAr": "احسب النهاية: $\\lim_{x \\to 0} x^{2} \\sin\\left(\\frac{1}{x^{1}}\\right)$.",
    "optionsEn": [
      "1",
      "0",
      "\\infty",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the limit: $\\lim_{x \\to 0} x^{3} \\sin\\left(\\frac{1}{x^{2}}\\right)$.",
    "questionAr": "احسب النهاية: $\\lim_{x \\to 0} x^{3} \\sin\\left(\\frac{1}{x^{2}}\\right)$.",
    "optionsEn": [
      "1",
      "\\infty",
      "0",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the limit: $\\lim_{x \\to 0} x^{4} \\sin\\left(\\frac{1}{x^{3}}\\right)$.",
    "questionAr": "احسب النهاية: $\\lim_{x \\to 0} x^{4} \\sin\\left(\\frac{1}{x^{3}}\\right)$.",
    "optionsEn": [
      "1",
      "\\infty",
      "-1",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the limit: $\\lim_{x \\to 0} x^{5} \\sin\\left(\\frac{1}{x^{4}}\\right)$.",
    "questionAr": "احسب النهاية: $\\lim_{x \\to 0} x^{5} \\sin\\left(\\frac{1}{x^{4}}\\right)$.",
    "optionsEn": [
      "0",
      "1",
      "\\infty",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the limit: $\\lim_{x \\to 0} x^{6} \\sin\\left(\\frac{1}{x^{5}}\\right)$.",
    "questionAr": "احسب النهاية: $\\lim_{x \\to 0} x^{6} \\sin\\left(\\frac{1}{x^{5}}\\right)$.",
    "optionsEn": [
      "1",
      "0",
      "\\infty",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the oblique asymptote as $x \\to \\infty$ for $f(x) = \\frac{2x^2 + 5}{x}$.",
    "questionAr": "أوجد معادلة المستقيم المقارب المائل عندما $x \\to \\infty$ للدالة $f(x) = \\frac{2x^2 + 5}{x}$.",
    "optionsEn": [
      "$y = 2x + 2$",
      "$y = 2x - 1$",
      "$y = 2x$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the oblique asymptote as $x \\to \\infty$ for $f(x) = \\frac{3x^2 + 5}{x}$.",
    "questionAr": "أوجد معادلة المستقيم المقارب المائل عندما $x \\to \\infty$ للدالة $f(x) = \\frac{3x^2 + 5}{x}$.",
    "optionsEn": [
      "$y = 3x + 2$",
      "$y = 3x - 1$",
      "$y = 4x$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the oblique asymptote as $x \\to \\infty$ for $f(x) = \\frac{4x^2 + 5}{x}$.",
    "questionAr": "أوجد معادلة المستقيم المقارب المائل عندما $x \\to \\infty$ للدالة $f(x) = \\frac{4x^2 + 5}{x}$.",
    "optionsEn": [
      "$y = 4x$",
      "$y = 4x + 2$",
      "$y = 4x - 1$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the oblique asymptote as $x \\to \\infty$ for $f(x) = \\frac{5x^2 + 5}{x}$.",
    "questionAr": "أوجد معادلة المستقيم المقارب المائل عندما $x \\to \\infty$ للدالة $f(x) = \\frac{5x^2 + 5}{x}$.",
    "optionsEn": [
      "$y = 5x + 2$",
      "$y = 5x$",
      "$y = 5x - 1$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the oblique asymptote as $x \\to \\infty$ for $f(x) = \\frac{6x^2 + 5}{x}$.",
    "questionAr": "أوجد معادلة المستقيم المقارب المائل عندما $x \\to \\infty$ للدالة $f(x) = \\frac{6x^2 + 5}{x}$.",
    "optionsEn": [
      "$y = 6x + 2$",
      "$y = 6x - 1$",
      "$y = 6x$",
