...
export const egBacCh2Exercises: SolvedProblem[] = [
  {
    ...
    "difficulty": "easy",
    "questionEn": "Determine the linear algebraic rank of the $2 \\times 2$ matrix $A = \\begin{pmatrix} 1 & 2 \\\\ 1 & 2 \\end{pmatrix}$.",
    "questionAr": "حدد رتبة المصفوفة الجبرية الخطية من الرتبة $2 \\times 2$ الآتية: $A = \\begin{pmatrix} 1 & 2 \\\\ 1 & 2 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{rank}(A) = 1$",
      "$\\text{rank}(A) = 2$",
      "$\\text{rank}(A) = 0$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "By examining row linearly dependent relationships, evaluate $\\text{rank}(A)$ for $A = \\begin{pmatrix} 2 & 4 \\\\ 1 & 2 \\end{pmatrix}$.",
    "questionAr": "بفحص علاقات الارتباط الخطي بين الصفوف، احسب $\\text{rank}(A)$ للمصفوفة $A = \\begin{pmatrix} 2 & 4 \\\\ 1 & 2 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{rank}(A) = 2$",
      "$\\text{rank}(A) = 1$",
      "$\\text{rank}(A) = 0$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the dimension of the column space (rank) for the matrix $A = \\begin{pmatrix} 3 & 6 \\\\ 1 & 2 \\end{pmatrix}$.",
    "questionAr": "أوجد بعد فضاء الأعمدة (الرتبة) للمصفوفة $A = \\begin{pmatrix} 3 & 6 \\\\ 1 & 2 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{rank}(A) = 2$",
      "$\\text{rank}(A) = 0$",
      "$\\text{rank}(A) = 1$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Calculate the rank of the coefficient array $A = \\begin{pmatrix} 4 & 8 \\\\ 1 & 2 \\end{pmatrix}$.",
    "questionAr": "احسب رتبة مصفوفة المعاملات $A = \\begin{pmatrix} 4 & 8 \\\\ 1 & 2 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{rank}(A) = 2$",
      "$\\text{rank}(A) = 0$",
      "$\\text{rank}(A) = 3$",
  ...
  },
  {
    ...
    "difficulty": "easy",
    "questionEn": "Find the maximum number of linearly independent row vectors in $A = \\begin{pmatrix} 5 & 10 \\\\ 1 & 2 \\end{pmatrix}$.",
    "questionAr": "أوجد أقصى عدد من متجهات الصفوف المستقلة خطياً في المصفوفة $A = \\begin{pmatrix} 5 & 10 \\\\ 1 & 2 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{rank}(A) = 1$",
      "$\\text{rank}(A) = 2$",
      "$\\text{rank}(A) = 0$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Calculate the trace $\\text{tr}(A)$ by summing the main diagonal entries of $A = \\begin{pmatrix} 1 & 1 & 4 \\\\ 0 & 2 & -1 \\\\ 5 & 2 & 3 \\end{pmatrix}$.",
    "questionAr": "احسب أثر المصفوفة $\\text{tr}(A)$ بجمع عناصر القطر الرئيسي للمصفوفة $A = \\begin{pmatrix} 1 & 1 & 4 \\\\ 0 & 2 & -1 \\\\ 5 & 2 & 3 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{tr}(A) = 8$",
      "$\\text{tr}(A) = 6$",
      "$\\text{tr}(A) = 4$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Find the value of the matrix trace $\\text{tr}(A)$ for the $3 \\times 3$ transformation $A = \\begin{pmatrix} 2 & 1 & 4 \\\\ 0 & 4 & -1 \\\\ 5 & 2 & 6 \\end{pmatrix}$.",
    "questionAr": "أوجد قيمة أثر المصفوفة $\\text{tr}(A)$ للتحويل الخطي $A = \\begin{pmatrix} 2 & 1 & 4 \\\\ 0 & 4 & -1 \\\\ 5 & 2 & 6 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{tr}(A) = 14$",
      "$\\text{tr}(A) = 10$",
      "$\\text{tr}(A) = 12$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Evaluate the trace functional $\\text{tr}(A)$ for the square matrix $A = \\begin{pmatrix} 3 & 1 & 4 \\\\ 0 & 6 & -1 \\\\ 5 & 2 & 9 \\end{pmatrix}$.",
    "questionAr": "احسب دالة الأثر $\\text{tr}(A)$ للمصفوفة المربعة $A = \\begin{pmatrix} 3 & 1 & 4 \\\\ 0 & 6 & -1 \\\\ 5 & 2 & 9 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{tr}(A) = 20$",
      "$\\text{tr}(A) = 16$",
      "$\\text{tr}(A) = 24$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Determine the sum of the eigenvalues (which equals the trace) for $A = \\begin{pmatrix} 4 & 1 & 4 \\\\ 0 & 8 & -1 \\\\ 5 & 2 & 12 \\end{pmatrix}$.",
    "questionAr": "حدد مجموع القيم الذاتية (الذي يساوي الأثر) للمصفوفة $A = \\begin{pmatrix} 4 & 1 & 4 \\\\ 0 & 8 & -1 \\\\ 5 & 2 & 12 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{tr}(A) = 24$",
      "$\\text{tr}(A) = 26$",
      "$\\text{tr}(A) = 22$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Compute the trace $\\text{tr}(A)$ for the given system matrix $A = \\begin{pmatrix} 5 & 1 & 4 \\\\ 0 & 10 & -1 \\\\ 5 & 2 & 15 \\end{pmatrix}$.",
    "questionAr": "احسب أثر المصفوفة $\\text{tr}(A)$ لمصفوفة المنظومة المعطاة $A = \\begin{pmatrix} 5 & 1 & 4 \\\\ 0 & 10 & -1 \\\\ 5 & 2 & 15 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\text{tr}(A) = 32$",
      "$\\text{tr}(A) = 30$",
      "$\\text{tr}(A) = 28$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Identify the maximum eigenvalue $\\lambda_{\\max}$ for the diagonal matrix $D = \\begin{pmatrix} 1 & 0 & 0 \\\\ 0 & 2 & 0 \\\\ 0 & 0 & 4 \\end{pmatrix}$.",
    "questionAr": "عين القيمة الذاتية العظمى $\\lambda_{\\max}$ للمصفوفة القطرية $D = \\begin{pmatrix} 1 & 0 & 0 \\\\ 0 & 2 & 0 \\\\ 0 & 0 & 4 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\lambda_{\\max} = 2$",
      "$\\lambda_{\\max} = 1$",
      "$\\lambda_{\\max} = 4$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Determine the dominant eigenvalue of the diagonal spectral form $D = \\begin{pmatrix} 2 & 0 & 0 \\\\ 0 & 4 & 0 \\\\ 0 & 0 & 8 \\end{pmatrix}$.",
    "questionAr": "حدد القيمة الذاتية السائدة في الصيغة الطيفية القطرية $D = \\begin{pmatrix} 2 & 0 & 0 \\\\ 0 & 4 & 0 \\\\ 0 & 0 & 8 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\lambda_{\\max} = 4$",
      "$\\lambda_{\\max} = 2$",
      "$\\lambda_{\\max} = 10$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "For the diagonal matrix $D = \\begin{pmatrix} 3 & 0 & 0 \\\\ 0 & 6 & 0 \\\\ 0 & 0 & 12 \\end{pmatrix}$, find its largest eigenvalue $\\lambda_{\\max}$.",
    "questionAr": "للمصفوفة القطرية $D = \\begin{pmatrix} 3 & 0 & 0 \\\\ 0 & 6 & 0 \\\\ 0 & 0 & 12 \\end{pmatrix}$، أوجد أكبر قيمة ذاتية لها $\\lambda_{\\max}$.",
    "optionsEn": [
      "$\\lambda_{\\max} = 12$",
      "$\\lambda_{\\max} = 6$",
      "$\\lambda_{\\max} = 3$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Find the spectral radius (largest eigenvalue) $\\lambda_{\\max}$ of $D = \\begin{pmatrix} 4 & 0 & 0 \\\\ 0 & 8 & 0 \\\\ 0 & 0 & 16 \\end{pmatrix}$.",
    "questionAr": "أوجد نصف القطر الطيفي (أكبر قيمة ذاتية) $\\lambda_{\\max}$ للمصفوفة $D = \\begin{pmatrix} 4 & 0 & 0 \\\\ 0 & 8 & 0 \\\\ 0 & 0 & 16 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\lambda_{\\max} = 8$",
      "$\\lambda_{\\max} = 16$",
      "$\\lambda_{\\max} = 4$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "Compute the maximum characteristic root $\\lambda_{\\max}$ for the uncoupled diagonal system $D = \\begin{pmatrix} 5 & 0 & 0 \\\\ 0 & 10 & 0 \\\\ 0 & 0 & 20 \\end{pmatrix}$.",
    "questionAr": "احسب الجذر المميز الأكبر $\\lambda_{\\max}$ للمنظومة القطرية غير المقترنة $D = \\begin{pmatrix} 5 & 0 & 0 \\\\ 0 & 10 & 0 \\\\ 0 & 0 & 20 \\end{pmatrix}$.",
    "optionsEn": [
      "$\\lambda_{\\max} = 10$",
      "$\\lambda_{\\max} = 5$",
      "$\\lambda_{\\max} = 20$",
