...
export const egBacProbCh2Exercises: SolvedProblem[] = [
  {
    ...
    "difficulty": "medium",
    "questionEn": "A continuous random variable $X$ is uniformly distributed over the interval $[0, 6]$ ($X \\sim \\mathcal{U}(0, 6)$). Compute its theoretical mean $\\mathbb{E}[X]$ and variance $\\text{Var}(X)$.",
    "questionAr": "متغير عشوائي متصل $X$ يتبع التوزيع المنتظم على الفتره $[0, 6]$ ($X \\sim \\mathcal{U}(0, 6)$). احسب متوسطه النظري $\\mathbb{E}[X]$ وتباينه $\\text{Var}(X)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A continuous random variable $X$ is uniformly distributed over the interval $[0, 12]$ ($X \\sim \\mathcal{U}(0, 12)$). Compute its theoretical mean $\\mathbb{E}[X]$ and variance $\\text{Var}(X)$.",
    "questionAr": "متغير عشوائي متصل $X$ يتبع التوزيع المنتظم على الفتره $[0, 12]$ ($X \\sim \\mathcal{U}(0, 12)$). احسب متوسطه النظري $\\mathbb{E}[X]$ وتباينه $\\text{Var}(X)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A continuous random variable $X$ is uniformly distributed over the interval $[0, 18]$ ($X \\sim \\mathcal{U}(0, 18)$). Compute its theoretical mean $\\mathbb{E}[X]$ and variance $\\text{Var}(X)$.",
    "questionAr": "متغير عشوائي متصل $X$ يتبع التوزيع المنتظم على الفتره $[0, 18]$ ($X \\sim \\mathcal{U}(0, 18)$). احسب متوسطه النظري $\\mathbb{E}[X]$ وتباينه $\\text{Var}(X)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A continuous random variable $X$ is uniformly distributed over the interval $[0, 24]$ ($X \\sim \\mathcal{U}(0, 24)$). Compute its theoretical mean $\\mathbb{E}[X]$ and variance $\\text{Var}(X)$.",
    "questionAr": "متغير عشوائي متصل $X$ يتبع التوزيع المنتظم على الفتره $[0, 24]$ ($X \\sim \\mathcal{U}(0, 24)$). احسب متوسطه النظري $\\mathbb{E}[X]$ وتباينه $\\text{Var}(X)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "A continuous random variable $X$ is uniformly distributed over the interval $[0, 30]$ ($X \\sim \\mathcal{U}(0, 30)$). Compute its theoretical mean $\\mathbb{E}[X]$ and variance $\\text{Var}(X)$.",
    "questionAr": "متغير عشوائي متصل $X$ يتبع التوزيع المنتظم على الفتره $[0, 30]$ ($X \\sim \\mathcal{U}(0, 30)$). احسب متوسطه النظري $\\mathbb{E}[X]$ وتباينه $\\text{Var}(X)$.",
    "optionsEn": [
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Let $X \\sim \\text{Exp}(\\lambda = 1)$ be an exponentially distributed random variable. What is the exact survival probability $P(X > 2)$?",
    "questionAr": "ليكن $X \\sim \\text{Exp}(\\lambda = 1)$ متغيراً عشوائياً يتبع التوزيع الأسي. ما هو احتمال البقاء الدقيق $P(X > 2)$؟",
    "optionsEn": [
      "$P(X > 2) = 1 - e^{-2}$",
      "$P(X > 2) = e^{-2}$",
      "$P(X > 2) = e^{-1}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Let $X \\sim \\text{Exp}(\\lambda = 2)$ be an exponentially distributed random variable. What is the exact survival probability $P(X > 2)$?",
    "questionAr": "ليكن $X \\sim \\text{Exp}(\\lambda = 2)$ متغيراً عشوائياً يتبع التوزيع الأسي. ما هو احتمال البقاء الدقيق $P(X > 2)$؟",
    "optionsEn": [
      "$P(X > 2) = 1 - e^{-4}$",
      "$P(X > 2) = e^{-2}$",
      "$P(X > 2) = e^{-4}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Let $X \\sim \\text{Exp}(\\lambda = 3)$ be an exponentially distributed random variable. What is the exact survival probability $P(X > 2)$?",
    "questionAr": "ليكن $X \\sim \\text{Exp}(\\lambda = 3)$ متغيراً عشوائياً يتبع التوزيع الأسي. ما هو احتمال البقاء الدقيق $P(X > 2)$؟",
    "optionsEn": [
      "$P(X > 2) = 1 - e^{-6}$",
      "$P(X > 2) = e^{-3}$",
      "$P(X > 2) = e^{-12}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Let $X \\sim \\text{Exp}(\\lambda = 4)$ be an exponentially distributed random variable. What is the exact survival probability $P(X > 2)$?",
    "questionAr": "ليكن $X \\sim \\text{Exp}(\\lambda = 4)$ متغيراً عشوائياً يتبع التوزيع الأسي. ما هو احتمال البقاء الدقيق $P(X > 2)$؟",
    "optionsEn": [
      "$P(X > 2) = e^{-8}$",
      "$P(X > 2) = 1 - e^{-8}$",
      "$P(X > 2) = e^{-4}$",
  ...
  },
  {
    ...
    "difficulty": "medium",
    "questionEn": "Let $X \\sim \\text{Exp}(\\lambda = 5)$ be an exponentially distributed random variable. What is the exact survival probability $P(X > 2)$?",
    "questionAr": "ليكن $X \\sim \\text{Exp}(\\lambda = 5)$ متغيراً عشوائياً يتبع التوزيع الأسي. ما هو احتمال البقاء الدقيق $P(X > 2)$؟",
    "optionsEn": [
      "$P(X > 2) = 1 - e^{-10}$",
      "$P(X > 2) = e^{-10}$",
      "$P(X > 2) = e^{-5}$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A population has standard deviation $\\sigma = 20$. A random sample of size $n = 4$ is drawn. According to the Central Limit Theorem, compute the standard error of the sample mean $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "questionAr": "مجتمع إحصائي انحرافه المعياري $\\sigma = 20$. سُحبت عينة عشوائية حجمها $n = 4$. وفق نظرية النهاية المركزية، احسب الخطأ المعياري لمتوسط العينة $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "optionsEn": [
      "$\\sigma_{\\bar{X}} = 11.00$",
      "$\\sigma_{\\bar{X}} = 12.00$",
      "$\\sigma_{\\bar{X}} = 10$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A population has standard deviation $\\sigma = 20$. A random sample of size $n = 16$ is drawn. According to the Central Limit Theorem, compute the standard error of the sample mean $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "questionAr": "مجتمع إحصائي انحرافه المعياري $\\sigma = 20$. سُحبت عينة عشوائية حجمها $n = 16$. وفق نظرية النهاية المركزية، احسب الخطأ المعياري لمتوسط العينة $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "optionsEn": [
      "$\\sigma_{\\bar{X}} = 6.00$",
      "$\\sigma_{\\bar{X}} = 7.00$",
      "$\\sigma_{\\bar{X}} = 4.50$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A population has standard deviation $\\sigma = 20$. A random sample of size $n = 36$ is drawn. According to the Central Limit Theorem, compute the standard error of the sample mean $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "questionAr": "مجتمع إحصائي انحرافه المعياري $\\sigma = 20$. سُحبت عينة عشوائية حجمها $n = 36$. وفق نظرية النهاية المركزية، احسب الخطأ المعياري لمتوسط العينة $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "optionsEn": [
      "$\\sigma_{\\bar{X}} = 3.33$",
      "$\\sigma_{\\bar{X}} = 4.33$",
      "$\\sigma_{\\bar{X}} = 5.33$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A population has standard deviation $\\sigma = 20$. A random sample of size $n = 64$ is drawn. According to the Central Limit Theorem, compute the standard error of the sample mean $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "questionAr": "مجتمع إحصائي انحرافه المعياري $\\sigma = 20$. سُحبت عينة عشوائية حجمها $n = 64$. وفق نظرية النهاية المركزية، احسب الخطأ المعياري لمتوسط العينة $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "optionsEn": [
      "$\\sigma_{\\bar{X}} = 3.50$",
      "$\\sigma_{\\bar{X}} = 2.5$",
      "$\\sigma_{\\bar{X}} = 4.50$",
  ...
  },
  {
    ...
    "difficulty": "hots",
    "questionEn": "A population has standard deviation $\\sigma = 20$. A random sample of size $n = 100$ is drawn. According to the Central Limit Theorem, compute the standard error of the sample mean $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "questionAr": "مجتمع إحصائي انحرافه المعياري $\\sigma = 20$. سُحبت عينة عشوائية حجمها $n = 100$. وفق نظرية النهاية المركزية، احسب الخطأ المعياري لمتوسط العينة $\\sigma_{\\bar{X}} = \\frac{\\sigma}{\\sqrt{n}}$.",
    "optionsEn": [
      "$\\sigma_{\\bar{X}} = 3.00$",
      "$\\sigma_{\\bar{X}} = 4.00$",
      "$\\sigma_{\\bar{X}} = 2$",
