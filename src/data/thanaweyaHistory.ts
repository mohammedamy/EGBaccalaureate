...
import { historyCh1SolvedExamples, historyCh1Exercises } from './textbook/thanaweya/historyCh1Textbook';
import { historyCh2SolvedExamples, historyCh2Exercises } from './textbook/thanaweya/historyCh2Textbook';
import { historyCh3SolvedExamples, historyCh3Exercises } from './textbook/thanaweya/historyCh3Textbook';
import { historyCh4SolvedExamples, historyCh4Exercises } from './textbook/thanaweya/historyCh4Textbook';
import { historyCh5SolvedExamples, historyCh5Exercises } from './textbook/thanaweya/historyCh5Textbook';
import { historyCh6SolvedExamples, historyCh6Exercises } from './textbook/thanaweya/historyCh6Textbook';
import { historyCh7SolvedExamples, historyCh7Exercises } from './textbook/thanaweya/historyCh7Textbook';
import { historyCh8SolvedExamples, historyCh8Exercises } from './textbook/thanaweya/historyCh8Textbook';

export const thanaweyaHistoryBranch: Branch = {
  id: "thanaweya_history",
  ...
  iconName: "Landmark",
  colorGradient: "from-amber-700 via-yellow-700 to-stone-800",
  chapters: [
    {
      ...{
  "id": "th_hist_ch1",
  "chapterNumber": 1,
  "titleEn": "Unit 1: The French Expedition to Egypt and the Levant (1798–1801)",
  "titleAr": "الفصل الأول: الحملة الفرنسية على مصر والشام (1798–1801م)",
  "descriptionEn": "European colonial rivalry, pre-expedition Ottoman-Mamluk decline, Alexandria resistance under Muhammad Kurayyim, battles of Shubra Khit and Imbaba, Abukir Bay naval turning point, Upper Egypt resistance, First & Second Cairo Revolts, Levant expedition, and the enduring political, economic, judicial, and scientific legacies (Institut d'Égypte, Rosetta Stone, Description de l'Égypte).",
  "descriptionAr": "التنافس الاستعماري الأوروبي، أحوال مصر قبيل الحملة (الالتزام وطوائف الحرف)، مقاومة الإسكندرية ومحمد كُريّم، معركتا شبراخيت وإمبابة، موقعة أبي قير البحرية، ملحمة صمود الصعيد، ثورتا القاهرة الأولى والثانية، حملة الشام، والآثار الشاملة (الدواوين، القضاء، المجمع العلمي، حجر رشيد، كتاب وصف مصر، ويقظة الوعي القومي).",
  ...
  "lessons": [
    ...
    },
    {
      ...
      solvedExamples: historyCh1SolvedExamples,
      exerciseProblems: historyCh1Exercises
    },
    {
      ...{
  "id": "th_hist_ch2",
  "chapterNumber": 2,
  "titleEn": "Unit 2: Building the Modern Egyptian State under Muhammad Ali & Successors (1805–1879)",
  "titleAr": "الفصل الثاني: بناء الدولة الحديثة في عهد محمد علي وخلفائه حتى إسماعيل (1805–1879م)",
  "descriptionEn": "The popular revolution of 1805 and selection of Muhammad Ali, consolidation of power (Fraser expedition, elimination of Popular Leadership and Citadel Massacre), economic state monopoly (Ihtikar) across agriculture, industry, and commerce, administrative and military renaissance, external expansionism (Sudan, Hejaz, Greece, Levant), Treaty of London (1840), collapse of Monopoly, and the reign of Ismail.",
  "descriptionAr": "ثورة الشعب 1805م واختيار محمد علي، توطيد السلطة (حملة فريزر، نفي عمر مكرم، مذبحة القلعة 1811م)، نظام الاحتكار في الزراعة والصناعة والتجارة، بناء الجيش والأسطول والتعليم، الحروب الخارجية والتوسع، معاهدة لندن 1840م، سقوط الاحتكار، وعصر الخديوي إسماعيل والنهضة الثقافية وتفاقم الأزمة المالية.",
  "isFullyEquipped": true,
  "lessons": [
    {
      "id": "th_hist_ch2_l1",
    ...
    },
    {
      ...
      solvedExamples: historyCh2SolvedExamples,
      exerciseProblems: historyCh2Exercises
    },
    {
      ...{
  "id": "th_hist_ch3",
  "chapterNumber": 3,
  "titleEn": "Unit 3: Egypt Under the Orabi Revolt and British Occupation (1881–1914)",
  "titleAr": "الفصل الثالث: مصر منذ الثورة العرابية حتى الحرب العالمية الأولى (1881–1914م)",
  "descriptionEn": "Financial crisis under Tawfiq, Dual Control and Law of Liquidation (1880), the Orabi Revolt and Abdeen manifestations, Baroudi Revolution Ministry, British invasion (bombardment of Alexandria, Kafr El-Dawar, De Lesseps betrayal, Tell El-Kebir), Dufferin Basic Law of 1883, Cromer's Anglicization and economic de-industrialization, Dunlop's education regime, and nationalist resurgence under Mustafa Kamel (Fashoda, Entente Cordiale, Denshawai) and Muhammad Farid (trade unionism and night schools).",
  "descriptionAr": "الأزمة المالية في عهد توفيق، المراقبة الثنائية وقانون التصفية 1880م، مظالم الضباط والثورة العرابية ومظاهرتا عابدين، وزارة الثورة للبارودي، التدخل والعدوان البريطاني (ضرب الإسكندرية، صمود كفر الدوار، خيانة دي لسبس، التل الكبير)، القانون الأساسي 1883م لدافرين، قبضة كرومر والنجلزة وتدمير الصناعة، تجهيل دانلوب، ويقظة الحركة الوطنية مع مصطفى كامل (فاشودة، الوفاق الودي، دنشواي) ومحمد فريد (النقابات العمالية ومدارس الشعب).",
  "isFullyEquipped": true,
  "lessons": [
    {
      "id": "th_hist_ch3_l1",
    ...
    },
    {
      ...
      solvedExamples: historyCh3SolvedExamples,
      exerciseProblems: historyCh3Exercises
    },
            {
  "id": "th_hist_ch4",
  "chapterNumber": 4,
  "titleEn": "Unit 4: From the 1919 Revolution to July 23, 1952 Free Officers Revolution (1914–1952)",
  "titleAr": "الفصل الرابع: مصر بعد الحرب العالمية الأولى وثورة 1919 حتى ثورة 23 يوليو 1952م",
  "descriptionEn": "WWI and British Protectorate (1914), 1919 National Revolution led by Saad Zaghloul (unity of crescent and cross, women's participation), Declaration of February 28, 1922 and 1923 Constitution, Saad's People's Ministry (1924), 1936 Anglo-Egyptian Treaty, February 4, 1942 incident, 1948 Palestine War, Cairo Fire, and the July 23, 1952 Revolution with its six goals and political/social/Arab achievements.",
  "descriptionAr": "الحرب العالمية الأولى وإعلان الحماية البريطانية 1914م، ثورة 1919م الوطنية بقيادة سعد زغلول، تصريح 28 فبراير 1922م وتحفظاته ودستور 1923م، وزارة الشعب 1924م، معاهدة 1936م، حادث 4 فبراير 1942م، حرب فلسطين 1948م، حريق القاهرة، وثورة 23 يوليو 1952م وأهدافها الستة وإنجازاتها السياسية والاجتماعية والعربية والدولية وتأميم قناة السويس.",
  "isFullyEquipped": true,
  "lessons": [
    {
      "id": "th_hist_ch4_l1",
      "titleEn": "World War I, The British Protectorate & The 1919 National Revolution",
      "titleAr": "مصر أثناء الحرب العالمية الأولى، إعلان الحماية وثورة 1919م القومية",
    ...
    },
    {
      ...
      solvedExamples: historyCh4SolvedExamples,
      exerciseProblems: historyCh4Exercises
    },
{
  "id": "th_hist_ch5",
  "chapterNumber": 5,
  ...
  "lessons": [
    {
      "id": "th_hist_ch5_l1",
      "titleEn": "British Hegemony over the Arabian Gulf and South Arabia (1798–1839)",
      "titleAr": "السيطرة البريطانية على الخليج العربي وجنوب الجزيرة العربية (1798–1839م)",
      ...
      "moeRef": {
        "bookTitleEn": "Modern Egyptian & Arab History",
        "bookTitleAr": "تاريخ مصر الحديث والمعاصر",
        "grade": "Grade 12",
        "term": "Full Year",
      ...
      "worksheet": {
        "id": "th_hist_ch5_ws1",
        "titleEn": "Worksheet 5.1: British Imperial Geopolitics in the Gulf & South Arabia",
        "titleAr": "ورقة عمل ٥-١: الجيوسياسة الإمبريالية لبريطانيا في الخليج وجنوب الجزيرة",
    ...
    {
      "id": "th_hist_ch5_l2",
      "titleEn": "French Colonization of Algeria: Settler Colonialism & National Liberation (1830–1962)",
      "titleAr": "استعمار فرنسا للجزائر: الاستعمار الاستيطاني وثورة التحرير الكبرى (1830–1962م)",
      ...
      "worksheet": {
        "id": "th_hist_ch5_ws2",
        "titleEn": "Worksheet 5.2: The Algerian Epic: Settler Colonialism & Armed Liberation",
        "titleAr": "ورقة عمل ٥-٢: ملحمة الجزائر: الاستعمار الاستيطاني وثورة التحرير الكبرى",
    ...
    {
      "id": "th_hist_ch5_l3",
      "titleEn": "French Colonization of Tunisia: Modernization Traps & The Berlin Congress (1881–1956)",
      "titleAr": "استعمار فرنسا لتونس: فخ التحديث ومؤتمر برلين حتى الاستقلال (1881–1956م)",
      ...
      "worksheet": {
        "id": "th_hist_ch5_ws3",
        "titleEn": "Worksheet 5.3: Tunisia: The Debt Trap, Berlin Congress & Bourguiba's Diplomacy",
        "titleAr": "ورقة عمل ٥-٣: تونس: فخ الديون، مؤتمر برلين، ودبلوماسية بورقيبة المرحلية",
    ...
    {
      "id": "th_hist_ch5_l4",
      "titleEn": "Colonial Partition of Morocco: From the Agadir Crisis to Independence (1912–1956)",
      "titleAr": "استعمار المغرب (مراكش): من أزمة أغادير حتى الاستقلال ووحدة التراب (1912–1956م)",
      ...
      "worksheet": {
        "id": "th_hist_ch5_ws4",
        "titleEn": "Worksheet 5.4: Colonial Partition of Morocco & National Resilience",
        "titleAr": "ورقة عمل ٥-٤: التقسيم الاستعماري للمغرب وصمود الحركة الوطنية",
    ...
    {
      "id": "th_hist_ch5_l5",
      "titleEn": "Italian Colonization of Libya: Fascist Brutality & The Jihad of Omar al-Mukhtar (1911–1951)",
      "titleAr": "استعمار إيطاليا لليبيا: الفاشية وبطش جراتسياني وجهاد عمر المختار (1911–1951م)",
      ...
      "worksheet": {
        "id": "th_hist_ch5_ws5",
        "titleEn": "Worksheet 5.5: Italian Imperialism in Libya & Omar al-Mukhtar's Jihad",
        "titleAr": "ورقة عمل ٥-٥: الاستعمار الإيطالي في ليبيا وملحمة جهاد عمر المختار",
      ...
      solvedExamples: historyCh5SolvedExamples,
      exerciseProblems: historyCh5Exercises
    },
    {
  "id": "th_hist_ch6",
  "chapterNumber": 6,
  ...
  "lessons": [
    {
      "id": "th_hist_ch6_l1",
      "titleEn": "The Great Arab Revolt (1916): Damascus Protocol, McMahon Correspondence & The Preemptive Spark",
      "titleAr": "الثورة العربية الكبرى 1916م: ميثاق دمشق، مراسلات حسين - مكماهون، وإعلان الثورة",
      ...
      "worksheet": {
        "id": "th_hist_ch6_ws1",
        "titleEn": "Worksheet 6.1: The Great Arab Revolt & McMahon Correspondence",
        "titleAr": "ورقة عمل ٦-١: الثورة العربية الكبرى ومراسلات حسين - مكماهون",
    ...
    },
    {
      ...
      "worksheet": {
        "id": "th_hist_ch6_ws2",
        "titleEn": "Worksheet 6.2: Imperial Conspiracies: Sykes-Picot & San Remo",
        "titleAr": "ورقة عمل ٦-٢: مؤامرات التقسيم: سايكس بيكو وسان ريمو",
    ...
    },
    {
      ...
      "worksheet": {
        "id": "th_hist_ch6_ws3",
        "titleEn": "Worksheet 6.3: French Mandate in the Levant & Syrian Liberation",
        "titleAr": "ورقة عمل ٦-٣: الانتداب الفرنسي في الشام وملحمة التحرر السوري",
    ...
    },
    {
      ...
      "worksheet": {
        "id": "th_hist_ch6_ws4",
        "titleEn": "Worksheet 6.4: The Iraqi National Struggle: From 1920 Revolution to 1958 Republic",
        "titleAr": "ورقة عمل ٦-٤: كفاح العراق الوطني: من ثورة العشرين إلى جمهورية 1958م",
    ...
    },
    {
      ...
      "worksheet": {
        "id": "th_hist_ch6_ws5",
        "titleEn": "Worksheet 6.5: The Unification of Saudi Arabia & The Treaty of Taif",
        "titleAr": "ورقة عمل ٦-٥: توحيد المملكة العربية السعودية ومعاهدة الطائف",
      ...
      solvedExamples: historyCh6SolvedExamples,
      exerciseProblems: historyCh6Exercises
    },
    {
  "id": "th_hist_ch7",
  "chapterNumber": 7,
  ...
  "lessons": [
    {
      ...
      "titleAr": "القومية العربية وتأسيس جامعة الدول العربية: بروتوكول الإسكندرية 1944م وميثاق الجامعة 1945م",
      ...
      "worksheet": {
        "id": "th_hist_ch7_ws1",
        "titleEn": "Worksheet 7.1: The Arab League & Arab Collective Security",
        "titleAr": "ورقة عمل ٧-١: تأسيس جامعة الدول العربية ومنظومة الأمن الجماعي",
    ...
    {
      "id": "th_hist_ch7_l2",
      "titleEn": "The Palestine Cause Under the British Mandate: Balfour Declaration, 1936 Great Revolt & Peel Commission",
      "titleAr": "القضية الفلسطينية تحت الانتداب البريطاني: وعد بلفور، الثورة الكبرى 1936م، ولجنة بيل 1937م",
      ...
      "worksheet": {
        "id": "th_hist_ch7_ws2",
        "titleEn": "Worksheet 7.2: Palestine Under the Mandate & The 1936 Revolt",
        "titleAr": "ورقة عمل ٧-٢: القضية الفلسطينية تحت الانتداب والثورة الكبرى 1936م",
    ...
    },
    {
      ...
      "worksheet": {
        "id": "th_hist_ch7_ws3",
        "titleEn": "Worksheet 7.3: The 1948 Nakba & The 1956 Suez War",
        "titleAr": "ورقة عمل ٧-٣: نكبة فلسطين 1948م والعدوان الثلاثي 1956م",
    ...
    {
      "id": "th_hist_ch7_l4",
      "titleEn": "The June 1967 Aggression, Rebuilding the Egyptian Military & The War of Attrition (1967–1970)",
      "titleAr": "عدوان 5 يونيو 1967م، إعادة بناء القوات المسلحة، وحرب الاستنزاف (1967–1970م)",
      ...
      "worksheet": {
        "id": "th_hist_ch7_ws4",
        "titleEn": "Worksheet 7.4: The War of Attrition & The Air Defense Missile Wall",
        "titleAr": "ورقة عمل ٧-٤: حرب الاستنزاف وبناء حائط صواريخ الدفاع الجوي",
    ...
    {
      "id": "th_hist_ch7_l5",
      "titleEn": "The Glorious October 1973 War: Crossing the Canal, Demolishing the Bar Lev Line & Military Doctrines",
      "titleAr": "حرب أكتوبر المجيدة 1973م: العبور العظيم، تحطيم خط بارليف، وسقوط نظريات الأمن الإسرائيلية",
      ...
      "worksheet": {
        "id": "th_hist_ch7_ws5",
        "titleEn": "Worksheet 7.5: Operation Badr & The October 1973 Military Triumph",
        "titleAr": "ورقة عمل ٧-٥: ملحمة العبور في عملية بدر وسقوط خط بارليف 1973م",
    ...
    {
      "id": "th_hist_ch7_l6",
      "titleEn": "The Path to Peace: Sadat's Jerusalem Initiative, Camp David, Peace Treaty & Taba International Arbitration",
      "titleAr": "طريق السلام: مبادرة السادات التاريخية، اتفاقيات كامب ديفيد، معاهدة السلام، والتحكيم الدولي في طابا",
      ...
      "worksheet": {
        "id": "th_hist_ch7_ws6",
        "titleEn": "Worksheet 7.6: Camp David, Sinai Liberation & The Taba Arbitration",
        "titleAr": "ورقة عمل ٧-٦: معاهدة السلام وتحرير سيناء وملحمة استرداد طابا",
      ...
      solvedExamples: historyCh7SolvedExamples,
      exerciseProblems: historyCh7Exercises
    },
    {
  "id": "th_hist_ch8",
  "chapterNumber": 8,
  ...
  "lessons": [
    {
      "id": "th_hist_ch8_l1",
      "titleEn": "The January 25, 2011 Revolution: Roots, Escalation, The 18 Days & SCAF Governance",
      "titleAr": "ثورة 25 يناير 2011م: الأسباب والمقدمات، ملحمة الـ 18 يوماً، وإدارة المجلس العسكري",
      ...
      "worksheet": {
        "id": "th_hist_ch8_ws1",
        "titleEn": "Worksheet 8.1: Precursors, Digital Mobilization, and the 18 Days of January 25",
        "titleAr": "ورقة عمل ٨-1: مقدمات ثورة يناير، الحشد التكنولوجي، وملحمة الـ 18 يوماً",
    ...
    {
      "id": "th_hist_ch8_l2",
      "titleEn": "The June 30, 2013 Revolution: Political Impasse, Armed Forces Statement, The Roadmap & The 2014 Constitution",
      "titleAr": "ثورة 30 يونيو 2013م: مظاهر الأزمة السياسية، حشود الميادين، بيان القوات المسلحة، خارطة الطريق ودستور 2014م",
      ...
      "worksheet": {
        "id": "th_hist_ch8_ws2",
        "titleEn": "Worksheet 8.2: The June 30 Revolution, The Roadmap, and Contemporary State Building",
        "titleAr": "ورقة عمل ٨-2: ثورة 30 يونيو، خارطة الطريق، وبناء الدولة المصرية الحديثة",
      ...
      solvedExamples: historyCh8SolvedExamples,
      exerciseProblems: historyCh8Exercises
    }
  ]
};
