    ...
    return (
      <div className="fixed inset-0 z-50 w-screen h-screen overflow-hidden flex flex-col p-2 sm:p-3 bg-slate-950 text-slate-100 font-sans select-none" dir={isAr ? 'rtl' : 'ltr'}>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs sm:text-sm font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                  lens === obj
                    ...
                    : obj === '40x' ? 'bg-sky-500 text-slate-950 shadow-xs'
        ...
        <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-12 gap-2 sm:gap-3 my-2 overflow-hidden">
          {/* Eyepiece Canvas */}
          <div className="lg:col-span-8 h-full min-h-0 rounded-2xl bg-slate-950 border-4 border-slate-900 overflow-hidden shadow-2xl relative flex items-center justify-center">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-slate-800">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            type="button"
            onClick={toggleFullscreen}
            className="px-3 py-1.5 rounded-xl text-xs font-black border flex items-center gap-1.5 shadow-sm transition-all cursor-pointer bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border-emerald-500/40"
