...
export type BranchId = 
  ...
  | 'thanaweya_biotechnology'
  | 'thanaweya_nanotechnology'
  | 'egbac_analysis'
...
export type InteractiveWidgetType =
  ...
  | 'geology_seismology_lab'
  | 'seismic_shadow_zone_simulator'
  | 'earthquake_epicenter_triangulator'
  | 'logic_truth_table'
  | 'logic_syllogism'
  ...
  | 'ind_quality_spc_lab'
  | 'commercial_finance_studio'
  | 'comm_financial_statements_lab'
