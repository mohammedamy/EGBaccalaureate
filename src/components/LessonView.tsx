...
import { getOfficialBookByBranch, getBookDownloadUrl, getBookGithubUrl } from '../data/officialBooksData';
          ...
          <div className={`p-3 sm:p-3.5 rounded-xl border text-xs space-y-2 shadow-sm w-full sm:w-auto ${
            ...
            {matchingBook && (
              <div className="flex items-center gap-1.5 pt-1.5 border-t border-slate-200/70 dark:border-slate-800/80 flex-wrap">
                ...
                <a
                  href={getBookGithubUrl(matchingBook)}
                  download={matchingBook.filename}
                  target="_blank"
                ...
                >
                  ...
                  <span>{t.downloadGithubMirrorShort}</span>
                </a>
                {onOpenOfficialBooks && (
                  <button
              ...
              {matchingBook && (
                <>
                  ...
                  >
                    ...
                    <span>{t.downloadGithubMirrorShort} (Anti-403)</span>
                  </a>
                </>
              )}
              <button
