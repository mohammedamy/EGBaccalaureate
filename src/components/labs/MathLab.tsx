  ...
  if (isFullscreen) {
    return (
      <div className="fixed inset-0 z-50 w-screen h-screen overflow-hidden flex flex-col p-2 sm:p-3 bg-slate-950 text-slate-100 font-sans">
        {/* Workstation Top Bar */}
        <div className="flex items-center justify-between gap-3 px-3 py-2 bg-slate-900/95 border border-slate-800 rounded-xl shrink-0 backdrop-blur-md shadow-lg">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-gradient-to-br from-indigo-500 to-blue-600 text-white shadow-md shrink-0">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-indigo-950 text-indigo-300 border border-indigo-800/60 uppercase">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative min-w-[200px] sm:min-w-[260px]">
              <select
                ...
                className="w-full appearance-none pl-3 pr-8 rtl:pr-3 rtl:pl-8 py-1.5 rounded-lg text-xs font-bold border border-slate-700 bg-slate-800 text-slate-200 cursor-pointer focus:outline-hidden focus:ring-2 focus:ring-indigo-500"
              >
            ...
            {onOpenDesmos && (
              <div className="hidden md:flex items-center gap-1.5">
                <button
                  ...
                  className="px-2.5 py-1.5 rounded-lg text-xs font-bold bg-indigo-600/80 hover:bg-indigo-600 text-white flex items-center gap-1 transition-all cursor-pointer"
                >
                  <span>Desmos 2D</span>
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 rounded-lg text-xs font-bold bg-cyan-600/80 hover:bg-cyan-600 text-white flex items-center gap-1 transition-all cursor-pointer"
                >
                  <span>Desmos 3D</span>
                  <ExternalLink className="w-3 h-3" />
                </button>
            ...
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white border border-slate-700 transition-colors cursor-pointer flex items-center gap-1 text-xs font-semibold"
            >
              <Minimize2 className="w-4 h-4 text-indigo-400" />
              <span className="hidden sm:inline">{isArabic ? 'تصغير' : 'Exit Fullscreen'}</span>
            </button>
          </div>
        </div>
