  ...
  const LABS = [
    {
      ...
      subtitleEn: 'Calculus, 3D Vectors & Tier-1 Mechanics',
      subtitleAr: 'التفاضل، الفراغية، واستاتيكا المستويات والسلم',
      icon: Calculator,
      color: 'indigo',
      badge: '⚙️ Tier-1 Mechanics',
      gradient: 'from-blue-600 via-indigo-600 to-violet-600',
      activeBg: 'bg-indigo-600 text-white shadow-indigo-600/30',
      tagline: isArabic ? 'احتكاك المستويات المائلة، اتزان السلم، والمماسات والمصفوفات' : 'Inclined plane friction, ladder equilibrium, calculus & 3D matrices',
    },
    {
      id: 'physics' as LabId,
      titleEn: 'Physics Lab',
    ...
    },
    {
      ...
      subtitleEn: '206 Bones, Plant Support & DNA Studio',
      subtitleAr: 'أطلس العظام، دعامة النبات، وترجمة DNA',
      icon: Dna,
      color: 'rose',
      badge: '🧬 Hi-Res Atlas',
      gradient: 'from-rose-600 via-pink-600 to-purple-600',
      activeBg: 'bg-rose-600 text-white shadow-rose-600/30',
      tagline: isArabic ? 'أطلس مجهري عالي الدقة، أنسجة النبات، وانقباض العضلات والجينات' : 'High-res stem histology, plant support, sliding filaments & codon translation',
    },
  ];
