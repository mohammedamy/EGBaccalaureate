...
const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    titleEn: 'Instant Universal Search Across 39,400+ Questions',
    titleAr: 'البحث الفوري الذكي في جميع الـ ٣٩,٤٠٠ مسألة و ١٩٧ فصلاً',
    ...
    descriptionEn:
      'Press ⌘K or Ctrl+K anywhere to launch the Universal Search modal. Search across 39,400+ problems, 197 syllabus chapters, official Ministry theorems, and KaTeX scientific equations with live filtered highlights.',
    descriptionAr:
      'اضغط ⌘K أو Ctrl+K في أي وقت لفتح نافذة البحث الشامل السريع. ابحث عبر ٣٩,٤٠٠+ مسألة، و١٩٧ فصلاً دراسياً، وقوانين الوزارة والمعادلات العلمية بدقة فائقة وانتقال فوري إلى الدرس المعني.',
    highlightsEn: [
  ...
  },
  {
    ...
    titleEn: '39,400+ Problems & Automated Exam Simulator',
    titleAr: 'بنك ٣٩,٤٠٠+ مسألة ومولد الامتحانات المؤتمت',
    ...
    descriptionEn:
      'Challenge yourself with the complete 39,400+ problem databank categorized into 3 difficulty tiers (Foundational, Intermediate, Advanced HOTS). Generate custom mock exams or launch the 3-Hour Ministerial Exam Simulation Room with OMR bubble sheets.',
    descriptionAr:
      'اختبر قدراتك مع بنك الأسئلة المتكامل الذي يضم ٣٩,٤٠٠+ مسألة مصنفة لثلاثة مستويات صعوبة (تأسيسي، متوسط، متقدم HOTS). قم بإنشاء امتحانات تجريبية أو محاكاة الامتحان الوزاري الرسمي لثلاث ساعات بنظام البابل شيت.',
    highlightsEn: [
